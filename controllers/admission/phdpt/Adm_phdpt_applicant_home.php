...
class Adm_phdpt_applicant_home extends MY_Controller {
  ...
  function index()
  {
    ...
    $check_program_apply=$this->Adm_phdpt_personal_details_model->get_tab_prog_apply($get_reg_no);
    $tab_position=$this->Adm_phdpt_personal_details_model->get_tab_status($get_reg_no);
    // echo "<pre>";
    // print_r();
    // exit;
    ...
    $this->load->view('admission/phdpt/adm_phdpt_welcome_view',$viewdata);
