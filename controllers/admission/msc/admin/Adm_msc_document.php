...
class Adm_phd_document extends MY_Controller {
	...
	function __construct()
  {
    ...
    $this->load->model('admission/Adm_phd_personal_details_model');
    $this->load->model('admission/Adm_phd_application_model');
    $this->load->model('admission/admin/Adm_phd_document_model','amd',TRUE);
    $this->load->model('admission/admin/phd_dashboard_model', 'phd_all', TRUE);
  }
  ...
  public function document_view_of_candidate()
  {
    ...
    $emails = $this->phd_all->get_email_by_reg_no($get_reg_no);
    $array = array(
      'email' =>  $emails,
    );
    ...
    $this->load->view('admission/admin/adm_phd_document_view',$data);
           ...
           else
            {
                ...
                else
                {
                  ...
                  else
                  {
                    ...
                    $k=base_url()."assets/admission/phd/".$get_reg_no."/".$get_reg_no.$tran_id.$this->clean($_FILES[$file]['name']);
                    if($file=='photo' || $file =='signature')
                    {
                      ...
                      $document=array(
                        ...
                        'doc_id'=>$doctype,
                        'doc_path'=>'assets/admission/phd/'.$get_reg_no.'/'.$get_reg_no.$tran_id.$this->clean($_FILES[$file]['name']),
  ...
  public function validate_photo_signature_doc()
  {
    ...
    //$value=$this->Add_phd_registration_model->get_application_programme_details($get_reg_no,$doc_id);
