...
class Add_phd
 extends MY_Controller {
  ...
  {  
    ...
    $this->load->view('admission/phd/adm_phd_home',$data);
  ...
  { 
    $data['val']="contact";
    $this->adm_phd_header($data);
    $this->load->view('admission/phd/adm_phd_contact_us',$data);
    $this->adm_phd_footer();
  }
  ...
  { 
    $data['val']="payment";
    $this->adm_phd_header($data);
    $this->load->view('admission/phd/adm_phd_payment_of_fees',$data);
    $this->adm_phd_footer();
  }
  ...
  { 
    $data['val']="brochure";
    $this->adm_phd_header($data);
    $this->load->view('admission/phd/adm_phd_information_brochure',$data);
    $this->adm_phd_footer();
  }
  ...
  { 
    $data['val']="apply";
    $this->adm_phd_header($data);
    $this->load->view('admission/phd/adm_phd_how_to_apply',$data);
    $this->adm_phd_footer();
  }
  ...
  { 
    ...
    $this->adm_phd_header($data);
    $this->load->view('admission/phd/adm_phd_programme_eligibility',$data);
    $this->adm_phd_footer();
  }
  public function adm_phd_login()
  { 
    $data['val']="login";
    $this->adm_phd_header($data);
  ...
  public function adm_phd_registration()
  { 
