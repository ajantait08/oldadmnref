...
class Adm_phd_admisison_payment extends MY_Controller {
	...
	function __construct()
  {
    ...
    $this->load->model('admission/phd/Adm_phd_admission_payment_model');
  ...
  function index()
  {
    ...
    $this->load->view('admission/phd/adm_phd_admisison_payment_view',$data);
    $this->adm_phd_footer();
  ...
  public function adm_phd_payment()
  {
    ...
    $data['application_details']=$this->Add_phd_registration_model->get_application_programme_details($get_reg_no);
    //$data['personal_details']=$this->Adm_phd_admission_payment_model->get_adm_phd_appl_ms($get_reg_no);
    $data['personal_details']=$this->Adm_phd_admission_payment_model->get_adm_phd_appl_ms_selected($get_reg_no,$data['program_selected']);
    // echo '<pre>';
    // print_r($data['personal_details']);
    // echo '</pre>';
    // exit;
    //$data['program_apply']=$this->Adm_phd_personal_details_model->get_adm_phd_reg_appl_program($get_reg_no);
    $data['program_apply']=$this->Adm_phd_admission_payment_model->get_adm_phd_reg_appl_program_selected($get_reg_no,$data['program_selected']);
    // echo '<pre>';
    // print_r($data);
    // echo '</pre>';
    // exit;
  ...
  public function proceed_to_payment()
  {
    ...
    $purpose = 'phd Program Admission apply Fee';
    if($paygateway=='Sbi')
    {
    ...
    */
    ...
    $response_url = base_url('index.php/admission/phd/Adm_phd_admisison_payment/pay_response');
    ...
    $array_otherdetails = array(
      ...
      'payment_type' => 'PHD ADMISSION FEE',
  ...
  $log_data = array(
     ...
     $this->Adm_phd_admission_payment_model->insert_payment_log_data($log_data); // insert in log table
  ...
  public function pay_response(){
    ...
    if(!empty($response_data))
    {
        ...
        if($bank_data['payment_status']=='FAIL')
            {
                $update_array = array(
                  ...
                  $update_log_fail = $this->Adm_phd_admission_payment_model->update_main_payment_log($update_array,$where_data);
                  if ($update_log_fail) {
            ...
            else if($bank_data['payment_status']=="PENDING")
            {
                $update_array = array(
                  ...
                  $update_log_pending = $this->Adm_phd_admission_payment_model->update_main_payment_log($update_array,$where_data);
            ...
            else if($bank_data['payment_status']=="SUCCESS")
            {
                ...
                $update_log_success = $this->Adm_phd_admission_payment_model->update_main_payment_log($update_array,$where_data);
                ...
                $tab_update=array(
                  'remark_1'=>"phd Admission Fee done",

                );

                 $update_payment_tab_details = $this->Adm_phd_admission_payment_model->update_payment_tab_details($tab_update, $where_data);
                 /* update payment in tab details */
                ...
                $update_payment_appl_ms_details = $this->Adm_phd_admission_payment_model->update_payment_appl_ms_details($adm_phd_appl_ms, $where_data,$otherdetails_data['admn_type']);
      ...
      else
      {
            ...
            redirect('admission/phd/Adm_phd_admission_payment');
      }
  }
