...
function mis_registration_save_education_details(){
    ...
    if ($registration_no && ($login_type =='Phd')) {
        ...
        // $this->form_validation->set_rules('exam0','Board 10th','');
        // $this->form_validation->set_rules('institute0','Institution 10th','');
        // $this->form_validation->set_rules('year0','Year 10th','');
        // $this->form_validation->set_rules('marksheet0','Marksheet 10th','');
        // $this->form_validation->set_rules('certificate0','Certificate 10th','');
        // $this->form_validation->set_rules('grade0','Grade 10th','');
        // $this->form_validation->set_rules('division0','Division 10th','');
        // $this->form_validation->set_rules('sub0','Subject 10th','');
        // $this->form_validation->set_rules('exam1','Board 12th','');
        // $this->form_validation->set_rules('institute1','Institution 12th','');
        // $this->form_validation->set_rules('year1','Year 12th','');
        // $this->form_validation->set_rules('marksheet1','Marksheet 12th','');
        // $this->form_validation->set_rules('certificate1','Certificate 12th','');
        // $this->form_validation->set_rules('grade1','Grade 12th','');
        // $this->form_validation->set_rules('division1','Division 12th','');
        // $this->form_validation->set_rules('sub1','Subject 12th','');
