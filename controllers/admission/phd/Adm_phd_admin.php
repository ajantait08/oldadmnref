...
class Adm_phd_admin extends MY_Controller {
    ...
    $this->load->model('admission/phd/Adm_phd_admin_model');
  }
  ...
  {  
    // echo "reach";
    // exit;
   $this->load->view('admission/phd/Adm_phd_admin_view');
  ...
  {   
    ...
    $this->load->model('admission/phd/Adm_phd_admin_model');	  
    $login=$this->Adm_phd_admin_model->login($saltuser,$saltpass);
    // echo $this->db->last_query();
    // exit;
    if($login)
    { 
      $auth_type=$this->Adm_phd_admin_model->get_auth($saltuser,$saltpass);
     //   echo $this->db->last_query();
     //  exit;  
     // echo $auth_type;
      // exit;
      ...
      // exit;
      redirect('admission/phd/Adm_phd_admin/dashboard');
       
    } 
    else
    {  
      $this->session->set_flashdata('fail','wrong user name and password');
    	redirect('admission/phd/Adm_phd_admin');
 ...
 public function dashboard()
  { 
    ...
    if($var=='admin')
    { 
     $this->Adm_phd_admin_header();
     $this->load->view('admission/phd/Adm_phd_admin_home_page');
     $this->Adm_phd_admin_footer();
    }
   else
   {
    redirect('admission/phd/Adm_phd_admin');
