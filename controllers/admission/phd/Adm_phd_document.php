...
class Adm_phd_document extends MY_Controller {
  ...
  function index()
  {
    ...
    $this->load->view('admission/phd/adm_phd_document_view',$data);
    $this->adm_phd_footer();
  ...
  public function document_upload($v)
  {
    ...
    if (!file_exists('/disk2/virtualhost/admission/public_html/html/assets/admission/phd/'.$get_reg_no))
    {
      mkdir('/disk2/virtualhost/admission/public_html/html/assets/admission/phd/'.$get_reg_no, 0777, true);
    }
        //upload file
           ...
           else
            {
                ...
                else
                {
                  ...
                  else
                  {
                    ...
                    $k=base_url()."assets/admission/phd/".$get_reg_no."/".$file.$tran_id.$this->clean($_FILES[$file]['name']);
                    if($file=='photo'|| $file =='signature')
                    {
                      ...
                      $document=array(
                        ...
                        'doc_id'=>$doctype,
                        'doc_path'=>'assets/admission/phd/'.$get_reg_no.'/'.$file.$tran_id.$this->clean($_FILES[$file]['name']),
                        'created_by'=>$email
                      );
                    }
                    else
