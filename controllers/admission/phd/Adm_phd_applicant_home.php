...
class Adm_phd_applicant_home extends MY_Controller {
  ...
  function index()
  {
    ...
    {
      redirect('admission/Add_phd/Adm_phd_login');
    }
    ...
    $check_program_apply=$this->Adm_phd_personal_details_model->get_tab_prog_apply($get_reg_no);
    $tab_position=$this->Adm_phd_personal_details_model->get_tab_status($get_reg_no);
    // echo "<pre>";
    // print_r();
    // exit;
    ...
    $this->load->view('admission/phd/adm_phd_welcome_view',$viewdata);
    $this->Adm_phd_footer();
