...
class Adm_phdef_mis_registration_education extends MY_Controller
{
                    ...
                    # comment receipt part here because it will be generated dynamically #
                     ...
                     $tab_status = $reg_tab_status[0]['tab_status'];
                      ...
                      if ($tab_status == '1') {
                        ...
                        $this->load->view('admission/phdef/mis_registration_common_form_education_details', $login_id);
...
//12th prev_certificates
    ...
    // echo '<pre>';print_r($stu_prev_certificates_final);echo '</pre>'; exit;
      ...
      {
        //echo 'reached'; exit;
        $prev_edu_details = $this->Phdef_mis_reg->get_mis_reg_prev_education_details($registration_no);
        $prev_cert_details = $this->Phdef_mis_reg->get_mis_reg_prev_certificate_details($registration_no);
        ...
        if (!empty($prev_edu_details) && !empty($prev_cert_details)) {
            ...
            for ($i=0; $i < $count_edu; $i++) {
                ...
                $stu_prev_edu_mis_reg =  $this->Phdef_mis_reg->insertbatch_stu_prev_education_log($prev_edu_details_new);// 10 insert_batch
                $remove_prev_edu_mis_reg_main_table = $this->Phdef_mis_reg->remove_prev_edu_mis_reg_main_table($registration_no);
                $stu_prev_edu_mis_reg =  $this->Phdef_mis_reg->insertbatch_stu_prev_education_mis_registration($stu_prev_education_details_final);
                //*** for previous education update */
                //*** for previous certificate update */
                $stu_prev_cert_mis_reg = $this->Phdef_mis_reg->insertbatch_stu_prev_certificate_log($prev_cert_details_new);// 11
                $remove_prev_cert_mis_reg_main_table = $this->Phdef_mis_reg->remove_prev_cert_mis_reg_main_table($registration_no);
                $stu_prev_cert_mis_reg =  $this->Phdef_mis_reg->insertbatch_stu_prev_certificate_mis_registration($stu_prev_certificates_final);
                //*** for previous certificate update */
            ...
            // echo '</pre>';
            $stu_prev_edu_mis_reg =  $this->Phdef_mis_reg->insertbatch_stu_prev_education_mis_registration($stu_prev_education_details_final);// 10 insert_batch
            $stu_prev_cert_mis_reg = $this->Phdef_mis_reg->insertbatch_stu_prev_certificate_mis_registration($stu_prev_certificates_final);// 11
        }
      }
      else
      {
         $stu_prev_edu_mis_reg = $this->Phdef_mis_reg->insertbatch_stu_prev_education_mis_registration($stu_prev_education_details);// 10 insert_batch
         $stu_prev_cert_mis_reg = $this->Phdef_mis_reg->insertbatch_stu_prev_certificate_mis_registration($stu_prev_certificates);// 11
      }
      //echo 'reached here'; exit;
      //check if basic education details already exists
      $check_education_details_already_exists = $this->Phdef_mis_reg->check_education_details_already_exists($registration_no);
      ...
      $education_details_insert_log = $this->Phdef_mis_reg->insert_education_details_log($data_insert_log);
      if ($education_details_insert_log == '') {
        ...
        redirect('admission/phdef/Adm_phdef_mis_registration_education/manage_previous_education_details');
      }
      else {
        //echo 'success here';exit;
        $delete_prev = $this->Phdef_mis_reg->delete_prev_education_details($registration_no);
        if($delete_prev == ''){
        ...
        $mis_reg_edu_details = $this->Phdef_mis_reg->insert_mis_reg_edu_details($data['basic_edu_details']);
        ...
        //if ($stu_prev_edu_mis_reg && $stu_prev_cert_mis_reg) {
         $get_tab2_status = $this->Phdef_mis_reg->get_tab2_status($registration_no);
         if(empty($check_education_details_already_exists)){
        ...
        if ($registration_no && ($login_type =='Phdef')) {
            ...
            $data['tab_stat'] = $this->Phdef_all->get_tab_status($registration_no);
            $data['program_selected'] = $this->session->userdata('selected_program');
            $login_id=$this->Phdef_mis_reg->validate_login($registration_no,$data['program_selected']);
            #$admission_no=$this->Phd_mis_reg->get_admn_no_from_stud_final_with_fee($registration_no);
            $admn_type='';
                if($login_id){
                 $admn_type=$login_id['admn_type'];
...
/*
 ...
 // end here not == to jee
             ...
             // either print form or load form
              ...
              else
              {
                ...
                # comment receipt part here because it will be generated dynamically #
                  ...
                  $login_id['get_mis_reg_education_details'] = $this->Phdef_mis_reg->get_mis_reg_education_details($login_id['reg_id']);
                  $login_id['get_mis_reg_prev_edu_details'] = $this->Phdef_mis_reg->get_mis_reg_prev_education_details($login_id['reg_id']);
                  $login_id['get_mis_reg_prev_cert_details'] = $this->Phdef_mis_reg->get_mis_reg_prev_certificate_details($login_id['reg_id']);
                  // echo '<pre>';
                  // print_r($login_id);
                  // echo '</pre>';
                  // exit;
  ...
  function remove_marksheeet(){
     $sno = $_REQUEST['sno'];
     $query_prev_edu_details = $this->Phdef_mis_reg->get_stu_prev_certificate_details($sno);
     if ($query_prev_edu_details != '') {
        ...
        $insert_id = $this->Phdef_mis_reg->insert_stu_prev_certificate_details_log($form_data);
        if ($insert_id != '') {
        $update_cert = $this->Phdef_mis_reg->update_stu_prev_certificate($form_data);
        if ($update_cert) {
           echo '1';
        }
        else{
  ...
  function remove_certificate(){
    ...
    if ($query_prev_edu_details != '') {
       ...
       $insert_id = $this->Phdef_mis_reg->insert_stu_prev_certificate_details_log($form_data);
       if ($insert_id != '') {
       $update_cert = $this->Phdef_mis_reg->update_stu_prev_marksheet($form_data);
       if ($update_cert) {
          echo '1';
       }
       else{
 ...
 public function mis_reg_save_parent_details(){
        ...
        if ($registration_no && ($login_type =='Phdef')) {
          ...
          if ($this->form_validation->run() == TRUE) {
                ...
                $prev_parent_details_log = $this->Phdef_mis_reg->check_parent_details_already_exists($registration_no,$admn_no);
            ...
            /* check if parent details already exists */
                if($prev_parent_details_log != ''){
                    ...
                    $save_parent_details_log = $this->Phdef_mis_reg->save_phdef_mis_reg_prev_parent_details_log($form_data_prev_parent);
                    $remove_prev_cert_mis_reg_main_table = $this->Phdef_mis_reg->remove_prev_parent_mis_reg_main_table($registration_no);
                    $stu_prev_cert_mis_reg =  $this->Phdef_mis_reg->save_phdef_mis_reg_parent_details($save_parent_details);
             ...
             //echo 'entered_2'; exit;
             $save_parent_details = $this->Phdef_mis_reg->save_phdef_mis_reg_parent_details($save_parent_details);
                   ...
                   /* check if payment is completed in appl_selected */
                      ...
                      else
                      {
                        ...
                        # comment receipt part here because it will be generated dynamically #
                          ...
                          $login_id['photo_signature'] = $this->Phdef_mis_reg->get_photo_signature_phdef($login_id['reg_id']);
                          if($prev_parent_details_log != ''){
                          $login_id['get_mis_reg_parent_details'] = $this->Phdef_mis_reg->get_mis_reg_parent_details($login_id['reg_id']);
                          }

                          $this->adm_phdef_header($data);
                          $this->load->view('admission/phdef/mis_registration_common_form_parent_details', $login_id);
                          $this->adm_phdef_footer();
                        }
                    }
                    else{
