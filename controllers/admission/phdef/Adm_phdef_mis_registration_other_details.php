...
class Adm_phdef_mis_registration_other_details extends MY_Controller
{
    ...
    function __construct()
    {
        ...
        $this->load->model('admission/phdef/Adm_phdef_mis_registration_model','Phdef_mis_reg',TRUE);
    ...
    function mis_reg_save_stu_other_imp_details(){
        ...
        if ($registration_no && ($login_type =='Phdef')) {
            ...
            $appl_type = $this->Phdef_mis_reg->get_appl_type_from_reg_no($registration_no);
            $login_id=$this->Phdef_mis_reg->validate_login($registration_no,$data['program_selected'],$appl_type);
            ...
            $admn_type='';
                ...
                if($login_id && $admn_type=='jrf')
                {
                 ...
                 // either print form or load form
                   ...
                   $pay_status_selected = $this->Phdef_mis_reg->check_payment_status_appl_selected($registration_no);
                   /* check if payment is completed in appl_selected */
                   $tab4 = $this->Phdef_mis_reg->check_tab4_status($registration_no);
                  if($tab4 != '' && $pay_status_selected != '')// already submitted
                  {
                     redirect('admission/phdef/Adm_phdef_application_preview');
                  }
                  else
                  {
                    ...
                    # comment receipt part here because it will be generated dynamically #
                      ...
                      $login_id['education_details'] = $this->Phdef_mis_reg->get_phdef_education_details($login_id['reg_id']);

                      $login_id['photo_signature'] = $this->Phdef_mis_reg->get_photo_signature_phdef($login_id['reg_id']);
                      $login_id['iitism_email'] = "admission_no@iitism.ac.in";
                      $login_id['iitism_password'] = $login_id['contact_no'];
                      // echo '<pre>';
                      // print_r($login_id);
                      // echo '</pre>';
                      $reg_tab_status = $this->Phdef_mis_reg->get_current_user_tab_status($registration_no);
                      if (empty($reg_tab_status)) {
                        redirect('admission/phdef/Adm_phdef_mis_registration/proceed_with_registration');
                        }
                        else {
                       $tab_status = $reg_tab_status[0]['tab_status'];
                        ...
                        if ($tab_status == '1') {
                          redirect('admission/phdef/Adm_phdef_mis_registration_education');
                        }
                        if ($tab_status == '2') {
                          redirect('admission/phdef/Adm_phdef_mis_registration/parent_bank_account_details');
                        }
                        if ($tab_status == '3') {
                            $this->adm_phdef_header($data);
                            $this->load->view('admission/phdef/mis_registration_common_form_other_imp_details', $login_id);
                            $this->adm_phdef_footer();
                        }

                        if ($tab_status == '4') {
                          redirect('admission/phdef/Adm_phdef_mis_registration_other_details/mis_reg_stu_other_details_preview');
                        }
                        if ($tab_status == '5') {
                          // echo $admn_no;
                          // echo $admn_type;
                          ...
                          $this->adm_phdef_header($data);
                          $this->load->view('admission/phdef/mis_reg_download_common_format',$details);
                          $this->adm_phdef_footer();
                        }
               ...
               // either print form or load form
                ...
                else
                {
                  ...
                  # comment receipt part here because it will be generated dynamically #
                    ...
                    $login_id['iitism_email'] = "admission_no@iitism.ac.in";
                    $login_id['iitism_password'] = $login_id['contact_no'];
                    $login_id['manage_previous_hostel_details'] = $this->Phdef_mis_reg->get_prev_other_hostel_details($registration_no);
                    $login_id['manage_previous_stu_account_details'] = $this->Phdef_mis_reg->get_prev_stu_account_details($registration_no);
    ...
    function mis_reg_stu_other_details_preview(){
                     ...
                     redirect('admission/phdef/Adm_phdef_application_preview');
                      ...
                      else
                      {
                        ...
                        # comment receipt part here because it will be generated dynamically #
                          ...
                          $login_id['get_personal_details'] = $this->Phdef_mis_reg->get_personal_details($login_id['reg_id']);
                          // echo '<pre>';
                          // print_r($login_id['get_personal_details']);
                          // echo '</pre>';
                          // exit;
                          $login_id['get_education_details'] = $this->Phdef_mis_reg->get_education_details($login_id['reg_id'],$login_id['admn_no']);
                          $login_id['get_prev_education_details'] = $this->Phdef_mis_reg->get_prev_education_details($login_id['reg_id'],$login_id['admn_no']);
                          $login_id['get_prev_certificate_details'] = $this->Phdef_mis_reg->get_prev_certificate_details($login_id['reg_id'],$login_id['admn_no']);
                          $login_id['get_parent_details'] = $this->Phdef_mis_reg->get_parent_details($login_id['reg_id'],$login_id['admn_no']);
                          $login_id['get_hostel_details'] = $this->Phdef_mis_reg->get_hostel_details($login_id['reg_id'],$login_id['admn_no']);
                          $login_id['get_fee_details'] = $this->Phdef_mis_reg->get_fee_details($login_id['reg_id'],$login_id['admn_no']);
                          $login_id['get_student_account_details'] = $this->Phdef_mis_reg->get_student_account_details($login_id['reg_id'],$login_id['admn_no']);
                      ...
                      if ($tab_status == '3') {
                        redirect('admission/phdef/Adm_phdef_mis_registration_other_details/mis_reg_save_stu_other_imp_details');
                      }

                      if ($tab_status == '4') {
                        $this->adm_phdef_header($data);
                        $this->load->view('admission/phdef/mis_registration_common_form_preview', $login_id);
                        //$this->load->view('admission/phd/mis_registration', $login_id);
                        $this->adm_phdef_footer();
                          }
                          if ($tab_status == '5') {
                            // echo $admn_no;
      ...
      echo 'entered logout'; exit;
      redirect('admission/phdef/Adm_phdef_registration/logout');
    }

}

function mis_reg_stu_other_details_preview_new(){
  $registration_no = $this->session->userdata('registration_no');
  $login_type = $this->session->userdata('login_type');
  $count_ml = 0;
  if ($registration_no && ($login_type =='Phdef')) {
      ...
      $appl_type = $this->Phdef_mis_reg->get_appl_type_from_reg_no($registration_no);
      $admn_type='jrf';
      $admn_no = $this->Phdef_mis_reg->get_admn_no_from_mis($registration_no);
      if ($admn_no != '') {
        $tab5 = $this->Phdef_mis_reg->check_tab5_status($registration_no); // comment the tab condition later
        if($tab5 != '')// already submitted
        {
          $details=$this->getFromTables($admn_no,$admn_type);// will be same
          $data1['admn_type']=$admn_type;
          $data1['registration_no'] = $registration_no;
          $data1['photopath'] = $this->Phdef_mis_reg->get_photopath_from_personal_details($registration_no);
          $data1['signpath'] = $this->Phdef_mis_reg->get_signpath_from_personal_details($registration_no);
          $details=array_merge($details,$data1);
          $emaildata = $this->Phdef_mis_reg->get_emaildata($admn_no);
    ...
    function save_registrtaion_no_other_details(){
        ...
        if ($registration_no && ($login_type =='Phdef')) {
          ...
          if($this->form_validation->run() == TRUE) {
            //echo 'pass'; exit;
            $check_hostel_details_exists = $this->Phdef_mis_reg->get_prev_other_hostel_details($registration_no);
            // echo '<pre>';
            ...
            if (!empty($check_hostel_details_exists)) {
              ...
              $hostel_details_insert_log = $this->Phdef_mis_reg->insert_hostel_details_log($data_insert_log);
              if ($hostel_details_insert_log == '') {
                ...
                redirect('admission/phdef/Adm_phdef_mis_registration_other_details/manage_previous_other_details');
              }
              else {
                //echo 'success here';exit;
                $delete_prev = $this->Phdef_mis_reg->delete_prev_hostel_details($registration_no);
                if($delete_prev == ''){
            ...
            $hostel_info = array(
              ...
              $save_hostel_info = $this->Phdef_mis_reg->save_hostel_info($hostel_info);
              //exit;

            $check_stu_account_details_exists = $this->Phdef_mis_reg->get_prev_stu_account_details($registration_no);
            if (!empty($check_stu_account_details_exists)) {
              ...
              //echo '<pre>'; print_r($data_insert_log); echo '</pre>'; //exit;
              $account_details_insert_log = $this->Phdef_mis_reg->insert_account_details_log($data_insert_log);
              if ($account_details_insert_log == '') {
                ...
                //echo 'success here';exit;
                $delete_prev = $this->Phdef_mis_reg->delete_prev_account_details($registration_no);
                if($delete_prev == ''){
                  //echo 'not deleted'; exit;
                  $this->session->flashdata('flashError','Error Occured , Please Wait while trying to update education details');
                  redirect('admission/phdef/Adm_phdef_mis_registration_other_details/manage_previous_other_details');
              ...
              $save_account_details = $this->Phdef_mis_reg->save_account_details($stu_account_details);

              $check_fee_details_exists = $this->Phdef_mis_reg->get_prev_stu_fee_details($registration_no);
              if (!empty($check_fee_details_exists)) {
                ...
                //echo '<pre>'; print_r($data_insert_log); echo '</pre>'; //exit;
                $fee_details_insert_log = $this->Phdef_mis_reg->insert_fee_details_log($data_insert_log);
                if ($fee_details_insert_log == '') {
                  ...
                  //echo 'success here';exit;
                  $delete_prev = $this->Phdef_mis_reg->delete_prev_fee_details($registration_no);
                  if($delete_prev == ''){
                    //echo 'not deleted'; exit;
                    $this->session->flashdata('flashError','Error Occured , Please Wait while trying to update education details');
                    redirect('admission/phdef/Adm_phdef_mis_registration_other_details/manage_previous_other_details');
              ...
              if ($save_hostel_info != '' &&  $save_account_details != '') {
                $data_Phd_mis_reg =  array(
                 ...
                 $tab_details_insert = $this->Phdef_mis_reg->update_mis_reg_tab_status($data_Phd_mis_reg,$registration_no);
    ...
    function preview_submit(){
      ...
      if ($registration_no && ($login_type =='Phdef')) {
          ...
          $data['program'] = $this->Phdef_all->get_program_details($registration_no);
          $data['tab_stat'] = $this->Phdef_all->get_tab_status($registration_no);
          $login_id=$this->Phdef_mis_reg->validate_login($registration_no);
          //$admission_no=$this->Phd_mis_reg->get_admn_no_from_stud_final_with_fee($registration_no);
          $admn_type='';
              if($login_id){
               $admn_type=$login_id['admn_type'];
              ...
              if($login_id && $admn_type=='jrf')
              {
               ...
               // either print form or load form
                 $this->session->set_userdata($admn_no,$admn_type);
                 $tab5 = $this->Phdef_mis_reg->check_tab5_status($admn_no,$registration_no); // comment the tab condition later
                if($this->Phd_mis_reg->check($admn_no) && $tab5 != '')// already submitted
                {
                  ...
                  $data1['admn_type']=$admn_type;
                  $data1['registration_no'] = $login_id['reg_id'];
                  $data1['photopath'] = $this->Phdef_mis_reg->get_photopath_from_personal_details($data1['registration_no']);
                  $data1['signpath'] = $this->Phdef_mis_reg->get_signpath_from_personal_details($data1['registration_no']);
                  $details=array_merge($details,$data1);
                  $this->session->set_userdata("admn_no",$admn_no);
                  //echo '<pre>';print_r($details);echo '</pre>'; exit;
                  $this->adm_phdef_header($data);
                ...
                else
                {
                  ...
                  # comment receipt part here because it will be generated dynamically #
                    ...
                    /* get data from previous form */
                    $login_id['get_personal_details'] = $this->Phdef_mis_reg->get_personal_details($login_id['reg_id']);
                    $login_id['get_education_details'] = $this->Phdef_mis_reg->get_education_details($login_id['reg_id']);
                    $login_id['get_prev_education_details'] = $this->Phdef_mis_reg->get_prev_education_details($login_id['reg_id']);
                    $login_id['get_prev_certificate_details'] = $this->Phdef_mis_reg->get_prev_certificate_details($login_id['reg_id']);
                    $login_id['get_parent_details'] = $this->Phdef_mis_reg->get_parent_details($login_id['reg_id']);
                    $login_id['get_hostel_details'] = $this->Phdef_mis_reg->get_hostel_details($login_id['reg_id']);
                    $login_id['get_fee_details'] = $this->Phdef_mis_reg->get_fee_details($login_id['reg_id']);
                    $login_id['get_student_account_details'] = $this->Phdef_mis_reg->get_student_account_details($login_id['reg_id']);
                    $dynamic_prev_edu_details = array();
                    $dynamic_prev_cert_details = array();
                    //$dynamic_array_merge_edu_cert_details = array();
                    foreach($login_id['get_prev_education_details'] as $prev_edu_details){
                  ...
                  if($action=='Proceed For Payment')
                        {
                          ...
                          $tab5 = $this->Phdef_mis_reg->check_tab5_status($registration_no); // comment the tab condition later
                          if($this->Phdef_mis_reg->check_admn_no_registration($admn_no,$admn_type) && $tab5 != '')
                          {
                            $details=$this->getFromTables($admn_no,$admn_type);// will be same
                            $data1['admn_type']=$admn_type;
                            $data1['registration_no'] = $login_id['reg_id'];
                ...
                // {
                 ...
                 $tab_details_insert = $this->Phdef_mis_reg->update_mis_reg_tab_status($data_Phd_mis_reg,$registration_no);
                  ...
                  redirect('admission/phdef/Adm_phdef_admisison_payment');
                  //echo "<pre>"; print_r($details); echo '</pre>';exit;
    ...
    function download_pdf($admn_no,$admn_type,$reg_id)
  {
    ...
    if($this->session->userdata('admn_no'))
    {
      ...
      if($admn_no_session==$admn_no)
      {
         ...
         $data['photopath'] = $this->Phdef_mis_reg->get_photopath_from_personal_details($data['registration_no']);
         $data['signpath'] = $this->Phdef_mis_reg->get_signpath_from_personal_details($data['registration_no']);
         $details=array_merge($details,$data);
         ...
         $details['course'] = $this->Phdef_mis_reg->get_course_details($details['course_id']);
        ...
        $this->load->helper(array('dompdf', 'file'));
        $ff=$this->load->view('admission/phdef/mis_registration_print_final_pdf',$details,TRUE);
  ...
  //   exit;
    ...
    if($this->session->userdata('registration_no'))
    {
      ...
      $this->load->helper(array('dompdf', 'file'));
      $path = '/disk2/virtualhost/admission/public_html/html/assets/admission/phdef/'.$admn_no_lower;
      ...
      $html = $this->load->view('admission/phdef/mis_registration_print_final_pdf', $details, TRUE);
      //echo $html; exit;
      $paper = '';
      $stream = FALSE;
     $output_mis_registration = pdf_create($html,'Mis_registration_form_'.$admn_no_lower,$paper,$stream);
     //echo $output_mis_registration; exit;
     $file_to_save_reg = '/disk2/virtualhost/admission/public_html/html/assets/admission/phdef/'.$admn_no_lower.'/Mis_registration_form_'.$admn_no_lower.'.pdf';
     ...
     if($file_send_mis===false){
        ...
        $this->Phdef_mis_reg->insert_upload_error_logs($upload_array);
     }
     ...
     //$this->send_email($admn_no,$admn_type,$details['email'],$reg_id)
      ...
      if(true)
      {
        // email successfully sent vai email
        return true;
      }
      else
      {
        // email could not due issue in smtp plz check smtp setting shuld be "LESS SECURE = ON"
        return false;
      }
  ...
  //     $file_path = '/disk2/virtualhost/admission/public_html/html/assets/admission/phdef/'.strtolower($admn_no).'/Mis_registration_form_'.strtolower($admn_no).'.pdf';
  ...
  // }
   ...
   {
         //$this->load->model('new_admission_common/new_admission_common_model_new','',TRUE);
         $user_tables=$this->Phdef_mis_reg->get_user_tables($admn_no);
        //  echo '<pre>';
        //  print_r($user_tables);
        //  echo '</pre>';
         $stu_tables=$this->Phdef_mis_reg->get_stu_tables($admn_no);
        //  echo '<pre>';
        //  print_r($stu_tables);
        //  echo '</pre>';
         $reg_tables=$this->Phdef_mis_reg->get_reg_tables($admn_no,$admn_type);// for getting course and branch and department
        //  echo '<pre>';
        //  print_r($reg_tables);
        //  echo '</pre>';
         $hs_info=$this->Phdef_mis_reg->get_hs_info($admn_no); // hostel info details from hs_info for hostel pdf page
        //  echo '<pre>';
        //  print_r($hs_info);
        //  echo '</pre>';
         $education_details = $this->Phdef_mis_reg->get_prev_edu_and_cert($admn_no);
        //  echo '<pre>';
...
/*
      ...
      */
      ...
      {
      $year1=intval($year1);
      $query=$this->Phdef_mis_reg->get_passout_year($login_id['course_id']);
      ...
      $web_people = array(
        ...
        'remark1' => 'PHDEF MONSOON ADMISSION',
     ...
     $this->db->trans_start();  // start the transaction
      ...
      $this->Phdef_mis_reg->insert_users($users);///1
      $this->Phdef_mis_reg->insert_user_details($user_details);//2
      $this->Phdef_mis_reg->insert_user_other_details($user_other_details);//3
      $this->Phdef_mis_reg->insertbatch_user_address($user_address);// insert_batch 4
      $this->Phdef_mis_reg->insert_stu_academic($stu_academic);// 5
      $this->Phdef_mis_reg->insert_stu_details($stu_details);// 6
      $this->Phdef_mis_reg->insert_stu_other_details($stu_other_details);// 7
      $this->Phdef_mis_reg->insert_stu_admn_fee($stu_admn_fee);// 8
      #xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
      if($admn_type=='jee')
      {
         $this->Phdef_mis_reg->insert_stu_section_data($stu_section_data); // 9  only for JEE data
      }
      #xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
      if($admn_type!='jee')
      {
        $this->Phdef_mis_reg->insertbatch_stu_prev_education($stu_prev_education_details);// 10 insert_batch
        $this->Phdef_mis_reg->insertbatch_stu_prev_certificate($stu_prev_certificates_dynamic);// 11
      }
      else
      {
        $this->Phdef_mis_reg->insertbatch_stu_prev_education($stu_prev_education_details);// 10 insert_batch
      ...
      $this->Phdef_mis_reg->insert_stu_enroll_passout($stu_enroll_passout);// 12

      $this->Phdef_mis_reg->insert_email_form($email_form); // 13 Insert IITISM Email
      $this->Phdef_mis_reg->insert_emaildata($emaildata); // 14 Insert IITISM Email

      $this->Phdef_mis_reg->insert_web_people($web_people); // 15 Insert web_people

      if($login_id['is_prep']=='yes') {
        $this->Phdef_mis_reg->insertPreparatory($login_id['admn_no']);// 16
      }
...
// not required as reg_regular_form and feedback table is not filled
  ...
  */
    ...
    $reg_regular_form = array(        // form_id is ignored as it is AUTO_INCREMENT   //// information to be stored in reg_regular_form table  //
     ...
     $last_id = $this->Phdef_mis_reg->insert_reg_regular_fee($reg_regular_fee);// 17
     $reg_regular_form['form_id'] = $last_id;
     $this->Phdef_mis_reg->insert_reg_regular_form($reg_regular_form);// 18
    ...
    // $this->Phd_mis_reg->insert_reg_form($reg_form);//
     $this->Phdef_mis_reg->insert_fb_student_feedback($fb_student_feedback); // 19 information to be stored in feedback table//
      ...
      $this->Phdef_mis_reg->insert_hostel($hs_assigned_student_room); // 21
      $this->Phdef_mis_reg->insert_hs_student_allotment_list($hs_student_allotment_list); // 22
      $this->Phdef_mis_reg->insert_web_people_iitism_web($web_people); // uncommit most important
     ...
     $this->db->trans_complete();
      ...
      //       echo 'entered'; exit;
            ...
            //echo 'reached here'; exit;
             ...
             $this->Phdef_mis_reg->insert_users2($users);///1
             $this->Phdef_mis_reg->insert_user_details2($user_details);//2
             $this->Phdef_mis_reg->insert_user_other_details2($user_other_details);//3
             $this->Phdef_mis_reg->insertbatch_user_address2($user_address);// insert_batch 4
             $this->Phdef_mis_reg->insert_stu_academic2($stu_academic);// 5
             $this->Phdef_mis_reg->insert_stu_details2($stu_details);// 6
             $this->Phdef_mis_reg->insert_stu_other_details2($stu_other_details);// 7
             $this->Phdef_mis_reg->insert_stu_admn_fee2($stu_admn_fee);// 8
             #xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
             if($admn_type=='jee')
             {
              $this->Phdef_mis_reg->insert_stu_section_data2($stu_section_data); // 9  only for JEE data
             }
             #xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
             ...
             if($admn_type!='jee')
             {
               ...
               $this->Phdef_mis_reg->insertbatch_stu_prev_education2($stu_prev_education_details);// 10 insert_batch
               $this->Phdef_mis_reg->insertbatch_stu_prev_certificate2($stu_prev_certificates_dynamic);// 11
             }
             else
             {
               $this->Phdef_mis_reg->insertbatch_stu_prev_education2($stu_prev_education_details);// 10 insert_batch
             ...
             $this->Phdef_mis_reg->insert_stu_enroll_passout2($stu_enroll_passout);// 12

             $this->Phdef_mis_reg->insert_web_people2($web_people); // 13 Insert web_people mis

             //$this->Phd_mis_reg->insert_web_people_iitism_web($web_people); // Insert in people in iitism website

             $last_id = $this->Phdef_mis_reg->insert_reg_regular_fee2($reg_regular_fee); // 14 misdev tables reg_regular_fee (db2)
             $reg_regular_form['form_id'] = $last_id;
             $this->Phdef_mis_reg->insert_reg_regular_form2($reg_regular_form); // 15
             if($admn_type!='jrf')
             {
             // $this->Phd_mis_reg->insert_reg_form2($reg_form);//
             $this->Phdef_mis_reg->insert_fb_student_feedback2($fb_student_feedback); // 16
             }
             $this->Phdef_mis_reg->insert_hostel2($hs_assigned_student_room);
             $this->Phdef_mis_reg->insert_hs_student_allotment_list2($hs_student_allotment_list); // 17

            $this->Phdef_mis_reg->insert_email_form2($email_form); // 18 Insert IITISM Email
            $pk_id_emaildata = $this->Phd_mis_reg->get_pk_id_add_1_emaildata2();
            $emaildata['pk'] = $pk_id_emaildata['pk'];
            $this->Phdef_mis_reg->insert_emaildata2($emaildata); // 19 Insert IITISM Email

            $this->Phdef_mis_reg->insert_hs_info2($hs_info);// 20 Insert hs_info in mis

             if($login_id['is_prep']=='yes') {
              $this->Phdef_mis_reg->insertPreparatory2($login_id['admn_no']); // 21
             }
  ...
  public function download_receipt($receipt_payment)
    {
      ...
      $this->load->helper(array('dompdf', 'file'));
		  ...
		  $html = $this->load->view('admission/phdef/generate_receipt_print_view', $data, TRUE);
