...
class Adm_phdef_personal_details extends MY_Controller {
  ...
  { 
    ...
    $data['application_details_ms']=$this->Adm_phdef_personal_details_model->get_adm_phd_appl_ms($get_reg_no);
   
    $data['qual12_details']=$this->Adm_phdef_personal_details_model->get_qualification12_details($get_reg_no);
    $data['qual10_details']=$this->Adm_phdef_personal_details_model->get_qualification10_details($get_reg_no);
    $data['qualug_details']=$this->Adm_phdef_personal_details_model->get_qualificationug_details($get_reg_no);
    $data['qualpg1_details']=$this->Adm_phdef_personal_details_model->get_qualificationpg1_details($get_reg_no);
    $data['qualpg2_details']=$this->Adm_phdef_personal_details_model->get_qualificationpg2_details($get_reg_no);

    $data['exp_details']=$this->Adm_phdef_personal_details_model->get_expreince_details($get_reg_no);
    $data['exp_details_d']=$this->Adm_phdef_personal_details_model->get_expreince_details_dynamic($get_reg_no);
    
    $data['phd_fello_details1']=$this->Adm_phdef_personal_details_model->get_phd_fello_score_details_one($get_reg_no);
    $data['phd_fello_details2']=$this->Adm_phdef_personal_details_model->get_phd_fello_score_details_two($get_reg_no);
    $data['phd_fello_details3']=$this->Adm_phdef_personal_details_model->get_phd_fello_score_details_three($get_reg_no);
    $data['phd_fello_details4']=$this->Adm_phdef_personal_details_model->get_phd_fello_score_details_four($get_reg_no);
    $data['phd_fello_details_iit']=$this->Adm_phdef_personal_details_model->get_phd_fello_score_details_iit($get_reg_no);

    $data['iit_details']=$this->Adm_phdef_personal_details_model->get_iitname_details();
    $data['p_addr_details']=$this->Adm_phdef_personal_details_model->get_p_address_details($get_reg_no);
    $data['c_addr_details']=$this->Adm_phdef_personal_details_model->get_c_address_details($get_reg_no);
    $data['state']=$this->Adm_phdef_personal_details_model->get_state();
    $data['full_partime']=$this->Add_phdef_registration_model->get_candidate_type_by_email($email);
    
    //base on conditon of prj ,AI ,EXT, PT,fecth dropdown 
    $data['fellowship_type_list']=$this->Adm_phdef_personal_details_model->get_fellowship_list($data['application_details_ms'][0]['assistance_type'],$get_reg_no);
    // echo "<pre>";
    // print_r($data);
    // exit;

    $data['pro_work_yes_no']=$this->Adm_phdef_personal_details_model->get_non_min_work_exp($get_reg_no);
    ...
    $this->load->view('admission/phdef/adm_phdef_application',$data);
  ...
  { 
    ...
    $email=$this->session->userdata('email');
    $full_partime=$this->Add_phdef_registration_model->get_candidate_type_by_email($email);
    ...
    { 
      ...
      { 
        ...
        { 
          ...
          // if($working_project=='Y')
          // {
          //   $this->Adm_phdef_personal_details_model->update_project_deatils_yes_no($project_details_yes,$get_reg_no);  
          // }
          // else
          // {
            $this->Adm_phdef_personal_details_model->update_project_deatils_yes_no($project_details_no,$get_reg_no);
        ...
        {
          // $this->Adm_phdef_personal_details_model->update_project_deatils_yes_no($part_time,$get_reg_no);
           
        }

        $this->Adm_phdef_personal_details_model->update_personal_deatils($personal_dteails,$get_reg_no);
       
        $this->Adm_phdef_personal_details_model->insert_address($permanent_address);
        $this->Adm_phdef_personal_details_model->insert_address($current_address);
      ...
      else 
      {
        ...
        $this->Adm_phdef_personal_details_model->update_personal_deatils($personal_dteails,$get_reg_no);
        $this->Adm_phdef_personal_details_model->update_p_address($p_permanent_address,$get_reg_no);
        $this->Adm_phdef_personal_details_model->update_c_address($c_current_address,$get_reg_no);
        $this->db->trans_complete();
        if ($this->db->trans_status() === FALSE) 
        {
    ...
    { 
      ...
      $data['registration_detail']=$this->Add_phdef_registration_model->get_registration_detail_by_email($email);
      $get_reg_no=$this->Add_phdef_registration_model->get_registration_no_by_email($email);
      $data['application_details']=$this->Adm_phdef_personal_details_model->get_adm_phd_reg_appl_program($get_reg_no);
      $data['application_details_ms']=$this->Adm_phdef_personal_details_model->get_adm_phd_appl_ms($get_reg_no);
      $data['qual12_details']=$this->Adm_phdef_personal_details_model->get_qualification12_details($get_reg_no);
      $data['qual10_details']=$this->Adm_phdef_personal_details_model->get_qualification10_details($get_reg_no);
      $data['qualug_details']=$this->Adm_phdef_personal_details_model->get_qualificationug_details($get_reg_no);
     // $data['pg_details']=$this->Adm_phd_personal_details_model->get_qualificationpg_details($get_reg_no);
      ...
      $data['exp_details']=$this->Adm_phdef_personal_details_model->get_expreince_details($get_reg_no);
      $data['exp_details_d']=$this->Adm_phdef_personal_details_model->get_expreince_details_dynamic($get_reg_no);
      $data['phd_fello_details']=$this->Adm_phdef_personal_details_model->get_phd_fello_score_details($get_reg_no);
      $data['iit_details']=$this->Adm_phdef_personal_details_model->get_iitname_details();
      $data['p_addr_details']=$this->Adm_phdef_personal_details_model->get_p_address_details($get_reg_no);
      $data['c_addr_details']=$this->Adm_phdef_personal_details_model->get_c_address_details($get_reg_no);
      $data['state']=$this->Adm_phdef_personal_details_model->get_state();
  ...
  public function get_education_detail()
  {
    ...
    $email=$this->session->userdata('email');
    $get_reg_no=$this->Add_phdef_registration_model->get_registration_no_by_email($email);
    $full_part_time=$this->Add_phdef_registration_model->get_candidate_type_by_email($email);
    $data['application_details_ms']=$this->Adm_phdef_personal_details_model->get_adm_phd_appl_ms($get_reg_no);
    ...
    if ($this->form_validation->run() == true) 
    {
      ...
      $qualrow=$this->Adm_phdef_personal_details_model->get_qual_row($get_reg_no);
      if($qualrow)
      {  
         //data will update 
         // exit;
        ...
        //   $this->load->model('admission/phd/Adm_phd_personal_details_model');
          ...
          { 
            ...
            {  
               ...
               if($have)
               {
                 $this->Adm_phdef_personal_details_model->update_phd_fello_details($fellowship_u1,$get_reg_no,'one');
               }
               else // else insert row if added
               {
                 $this->Adm_phdef_personal_details_model->insert_phd_fello_details($fellowship1);
               }
          ...
          { 
               $have=$this->Adm_phdef_personal_details_model->check_phd_fello_row($get_reg_no,'two');
               if($have)
               {
                $this->Adm_phdef_personal_details_model->update_phd_fello_details($fellowship_u2,$get_reg_no,'two');
               }
               else // else insert row if added
               {
                 $this->Adm_phdef_personal_details_model->insert_phd_fello_details($fellowship2);
               }
          ...
          { 
            $have=$this->Adm_phdef_personal_details_model->check_phd_fello_row($get_reg_no,'three');
            if($have)
            {
              $this->Adm_phdef_personal_details_model->update_phd_fello_details($fellowship_u3,$get_reg_no,'three');
            }
            else // else insert row if added
            {
              $this->Adm_phdef_personal_details_model->insert_phd_fello_details($fellowship3);
            }
          ...
          { 
            $have=$this->Adm_phdef_personal_details_model->check_phd_fello_row($get_reg_no,'four');
            if($have)
            {
              $this->Adm_phdef_personal_details_model->update_phd_fello_details($fellowship_u4,$get_reg_no,'four');
            }
            else // else insert row if added
            {
              $this->Adm_phdef_personal_details_model->insert_phd_fello_details($fellowship4);
            }
          ...
          if($btech_cgpa=='Y')
          {
            ...
            if($have)
            {
              $this->Adm_phdef_personal_details_model->update_phd_fello_details($fellowship_u_iit,$get_reg_no,'IIT Fellow');
            }
            else // else insert row if added
            {
              $this->Adm_phdef_personal_details_model->insert_phd_fello_details($fellowship_iit);
            }

           
          }
            
          $this->Adm_phdef_personal_details_model->update_personal_deatils($personal_details_iit,$get_reg_no);
          // echo $this->db->last_query();
          //   exit;
          $this->Adm_phdef_personal_details_model->update_qualification($u_educations_details10,$get_reg_no,'10 th');
          $this->Adm_phdef_personal_details_model->update_qualification($u_educations_details12,$get_reg_no,'12 th');
          $this->Adm_phdef_personal_details_model->update_qualification($u_educations_detailug,$get_reg_no,'UG Exam');
          ...
          { 
            ...
            if($have)
            {
              $this->Adm_phdef_personal_details_model->update_qualification($u_educations_detailspg1,$get_reg_no,'PG1 Exam');
            }
            else // else insert row if added
            {
              $this->Adm_phdef_personal_details_model->insert_qualification($educations_detailspg1);
            }
          ...
          { 
            $have=$this->Adm_phdef_personal_details_model->check_qualification_row($get_reg_no,'PG2 Exam');
            if($have)
            {
              $this->Adm_phdef_personal_details_model->update_qualification($u_educations_detailspg2,$get_reg_no,'PG2 Exam');
            }
            else // else insert row if added
            {
              $this->Adm_phdef_personal_details_model->insert_qualification($educations_detailspg2);
            }
      ...
      else
      {
        ...
        // echo $this->db->last_query();
        // exit;
        $this->Adm_phdef_personal_details_model->insert_qualification($educations_details10);
        $this->Adm_phdef_personal_details_model->insert_qualification($educations_details12);
        $this->Adm_phdef_personal_details_model->insert_qualification($educations_detailug);
        ...
        { 
          ...
          redirect('admission/phdef/Adm_phdef_personal_details');
          $this->adm_phdef_header($data);
          $this->load->view('admission/phdef/adm_phd_application',$data);
          $this->adm_phdef_footer();
        }
    ...
    {  
      ...
      $data['fellowship_type_list']=$this->Adm_phdef_personal_details_model->get_fellowship_list($data['application_details_ms'][0]['assistance_type']);
      ...
      $data['c_addr_details']=$this->Adm_phdef_personal_details_model->get_c_address_details($get_reg_no);
      $data['state']=$this->Adm_phd_personalef_details_model->get_state();
      $data['tab']="education";
      $this->session->set_userdata('education','education'); 
      $data['val']="H";
      $data['qualification']="qualification";
  ...
  { 
    ...
    { 
      ...
      $this->db->trans_start();
      $this->Adm_phdef_personal_details_model->update_tab1($tab,$get_reg_no);
      $this->Adm_phdef_personal_details_model->delete_all_work_experince($get_reg_no);
      $this->Adm_phdef_personal_details_model->update_personal_deatils($personal_dteails,$get_reg_no);
    ...
    {  
      ...
      $workexprow=$this->Adm_phdef_personal_details_model->get_work_exp_row($get_reg_no);
      if(empty($workexprow))
      {
        $this->db->trans_start();
        if(!empty($degination))
        {
          ...
          $this->Adm_phdef_personal_details_model->insert_work_experince_batch($datab);
        }
        
        $this->Adm_phdef_personal_details_model->update_personal_deatils($personal_dteails,$get_reg_no);
        
        $this->Adm_phdef_personal_details_model->insert_work_experince($work_exp_row1);
    ...
    {  
      ...
      $data['exp_details']=$this->Adm_phdef_personal_details_model->get_expreince_details($get_reg_no);
      $data['exp_details_d']=$this->Adm_phdef_personal_details_model->get_expreince_details_dynamic($get_reg_no); 
      $data['cat_details']=$this->Adm_phdef_personal_details_model->get_cat_score_details($get_reg_no);
      $data['iit_details']=$this->Adm_phdef_personal_details_model->get_iitname_details();
      $data['p_addr_details']=$this->Adm_phdef_personal_details_model->get_p_address_details($get_reg_no);
      $data['c_addr_details']=$this->Adm_phdef_personal_details_model->get_c_address_details($get_reg_no);
      $data['fellowship_type_list']=$this->Adm_phdef_personal_details_model->get_fellowship_list($data['application_details_ms'][0]['assistance_type']);
  ...
  public function final_submission()
  {
    ...
    {
      redirect('admission/phdef/Add_phdef/adm_phd_login');
    }
    // if(!($this->session->has_userdata('applied')))
    // {
    ...
    // echo $get_reg_no; echo "<br>";
    // echo $work_exp; echo "<br>";
    // echo $work_exp_total; echo "<br>";
    // echo $degination1; echo "<br>";
    // echo $organization1; echo "<br>";
    // echo $nature_of_work1; echo "<br>";
    // echo $work_exp_total; echo "<br>";
    // echo $duration1; echo "<br>";
    // echo $degination; echo "<br>";
    // echo $organization; echo "<br>";
    // echo $duration; echo "<br>";
    // echo $duration_in_monthd; echo "<br>";
  ...
  public function display_edu_detail_w() //for deleting qualification row
  {
    ...
    $msg=$this->Adm_phdef_personal_details_model->delete_row_work_qualification($cond); 
  ...
  public function display_work_detail_w() //for deleting working experince row
  {
    ...
    $msg=$this->Adm_phdef_personal_details_model->delete_row_work_experince($cond);
    echo json_encode($msg);  
  ...
  { 
    ...
    $get_reg_no=$this->Add_phdef_registration_model->get_registration_no_by_email($email);
    $data['registration_detail']=$this->Add_phdef_registration_model->get_registration_detail_by_email($email);
    if (!file_exists('./assets/admission/phdef/'.$get_reg_no))
    {
      mkdir('./assets/admission/phdef/'.$get_reg_no, 0777, true);
    }
        //upload file
        $config['upload_path'] = './assets/admission/phdef/'.$get_reg_no;
           ...
           else
            {
                ...
                else 
                {
                  ...
                  { 
                    ...
                    $k=base_url()."assets/admission/phdef/".$get_reg_no."/".$file.$get_reg_no.".pdf";
                    if($file=='photo'|| $file =='signature')
                    {
                      $k=base_url()."assets/admission/phdef/".$get_reg_no."/".$file.$get_reg_no.".jpg";
                      $document=array( 
                        'registration_no'=>$get_reg_no,
                        'doc_id'=>$doctype,
                        'doc_path'=>'assets/admission/phdef/'.$get_reg_no.'/'.$file.$get_reg_no.'.jpg',
                        'created_by'=>$email
                      );
                    }
                    else
                    {
                      $document=array( 
                        'registration_no'=>$get_reg_no,
                        'doc_id'=>$doctype,
                        'doc_path'=>'assets/admission/phdef/'.$get_reg_no.'/'.$file.$get_reg_no.'.pdf',
                        'created_by'=>$email
                      );
                    }
                   
                    if($this->Adm_phdef_personal_details_model->insert_document_val($document))
                    {
                      $upload='doc_ok';
                    }
                    else
  ...
  { 
    ...
    $files =(file_exists('assets/admission/phdef/'.$get_reg_no.'/'.$file.$get_reg_no.'.pdf'));
    if($files)
    {
      ...
      if($this->Adm_phdef_personal_details_model->remove_document_val($cond))
      {
        $upload='doc_remove';
      }
      else
