                                                             ...
                                                             <div class="row">
                                                                  ...
                                                                  <div class="col-md-12" class="text-center">
                                                                        ...
                                                                        <?php
                                                                           ...
                                                                           echo form_open('admission/Adm_mba_admisison_payment/proceed_to_payment', $attributes); ?>
                                                                                ...
                                                                                <tbody>
                                                                                  <?php
                                                                                    ...
                                                                                    {?>
                                                                                        <tr>
                                                                                            <td><?php echo $i;?></td>
                                                                                            <td><?php if($row['program_id']=='ba'){ echo "Business Analytics";}  if($row['program_id']=='mba'){ echo " Master of Business Administration";}?></td>
