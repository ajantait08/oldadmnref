                                ...
                                <div class="row">
                                                ...
                                                <?php if($interview_count > 0){ if (!empty($program)) {   $j=1; ?>
                                                    ...
                                                    <?php foreach ($program as $prgm) {
                                                        ...
                                                        ?>
                                                            ...
                                                            <?php if($prgm->program_id=='ba') 
                                                              { ?>
                                                                <a href="<?php echo base_url(); ?>/assets/admission/mba/brochure/Wait_List_1 _MBA _BA_Single_File.pdf" target="_blank"><button class="btn btn-sm btn-info">Wait List  MBA(BA)</button></a><br/><br/>
                                                             <?php }

                                                              if($prgm->program_id=='mba')
                                                              { ?>
                                                                  <a href="<?php echo base_url(); ?>/assets/admission/mba/brochure/Wait_List_1_MBA_Single_File.pdf" target="_blank"><button class="btn btn-sm btn-info">Wait List  MBA(MBA)</button></a><br/><br/>
                                                              <?php }
                                                            ?>  
                                    ...
                                    <div class="row">
                                       ...
                                       <?php } elseif($count_ml_with_payment > 0) { ?>
                                        ...
                                        <div class="col-md-12 col-lg-12 col-sm-12">
                    <div class="panel panel-primary news_back">
                        <div class="panel-heading">MBA Admission Status
                        </div>
                        <div class="panel-body">
                                        <table>
                                            <thead>
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <?php } else { ?>
                                                                <td data-label="Action">
                                                                    <!-- <a href="<?php echo base_url(); ?>index.php/admission/Adm_mba_application_preview/application_preview" target="_blank"><button class="btn btn-sm  btn-primary">Preview</button></a><br/><br/> -->
                                                                    <a href="<?php echo base_url(); ?>index.php/admission/Adm_mba_application_preview/payment_receipt_admission"><button class="btn btn-sm btn-info">Payment Receipt</button></a><br/><br/>
                                                                    <?php if (!empty($selected_program_details_with_payment)) {
                                                                        foreach ($selected_program_details_with_payment as $value) { if($value->program_id == 'ba') {?>
                                                                            <a href="<?php echo base_url();?>index.php/admission/Adm_mba_application_preview/application_download_mba_ba"><button class="btn btn-sm  btn-success">Offer Letter MBA(BA)</button></a><br/>
                                                                       <?php } else { ?>
                                                                        <a href="<?php echo base_url();?>index.php/admission/Adm_mba_application_preview/application_download_mba"><button class="btn btn-sm  btn-success">Offer Letter MBA</button></a><br/>
                                                                       <?php } }}
                                                                        ?>
