                    ...
                    <?php }?>
                                ...
                                <table style="margin-top: 0px;">
                                    ...
                                    <tbody>
                                        ...
                                        <td style="width: 12.0372%; height: 46px; text-align: center;"><span style="font-size: 18px;"><strong>Date to be announced later</strong></span></td>
                                        </tr>
                                        <tr style="height: 46px;">
                                        ...
                                        <td style="width: 12.0372%; text-align: center; height: 51px;"><span style="font-size: 18px;"><strong>Date to be announced later&nbsp;</strong></span></td>
                                        </tr>
                                        <tr style="height: 51px;">
