                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-lg-12">
                                    <button class="btn btn-danger" style="width:100%;"><a href="<?php echo base_url() ?>index.php/admission/phd/Adm_phd_registration/logout"><b style="text-decoration: none; color: white;">Logout</b></a> </button>
                                </div>
                            </div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <?php } else { ?>
                                                                <td data-label="Action">
                                                                    <a href="<?php echo base_url(); ?>index.php/admission/phd/Adm_phd_application_preview/application_preview" target="_blank"><button class="btn btn-sm  btn-primary">Preview</button></a><br /><br />
                                                                    <a href="<?php echo base_url(); ?>index.php/admission/phd/Adm_phd_application_preview/payment_receipt"><button class="btn btn-sm btn-primary">Payment Receipt</button></a>
                                                                </td>
                                                            <?php }
                                                            ?>
                                                        </tr>
...
<?php /* if(!empty($interview)){ */ if($interview_count > 0){ if(!empty($interview)){ ?>
                                                ...
                                                <p class="blink-one" style="font-size:15px;color:green;">Please Click on below Interview Call letter to Proceed</p>
                                                 <div class="row">
                                                        <div class="col-md-12 col-sm-12 col-lg-12">
                                                            ...
                                                            <input class="btn btn-primary" style="width:100%;" type="button" onclick="location.href='<?php echo base_url() ?>'+'index.php/admission/phd/Adm_phd_application_preview/admission_interview_call_letter'" value="Interview Call Letter"/>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div class="col-md-12 col-sm-12 col-lg-12">
                                <!-- <button class="btn btn-info" style="width:100%;"><a href="<?php echo base_url() ?>index.php/admission/Adm_phd_application_preview/"><b style="text-decoration: none; color: white;">My Application Status</b></a> </button> -->
                                <input class="btn btn-info" style="width:100%;" type="button" onclick="location.href='<?php echo base_url() ?>'+'index.php/admission/phd/Adm_phd_application_preview/admission_offer_letter'" value="Offer Letter"/>
                            </div>
                            </div>
                            ...
                            <tr>
                                ...
                                <?php } else { ?>
                                    <td data-label="Action">
                                        ...
                                        <a href="<?php echo base_url(); ?>index.php/admission/phd/Adm_phd_application_preview/payment_receipt_admission"><button class="btn btn-sm btn-info">Payment Receipt</button></a><br/><br/>
                                        <?php if (!empty($selected_program_details_with_payment)) { ?>
                                           <?php foreach ($selected_program_details_with_payment as $program_payment) { ?>
                                            <a href="<?php echo base_url();?>index.php/admission/phd/Adm_phd_application_preview/application_download_phd/<?php echo $program_payment->program_id; ?>/<?php echo $program_payment->program_desc; ?>"><button class="btn btn-sm  btn-success">Offer Letter PHD for <?php echo $program_payment->program_id;  ?></button></a><br/>
                                            <?php } ?>
                                        <?php }
                                            ?>
...
window.location.href="<?php echo base_url(); ?>index.php/admission/phd/Adm_phd_mis_registration_other_details/mis_reg_stu_other_details_preview";
});
