                                                        ...
                                                        <div class="tab-pane active" role="tabpanel" id="step4">
                                                            ...
                                                            <?php }?>
                                                             <?php  $attributes = array('class' => 'email', 'id' => 'btn_document','name'=>'p_details','enctype'=>'multipart/form-data');
                                                                echo form_open('admission/phd/Adm_phd_document/document_submit', $attributes); ?>
       ...
       $('#formcheck').click(function()
            {
                ...
                var count=$('#doc_t').val();
                $.ajax({
                url: base_url+'/index.php/admission/phd/Adm_phd_document/validate_photo_signature_doc',
                type: "POST",
                // dataType:'json',
                data: {"total":count},
...
function doc_upload(filenameid,link,msg,button_id)
{
    ...
    $.ajax({
        url: base_url+'/index.php/admission/phd/Adm_phd_document/document_upload/'+valchek, // point to server-side controller method
...
function doc_remove(filenameid,link,msg,button_id)
{
   ...
   if(hrefval==='#')
   {
    ...
    form_data.append(filenameid, file_data);
    $.ajax({
        url: base_url+'/index.php/admission/phd/Adm_phd_document/document_remove/'+filenameid, // point to server-side controller method
        dataType: 'json', // what to expect back from the server
        cache: false,
        contentType: false,
        processData: false,
