...
?>
                <!-- <p>Fill all form field to go to next step</p> -->
                    ...
                    <fieldset>
                    <form id="msform" class="form-horizontal" method="post" accept-charset="utf-8" enctype="multipart/form-data" action="<?php echo base_url(); ?>index.php/admission/phd/Adm_phd_mis_registration_other_details/save_registrtaion_no_other_details">
...
<script>
  $(document).ready(function(){
    $(".previous").click(function(){
      window.location.href = "<?php echo base_url().'index.php/admission/phd/Adm_phd_mis_registration_education/manage_previous_parent_details'; ?>";
    });
  });
</script>
