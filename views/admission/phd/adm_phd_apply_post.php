                        ...
                        <div class="panel-body">
                            ...
                            ?>
                                <section class="signup-step-container">
                                    <div id="sponserd">
                                        <form id="apply_post" action="<?php echo base_url() ?>index.php/admission/phd/Adm_phd_user_dashboard/get_apply_post" method="POST" control="" class="form-group register">
                                            <div class="row">
                                                <div class="col-md-3">
                                                    ...
                                                    foreach ($fill_appl_details as $row) { ?>
                                                        <tr>
                                                            ...
                                                            <?php 
                                                                ...
                                                                $specail_val=$this->Add_phd_registration_model->get_specialization_reg_pro($row->registration_no,$row->program_id);
                                                                    ...
                                                                    <div class="modal-dialog modal-dialog-centered">
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body">
                                                                                <div class="box-body ">
                                                                                    <form method="POST" action="<?php echo base_url() ?>index.php/admission/phd/Adm_phd_user_dashboard/education_apply_post" method="POST">
...
<!--row start  -->
<script type="text/javascript" src="<?php echo base_url(); ?>themes/dist/js/phd/adm_phd_apply.js"></script>
<script type="text/javascript">
    $(document).ready(function() 
    {   
        ...
        $("#programme_apply_for").change(function(event) 
        {
            ...
            $.ajax({
                url: "<?php echo base_url() ?>index.php/admission/phd/Adm_phd_user_dashboard/get_program_elligibilty",
                type: "POST",
                // dataType:'json',
                data: {
            ...
            $.ajax({
                url: "<?php echo base_url() ?>index.php/admission/phd/Adm_phd_user_dashboard/get_specialization_by_program_id",
                type: "POST",
                // dataType:'json',
                data: {
                    "programme_apply_for": programme_apply_for
