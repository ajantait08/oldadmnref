                    ...
                    <div class="panel panel-primary news_back">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <input class="btn btn-danger" style="width:100%;" type="button" onclick="location.href='<?php echo base_url() ?>'+'index.php/admission/phd/Adm_registration/logout'" value="Logout" />
                                    ...
                                    # code...
                                        ...
                                        <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td><strong id="ref_no"><?php echo $registration_no; ?></strong></td>
                                            </tr>
                                            <tr>
                                                <td>Order no :</td>
...
<!-- <script type="text/javascript" src="<?php echo base_url();?>themes/dist/js/phd/adm_phd/adm_phd_education.js"></script> -->
