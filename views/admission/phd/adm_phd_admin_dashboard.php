...
<html lang="en">
<head>
<title>Phd ADDMISSION  Dashboard</title>
<meta charset="utf-8">
   ...
   <div id="wrapper">
      ...
      <div id="sidebar-wrapper">
         <ul class="sidebar-nav nav-pills nav-stacked" id="menu">
            ...
            <li>
               <a href="#"><span class="fa-stack fa-lg pull-left"><i class="fa fa-flag fa-stack-1x "></i></span>Phd ADMISSION</a>
               <ul class="nav-pills nav-stacked" style="list-style-type:none;">
            ...
            <li>
               <a href="#"> <span class="fa-stack fa-lg pull-left"><i class="fa fa-cart-plus fa-stack-1x "></i></span>Phd ADMISSION REPORT</a>
            </li>
            <li>
