...
<body>
    <div class="page" width="8.3 inches" height="11.7 inches" align="center">
        ...
        <table class="mtech-nb" style="margin: 0.01in 0.01in 0.01in 0.01in; width:100%" align="center">
            ...
            <tr>
                <td>
                    ...
                    IIT (ISM) Dhanbad under <b>Visvesvaraya PhD Scheme.</b> The interview for the Ph.D. admission 2022
                    (Phase II) is scheduled to be held
                    on <span style="color:red;"><b>11.12.2022 (Sunday with reporting time 10:00 AM), at the Seminar
                            Room of Electronics Engineering Department.</b></span><span><b>The Interview Call Letter
                            can be downloaded from the PhD Admission Portal of IIT (ISM) Dhanbad.</b>.
                </td>
            </tr>
        </table>
        ...
        <table class="mtech-nb" style="margin: 0.01in 0.01in 0.01in 0.01in; width:100%" align="center">
            ...
            <tr>
                <td>
                    You are requested to be present for the interview on the scheduled date and time at the mentioned
                    venue in the campus.
                    <span style="color:blue;"><u><b>You are requested to make arrangements for to and fro travel and
                                your
                                accommodation arrangements on your own. No TA/DA will be provided by IIT (ISM)
                                Dhanbad.</b></u></span>
                </td>
            </tr>
        </table>
                ...
                <td>
                    ...
                    <ul style="list-style:none;">
                        ...
                        <ul style="list-style:none;">
                            ...
                            <li>
                                i. NOC from Employer if applicable.
                            </li>
                            <li>
        ...
        <table class="mtech-nb" style="margin: 0.01in 0.01in 0.01in 0.01in; width:100%;" align="center">
            ...
            <tr>
                <td style="color:red;">
                    <b>Publication of the interview list and Call to the Interview does not confer any right for
                        selection/appointment and is subjected to the verification of original certificates/documents
