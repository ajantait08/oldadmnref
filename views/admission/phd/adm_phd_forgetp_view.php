<link href="<?php echo base_url();?>themes/dist/css/phd/login.css" rel="stylesheet" media="screen">
<style>
.myalert
{
  color:white;
                    ...
                    <div style="margin-top: 481px;">
                        <div class="container-center"> 
                            ...
                            <?php
                                ...
                                echo form_open('admission/phd/Adm_phd_forgetp/forget_password', $attributes); 
                            ...
                            <input class="btn btn-danger" style="width:100%;" type="button" onclick="location.href='<?php echo base_url() ?>'+'index.php/admission/phd/add_phd/adm_phd_login'" value="Did you remember? Sign In" />
                           </p>
                        </div>
                    </div> 
                </div>
