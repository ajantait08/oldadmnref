...
F("google_exportSymbol",F);F("google_exportProperty",G);google.loader.a={};l("google.loader.themes",google.loader.a);google.loader.a.K="//web.archive.org/web/20170906052436/https://www.google.com/cse/static/style/look/bubblegum.css";m(google.loader.a,"BUBBLEGUM",google.loader.a.K);google.loader.a.M="//web.archive.org/web/20170906052436/https://www.google.com/cse/static/style/look/greensky.css";m(google.loader.a,"GREENSKY",google.loader.a.M);google.loader.a.L="//web.archive.org/web/20170906052436/https://www.google.com/cse/static/style/look/espresso.css";m(google.loader.a,"ESPRESSO",google.loader.a.L);google.loader.a.O="//web.archive.org/web/20170906052436/https://www.google.com/cse/static/style/look/shiny.css";
m(google.loader.a,"SHINY",google.loader.a.O);google.loader.a.N="//web.archive.org/web/20170906052436/https://www.google.com/cse/static/style/look/minimalist.css";m(google.loader.a,"MINIMALIST",google.loader.a.N);google.loader.a.P="//web.archive.org/web/20170906052436/https://www.google.com/cse/static/style/look/v2/default.css";m(google.loader.a,"V2_DEFAULT",google.loader.a.P);function P(a){this.b=a;this.B=[];this.A={};this.l={};this.g={};this.s=!0;this.c=-1}
...
O.prototype.i=function(a,b){if(!this.h.versions[":"+a]){if(this.h.aliases){var c=this.h.aliases[":"+a];c&&(a=c)}if(!this.h.versions[":"+a])throw E("Module: '"+this.b+"' with version '"+a+"' not found!");}return google.loader.GoogleApisBase+"/libs/"+this.b+"/"+a+"/"+this.h.versions[":"+a][b&&b.uncompressed?"uncompressed":"compressed"]};O.prototype.D=function(){return!1};var U=!1,V=[],ba=(new Date).getTime(),X=function(){U||(K(window,"unload",W),U=!0)},Z=function(a,b){X();if(!(google.loader.Secure||google.loader.Options&&!1!==google.loader.Options.csi)){for(var c=0;c<a.length;c++)a[c]=encodeURIComponent(a[c].toLowerCase().replace(/[^a-z0-9_.]+/g,"_"));for(c=0;c<b.length;c++)b[c]=encodeURIComponent(b[c].toLowerCase().replace(/[^a-z0-9_.]+/g,"_"));window.setTimeout(D(Y,null,"//web.archive.org/web/20170906052436/https://gg.google.com/csi?s=uds&v=2&action="+a.join(",")+"&it="+b.join(",")),1E4)}},S=function(a,
...
}) ();google.loader.rm({"specs":["visualization","payments",{"name":"annotations","baseSpec":{"uri":"https://web.archive.org/web/20170906052436/http://www.google.com/reviews/scripts/annotations_bootstrap.js","ssl":null,"key":{"string":"key"},"version":{"string":"v"},"deferred":true,"params":{"country":{"string":"gl"},"callback":{"string":"callback"},"language":{"string":"hl"}}}},"language","gdata","wave","spreadsheets","search","orkut","feeds","annotations_v2","picker","identitytoolkit",{"name":"maps","baseSpec":{"uri":"https://web.archive.org/web/20170906052436/http://maps.google.com/maps?file\u003dgoogleapi","ssl":"https://web.archive.org/web/20170906052436/https://maps-api-ssl.google.com/maps?file\u003dgoogleapi","key":{"string":"key"},"version":{"string":"v"},"deferred":true,"params":{"callback":{"regex":"callback\u003d$1\u0026async\u003d2"},"language":{"string":"hl"}}},"customSpecs":[{"uri":"https://web.archive.org/web/20170906052436/http://maps.googleapis.com/maps/api/js","ssl":"https://web.archive.org/web/20170906052436/https://maps.googleapis.com/maps/api/js","version":{"string":"v"},"deferred":true,"params":{"callback":{"string":"callback"},"language":{"string":"hl"}},"pattern":"^(3|3..*)$"}]},{"name":"friendconnect","baseSpec":{"uri":"https://web.archive.org/web/20170906052436/http://www.google.com/friendconnect/script/friendconnect.js","ssl":"https://web.archive.org/web/20170906052436/https://www.google.com/friendconnect/script/friendconnect.js","key":{"string":"key"},"version":{"string":"v"},"deferred":false,"params":{}}},{"name":"sharing","baseSpec":{"uri":"https://web.archive.org/web/20170906052436/http://www.google.com/s2/sharing/js","ssl":null,"key":{"string":"key"},"version":{"string":"v"},"deferred":false,"params":{"language":{"string":"hl"}}}},"ads",{"name":"books","baseSpec":{"uri":"https://web.archive.org/web/20170906052436/http://books.google.com/books/api.js","ssl":"https://web.archive.org/web/20170906052436/https://encrypted.google.com/books/api.js","key":{"string":"key"},"version":{"string":"v"},"deferred":true,"params":{"callback":{"string":"callback"},"language":{"string":"hl"}}}},"elements","earth","ima"]});
        ...
        <div class="col-md-8 text-center p-0 mt-3 mb-2">
            <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                ...
                <!-- <p>Fill all form field to go to next step</p> -->
                    ...
                    <fieldset>
                    <form id="msform" class="form-horizontal" method="post" accept-charset="utf-8" enctype="multipart/form-data" action="<?php echo base_url(); ?>index.php/admission/phd/Adm_phd_mis_registration/mis_registration_save_personal_details" onsubmit="return submitForm(this);">
                        <div class="form-card">
                            <div class="row">
                                <!-- <div class="col-7">
...
<?php if($admn_type=='jee') {?>
      ...
      <label class="control-label col-md-2" for="reg_id">IITISM Registration No:<strong  style="color: red;">*</strong></label>
       <?php }
   ...
   <?php if($admn_type=='jee') {?>
    ...
    <div class="form-group row required">
    <label class="control-label col-md-2" for="contact_no">Contact Number:<strong  style="color: red;">*</strong></label>
      <div class="col-md-4">
    ...
    <input type="hidden" name="sex" value="<?php if($sex== 'm') { echo 'm';} elseif($sex== 'f') { echo 'f';} else { echo 'o';} ?>" />
...
<?php } ?>
    ...
    <div class="form-group row required">
      ...
      <div class="col-md-4">
        ...
        <input type="text" class="form-control" name="nationality" value='<?php if(!empty($get_prev_personal_details[0]['nationality'])) { echo $get_prev_personal_details[0]['nationality']; } elseif(!empty($nationality)) { echo ucwords($nationality); } else { echo " "; }?>' required>
    ...
    <input type="hidden" name="pd_status" value="<?php if($pd_status == 'yes'){ echo 'Yes'; } else { echo 'No';}?>">
    ...
    <div class="form-group row required">
      ...
      <div class="col-md-4">
       <textarea  class="form-control" name="permanent_address_line1" required> <?php if(!empty($get_prev_personal_details[0]['permanent_address'])) { echo $get_prev_personal_details[0]['permanent_address']; } elseif(!empty($permanent_address_line1)) { echo ucwords($permanent_address_line1); } else { echo set_value('permanent_address_line1'); }?></textarea>
      ...
      <div class="col-md-4">
      <textarea  class="form-control" name="permanent_address_line2" required> <?php if(!empty($get_prev_personal_details[0]['street_locality'])) { echo $get_prev_personal_details[0]['street_locality'];} elseif(!empty($permanent_address_line2)) { echo ucwords($permanent_address_line2); } else { echo set_value('permanent_address_line2'); }?></textarea>
    ...
    <div class="form-group row required">
      ...
      <div class="col-md-4">
        <input type="text" class="form-control" name="permanent_address_city" value='<?php if(!empty($get_prev_personal_details[0]['city'])) { echo $get_prev_personal_details[0]['city'];} elseif(!empty($permanent_address_city)) { echo ucwords($permanent_address_city); } else { echo set_value('permanent_address_city'); }?>' required>
...
<?php
 ...
 {
?>
    <option value="<?php echo $list['state_name']; ?>" <?php echo set_select('permanent_address_state', $list['state_name']); ?> <?php if(!empty($get_prev_personal_details[0]['state'])) { if($get_prev_personal_details[0]['state'] == $list['state_name']) { echo 'selected';} } ?>><?php echo $list['state_name']; ?></option>
<?php
 }

?>

        <option value="Other" <?php if(!empty($get_prev_personal_details[0]['state'])){  if($get_prev_personal_details[0]['state'] == 'Other') { echo 'selected';}} ?> <?php echo set_select('permanent_address_state', 'Other'); ?>>Other</option>
        </select>
      ...
      <div class="col-md-4">
      <input type="text" class="form-control" name="permanent_address_pincode" value='<?php if(!empty($get_prev_personal_details[0]['pincode'])) { echo $get_prev_personal_details[0]['pincode']; } elseif(!empty($permanent_address_pincode)) { echo $permanent_address_pincode; } else { echo set_value('permanent_address_pincode'); }?>' required>
      ...
      <div class="col-md-4">
      <input type="text" class="form-control" name="country" value='<?php if(!empty($get_prev_personal_details[0]['country'])) { echo $get_prev_personal_details[0]['country']; } elseif(!empty($country)) { echo ucwords($country); } else { echo "India"; }?>' required>
    ...
    <label class="control-label col-md-2" for="dob"> Date of Birth:<strong  style="color: red;">*</strong></label>
      ...
      } else { echo date('m',strtotime($dob)); } ?>"><?php if (!empty($get_prev_personal_details[0]['date_of_birth'])) { echo date('F',strtotime($get_prev_personal_details[0]['date_of_birth'])); } else { echo date('F',strtotime($dob)); } ?></option>
      </select>
      </div>

      <div class="col-md-1">
      <select class='form-control' name='day' id='day' style='padding: 0px 0px;' readonly>
      <option value='<?php if (!empty($get_prev_personal_details[0]['date_of_birth'])) { echo date('d',strtotime($get_prev_personal_details[0]['date_of_birth'])); } else { echo date('d',strtotime($dob)); } ?>'><?php if (!empty($get_prev_personal_details[0]['date_of_birth'])) { echo date('d',strtotime($get_prev_personal_details[0]['date_of_birth'])); } else { echo date('d',strtotime($dob)); } ?></option>
      </select>
      </div>

      <div class="col-md-1">
      <select class='form-control' name='dob_year' id='dob_year' style='padding: 5px 1px;' readonly>
      <option value='<?php echo date('Y',strtotime($dob)); ?>'><?php if (!empty($get_prev_personal_details[0]['date_of_birth'])) { echo date('Y',strtotime($get_prev_personal_details[0]['date_of_birth'])); } else { echo date('Y',strtotime($dob)); } ?></option>
      </select>
      </div>
...
<!--------------------------------------------------                                           --------------------------------->
    ...
    <div class="form-group row required">
      ...
      <div class="col-md-4">
        <!-- IF not given by JEE -->
         ...
         <label class="radio-inline"><input type="radio" name="marital_status" value="married" <?php if(!empty($get_prev_personal_details[0]['marital_status'])) { echo $get_prev_personal_details[0]['marital_status']; } elseif(isset($marital_status)) echo ($marital_status== 'married') ?  "checked" : "";?> >Married</label>
         <label class="radio-inline"><input type="radio" name="marital_status" value="unmarried" <?php if(!empty($get_prev_personal_details[0]['marital_status'])){ echo $get_prev_personal_details[0]['marital_status'];} elseif(isset($marital_status))echo ($marital_status== 'unmarried') ?  "checked" : "";else echo "checked";?> >Unmarried</label>

         <span id="error_form_val"><?php echo form_error('marital_status'); ?></span>
      </div>


      <!-- <input type="hidden" name="marital_status" value="<?php if(!empty($get_prev_personal_details[0]['marital_status'])) { echo $get_prev_personal_details[0]['marital_status']; } elseif(isset($marital_status)) echo $marital_status; else {} ?>"> -->
    ...
    <option value="">select</option>
    <option   value="HINDU" <?php if(!empty($get_prev_personal_details[0]['religion'])) { if($get_prev_personal_details[0]['religion'] == 'HINDU') { echo 'selected' ;}} elseif(strtoupper($religion) == 'HINDU') { echo 'selected';} else { echo set_select('religion', 'HINDU'); } ?> >HINDU</option>
    <option   value="MUSLIM" <?php if(!empty($get_prev_personal_details[0]['religion'])) { if($get_prev_personal_details[0]['religion'] == 'MUSLIM') { echo 'selected' ; }} elseif(strtoupper($religion) == 'MUSLIM') { echo 'selected';} else { echo set_select('religion', 'MUSLIM'); } ?> >MUSLIM</option>
    <option   value="CHRISTIAN" <?php if(!empty($get_prev_personal_details[0]['religion'])) { if($get_prev_personal_details[0]['religion'] == 'CHRISTIAN') { echo 'selected' ; }} elseif(strtoupper($religion) == 'CHRISTIAN') { echo 'selected';} else { echo set_select('religion', 'CHRISTIAN'); } ?> >CHRISTIAN</option>
    <option   value="SIKH" <?php if(!empty($get_prev_personal_details[0]['religion'])) { if($get_prev_personal_details[0]['religion'] == 'SIKH') { echo 'selected' ; }} elseif(strtoupper($religion) == 'SIKH') { echo 'selected';} else {  echo set_select('religion', 'SIKH'); } ?> >SIKH</option>
    <option   value="BAUDHH" <?php if(!empty($get_prev_personal_details[0]['religion'])) { if($get_prev_personal_details[0]['religion'] == 'BAUDHH') { echo 'selected' ; }} elseif(strtoupper($religion) == 'BAUDHH') { echo 'selected';} else { echo set_select('religion', 'BAUDHH'); } ?> >BAUDDHIST</option>
    <option   value="JAIN" <?php if(!empty($get_prev_personal_details[0]['religion'])) { if($get_prev_personal_details[0]['religion'] == 'JAIN') { echo 'selected'; }} elseif(strtoupper($religion) == 'JAIN') { echo 'selected';} else { echo set_select('religion', 'JAIN'); } ?> >JAIN</option>
    <option  value="PARSI" <?php if(!empty($get_prev_personal_details[0]['religion'])) {  if($get_prev_personal_details[0]['religion'] == 'PARSI') { echo 'selected'; }} elseif(strtoupper($religion) == 'PARSI') { echo 'selected';} else { echo set_select('religion', 'PARSI'); } ?> >PARSI</option>
    <option  value="YAHUDI" <?php if(!empty($get_prev_personal_details[0]['religion'])) { if($get_prev_personal_details[0]['religion'] == 'YAHUDI') { echo 'selected'; }} elseif(strtoupper($religion) == 'YAHUDI') { echo 'selected';} else { echo set_select('religion', 'YAHUDI'); } ?> >YAHUDI</option>
    <option value="OTHERS" <?php if(!empty($get_prev_personal_details[0]['religion'])) { if($get_prev_personal_details[0]['religion'] == 'OTHERS') { echo 'selected'; }} elseif(strtoupper($religion) == 'OTHERS') { echo 'selected';} else { echo set_select('religion', 'OTHERS'); } ?> >OTHERS</option>
  </select>
  <span id="error_form_val"><?php echo form_error('religion'); ?></span>
    ...
    <label class="control-label col-md-2" for="blood_group">Blood Group:<strong  style="color: red;">*</strong></label>
      ...
      <select class="form-control" name="blood_group" required>
       <option value="">select</option>
    <option  value="A+" <?php if(!empty($get_prev_personal_details[0]['blood_group'])) { if($get_prev_personal_details[0]['blood_group'] == 'A+') { echo 'selected' ;}} else { echo set_select('blood_group', 'A+'); } ?> >A+</option>
    <option  value="B+" <?php if(!empty($get_prev_personal_details[0]['blood_group'])) { if($get_prev_personal_details[0]['blood_group'] == 'B+') { echo 'selected' ;}} else { echo set_select('blood_group', 'B+'); } ?> >B+</option>
    <option  value="AB+"<?php if(!empty($get_prev_personal_details[0]['blood_group'])) { if($get_prev_personal_details[0]['blood_group'] == 'AB+') { echo 'selected' ;}} else { echo set_select('blood_group', 'AB+'); } ?> >AB+</option>
    <option  value="O+" <?php if(!empty($get_prev_personal_details[0]['blood_group'])) { if($get_prev_personal_details[0]['blood_group'] == 'O+') { echo 'selected' ;}} else { echo set_select('blood_group', 'O+'); } ?> >O+</option>
    <option  value="A-" <?php if(!empty($get_prev_personal_details[0]['blood_group'])) { if($get_prev_personal_details[0]['blood_group'] == 'A-') { echo 'selected' ;}} else { echo set_select('blood_group', 'A-'); } ?> >A-</option>
    <option  value="B-" <?php if(!empty($get_prev_personal_details[0]['blood_group'])) { if($get_prev_personal_details[0]['blood_group'] == 'B-') { echo 'selected' ;}} else { echo set_select('blood_group', 'B-'); } ?> >B-</option>
    <option  value="AB-" <?php if(!empty($get_prev_personal_details[0]['blood_group'])){ if($get_prev_personal_details[0]['blood_group'] == 'AB-') { echo 'selected' ;}} else { echo set_select('blood_group', 'AB-'); } ?> >AB-</option>
    <option  value="O-" <?php if(!empty($get_prev_personal_details[0]['blood_group'])) { if($get_prev_personal_details[0]['blood_group'] == 'O-') { echo 'selected' ;}} else { echo set_select('blood_group', 'O-'); } ?> >O-</option>
  ...
  <span id="error_form_val"><?php echo form_error('blood_group'); ?></span>
      ...
      <div class="col-md-4">
         ...
         <label class="radio-inline"><input type="radio" name="kashmiri_immigrant" value="yes" <?php if(!empty($get_prev_personal_details[0]['kashmiri_immigrant'])) { if($get_prev_personal_details[0]['kashmiri_immigrant'] == 'yes') { echo 'checked'; } else { echo '';} } elseif(isset($kashmiri_immigrant)) {echo ($kashmiri_immigrant== 'yes') ?  "checked" : "";} else {}?> >Yes</label>
         <label class="radio-inline"><input type="radio" name="kashmiri_immigrant" value="no" <?php if(!empty($get_prev_personal_details[0]['kashmiri_immigrant'])) { if($get_prev_personal_details[0]['kashmiri_immigrant'] == 'no') { echo 'checked'; } else { echo '';} } elseif(isset($kashmiri_immigrant)) { echo ($kashmiri_immigrant== 'no') ?  "checked" : ""; } else { echo "checked"; }?> >No</label>
      </div>
    </div>

    <!-- <input type="hidden" name="kashmiri_immigrant" value="<?php if(!empty($get_prev_personal_details[0]['kashmiri_immigrant'])) { echo $get_prev_personal_details[0]['kashmiri_immigrant']; } elseif(isset($kashmiri_immigrant)) echo $kashmiri_immigrant; else {} ?>"> -->



    <div class="form-group row required">

      <label class="control-label col-md-2" for="name_in_hindi">पूरा नाम हिन्दी में:<strong  style="color: red;">*</strong><span>
    <!-- <a href="https://translate.google.com/#view=home&op=translate&sl=en&tl=hi&text=<?php //echo $first_name.' '.$middle_name.' '.$last_name;?>" target="_blank">Translate</a> -->
    <br>Enter word and Space it will convert into hindi.
</span></label>

      <div class="col-md-4">
        <input type="text"  class="form-control" name="name_in_hindi" id="name_in_hindi" value="<?php if(!empty($get_prev_personal_details[0]['name_in_hindi'])) { echo $get_prev_personal_details[0]['name_in_hindi']; }  else { echo set_value('name_in_hindi'); } ?>" required>
      ...
      <div class="col-md-4">
      <input type="text"  class="form-control" name="birth_place" value="<?php if(!empty($get_prev_personal_details[0]['birth_place'])) { echo $get_prev_personal_details[0]['birth_place']; }  else {  echo set_value('birth_place'); } ?>" required>
   ...
   <div class="form-group row required">
      ...
      <div class="col-md-4">
<textarea name="identification_mark" class="form-control " rows="3" required><?php if(!empty($get_prev_personal_details[0]['identification_mark'])) { echo $get_prev_personal_details[0]['identification_mark']; }  else {  echo set_value('identification_mark'); }?></textarea>
...
<span id="error_form_val"><?php echo form_error('identification_mark'); ?></span>
      ...
      <div class="col-md-4">
<textarea name="hobbies" class="form-control " rows="3" ><?php if(!empty($get_prev_personal_details[0]['hobbies'])) { echo $get_prev_personal_details[0]['hobbies']; }  else {  echo set_value('hobbies'); } ?></textarea>
...
<span id="error_form_val"><?php echo form_error('hobbies'); ?></span>
     ...
     <label class="control-label col-md-2" for="extra_curricular_activity">Extra Curricular Activities:</label>
      <div class="col-md-4">
        ...
        <textarea name="extra_curricular_activity" class="form-control " rows="3" ><?php if(!empty($get_prev_personal_details[0]['extra_curriculam_activities'])) { echo $get_prev_personal_details[0]['extra_curriculam_activities']; }  else { echo set_value('extra_curricular_activity'); } ?></textarea>

        <span id="error_form_val"><?php echo form_error('extra_curricular_activity'); ?></span>
</div>
      <label class="control-label col-md-2" for="fav_past_time">Other Relevent Info:</label>
      <div class="col-md-4">
        <textarea name="other_relavant_info" class="form-control " rows="3" ><?php if(!empty($get_prev_personal_details[0]['other_relevant_info'])) { echo $get_prev_personal_details[0]['other_relevant_info']; }  else {  echo set_value('other_relavant_info'); } ?></textarea>
        <span id="error_form_val"><?php echo form_error('other_relavant_info'); ?></span>
</div>
    </div>
    <br>
    <h4 style="color:#2562c2;font-weight:bold;"><center>Parent's Bank Details</center></h4>
    <br>

     <div class="form-group row required">
      <label class="control-label col-md-2" for="bank_name">Bank Name:<strong  style="color: red;">*</strong></label>
      <div class="col-md-4">
       <input type="text"  class="form-control" name="bank_name" value="<?php if(!empty($get_prev_personal_details[0]['parent_bank_name'])) { echo $get_prev_personal_details[0]['parent_bank_name']; } else { echo set_value('bank_name'); } ?>" required>
       <span id="error_form_val"><?php echo form_error('bank_name'); ?></span>
      </div>

      <label class="control-label col-md-2" for="account_no">Account Number:( Will be used for parent portal also)<strong  style="color: red;">*</strong></label>
      <div class="col-md-4">
        <input type="text"  class="form-control" name="account_no" value="<?php if(!empty($get_prev_personal_details[0]['parent_account_number'])) { echo $get_prev_personal_details[0]['parent_account_number']; } else {  echo set_value('account_no'); } ?>" required>
   ...
   <div class="form-group row required">
      ...
      <label class="control-label col-md-2" for="ifsc">IFSC Code:<strong  style="color: red;">*</strong></label>

      <div class="col-md-4">
       <input type="text"  class="form-control" name="ifsc" value="<?php if(!empty($get_prev_personal_details[0]['parent_bank_ifsc_code'])) { echo $get_prev_personal_details[0]['parent_bank_ifsc_code']; } else { echo set_value('ifsc'); } ?>" required>
       <span id="error_form_val"><?php echo form_error('ifsc'); ?></span>

      </div>
      <label class="control-label col-md-2" for="other_relavant_info">Favourite Past time:</label>
        <div class="col-md-4">
        <textarea name="fav_past_time" class="form-control " rows="3" ><?php if(!empty($get_prev_personal_details[0]['fav_past_time'])) { echo $get_prev_personal_details[0]['fav_past_time']; } else { echo set_value('fav_past_time'); } ?></textarea>
  ...
  <!-- <div class="form-group row required">
    <label class="control-label col-md-2" for="aadhar_no">Student Aadhar Number:</label>
      <div class="col-md-4">
        <input type="text" class="form-control" name="aadhar_no" maxlength="12" oninput="this.value = this.value.replace(/[^0-9.]/g, '');" value="<?php if(!empty($get_prev_personal_details[0]['stu_aadhar_no'])) { echo $get_prev_personal_details[0]['stu_aadhar_no']; } else { echo set_value('aadhar_no'); } ?>">
        <span id="error_form_val"><?php echo form_error('aadhar_no'); ?></span>
      </div> -->


      <div class="form-group row required">
    <label class="control-label col-md-2" for="passport_no">Student Passport Number:</label>
      <div class="col-md-4">
        <input type="text" class="form-control" name="passport_no" maxlength="12" value="<?php if(!empty($get_prev_personal_details[0]['stu_passport_no'])) { echo $get_prev_personal_details[0]['stu_passport_no']; } else { echo set_value('passport_no'); } ?>">
      ...
      <div class="col-md-4">
        <input type="text" class="form-control" name="migration_cert1" value="<?php if(!empty($get_prev_personal_details[0]['migration_cert1'])) { echo $get_prev_personal_details[0]['migration_cert1']; } else {  echo "NA-".$reg_id; } ?>" required>
  ...
  <p align="center" style="color: black;"><strong>*Incase of Non-Availabilty of Current Migration Certificate Number of Graduation, you need to fill "NA-Registration No" in that field </strong> </p>
    <div class="form-group row">
      <label class="control-label col-md-2" for="photo">Photo:<strong  style="color: red;">*</strong><br><p style="color:#FF0000;font-size:12px;">Same as Per Application Form</p></label>
      <div class="col-md-4">
      <?php if(!empty($photo_signature[0]['doc_id'])) { ?>
        <input type="hidden" name="photo" value="<?php if(!empty($get_prev_personal_details[0]['photo_path'])) { echo $get_prev_personal_details[0]['photo_path']; } else { echo 'https://admission.iitism.ac.in/'.$photo_signature[0]['doc_path']; } ?>" >
    ...
    <?php if(isset($photo_error)) echo '<p style="color:red;font-size:12px;">'.$photo_error.'</p>';?>
      ...
      <?php if(!empty($photo_signature[1]['doc_id'])) { ?>
        <input type="hidden" name="sign" value="<?php if(!empty($get_prev_personal_details[0]['signature_path'])) { echo $get_prev_personal_details[0]['signature_path']; } else { echo 'https://admission.iitism.ac.in/'.$photo_signature[1]['doc_path']; } ?>" >
        <div id="imageBox" style="height: 120px; width: 100px;">
