...
?>
                ...
                <form id="msform" class="form-horizontal" method="post" accept-charset="utf-8" enctype="multipart/form-data" action="<?php echo base_url(); ?>index.php/admission/phd/Adm_phd_mis_registration_education/mis_reg_save_parent_details" onsubmit="return submitForm(this);">
                    <!-- progressbar -->
...
<script>
  $(document).ready(function(){
    $(".previous").click(function(){
      window.location.href = "<?php echo base_url().'index.php/admission/phd/Adm_phd_mis_registration_education/manage_previous_education_details'; ?>";
    });
  });
</script>