                        ...
                        <div class="d-flex justify-content-center h-100">
                            <div class="user_card">
                                ...
                                <div class="d-flex justify-content-center form_container">
                                    ...
                                    <form  name="loginf" id="loginsub" action="<?php echo base_url() ?>index.php/admission/phd/Adm_phd_registration/user_login" method="POST"control="" class="form-group" method="post" enctype="multipart/form-data">
                                ...
                                <div class="mt-4">
                                    ...
                                    <input class="btn btn-danger" style="width:100%;" type="button" onclick="location.href='<?php echo base_url() ?>'+'index.php/admission/phd/Adm_phd_forgetp'" value="Forgot your password?" />
                                    </div>
                                    <div class="d-flex justify-content-center links" style="color: white;">
                                        Don't have an account? <a href="<?php echo base_url();?>index.php/admission/phd/Add_phd/adm_phd_registration" class="ml-2" style="color: white;">Sign Up</a>
                                    </div>
...
<script type="text/javascript" src="<?php echo base_url();?>themes/dist/js/phd/adm_phd_login.js"></script>
