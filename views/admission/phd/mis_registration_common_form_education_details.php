...
?>
                ...
                <!-- <p>Fill all form field to go to next step</p> -->
                    ...
                    <fieldset>
                    <form id="msform" class="form-horizontal" method="post" accept-charset="utf-8" enctype="multipart/form-data" action="<?php echo base_url(); ?>index.php/admission/phd/Adm_phd_mis_registration_education/mis_registration_save_education_details" onsubmit="return submitForm(this);">
                        <div class="form-card">
                            <div class="row">
                                <!-- <div class="col-7">
...
<p align="center"><b>Please do not use Autofill. Pl read the instructions carefully before filling the form</b><a href="<?=base_url ()?>assets/FAQ.pdf" target="_blank" style="color: #673AB7;font-size:16px;">&nbsp;Click Here</a></p>
...
<div class="form-group">
 <label class="control-label col-md-2" for="cat_score">Cat Score:<strong  style="color: red;">*</strong></label>
      <div class="col-md-4">
      <input type="text" class="form-control" name="cat_score" maxlength="5" oninput="this.value = this.value.replace(/[^0-9.]/g, '');" value='<?php echo $cat_score;?>'>
...
<label class="control-label col-md-2">Name of Examination:<strong  style="color: red;">*</strong></label>
 ...
 <label class="control-label col-md-2" >Marksheet:<strong  style="color: red;">*</strong></label>
  ...
  <?php }
  elseif(!empty($this->Phd_mis_reg->get_marksheet_by_sno($dynamic_edu['sno'],$reg_id))){ ?>
   <input type="hidden" name="marksheet[]" value="<?php echo $this->Phd_mis_reg->get_marksheet_by_sno($dynamic_edu['sno'],$reg_id); ?>" >
    <input type="hidden" name="verified_marksheet[]" value="<?php echo $this->Phd_mis_reg->get_marksheet_by_sno($dynamic_edu['sno'],$reg_id); ?>" >
  <a href="<?php echo $this->Phd_mis_reg->get_marksheet_by_sno($dynamic_edu['sno'],$reg_id); ?>" class="btn btn-primary" target='_blank'>View Marksheet</a>
  <?php }
  else
  { ?>
 ...
 <label class="control-label col-md-2" >Certificate:<strong  style="color: red;">*</strong></label>
  ...
  <?php }
  elseif(!empty($this->Phd_mis_reg->get_certificate_by_sno($dynamic_edu['sno'],$reg_id))){?>
   <input type="hidden" name="certificate[]" value="<?php echo $this->Phd_mis_reg->get_certificate_by_sno($dynamic_edu['sno'],$reg_id); ?>" >
    <input type="hidden" name="verified_certificate[]" value="<?php echo $this->Phd_mis_reg->get_certificate_by_sno($dynamic_edu['sno'],$reg_id); ?>" >
  <a href="<?php echo $this->Phd_mis_reg->get_certificate_by_sno($dynamic_edu['sno'],$reg_id); ?>" class="btn btn-primary" target='_blank'>View Certificate</a>
  <?php }
  else
  { ?>
...
<label class="control-label col-md-2">Major Subjects:<strong  style="color: red;">*</strong></label>
  ...
  <div class="col-md-4">
    <input type="text" class="form-control" name="sub[]" value="<?php if ($this->Phd_mis_reg->get_dynamic_sub_by_sno($dynamic_edu['sno'] != '',$reg_id)) {
        echo $this->Phd_mis_reg->get_dynamic_sub_by_sno($dynamic_edu['sno'],$reg_id);
...
<?php if($this->Phd_mis_reg->get_marksheet_by_sno($prev_edu_details['sno'],$reg_id)) { ?>
    <input type="hidden" name="marksheet[]" value="<?php echo $this->Phd_mis_reg->get_marksheet_by_sno($prev_edu_details['sno'],$reg_id); ?>" >
    <input type="hidden" name="verified_marksheet[]" value="<?php echo $this->Phd_mis_reg->get_marksheet_by_sno($prev_edu_details['sno'],$reg_id); ?>" >
  <a href="<?php echo $this->Phd_mis_reg->get_marksheet_by_sno($prev_edu_details['sno'],$reg_id); ?>" class="btn btn-primary" target='_blank'>View Marksheet</a>
...
<label class="control-label col-md-2" >Certificate:<strong  style="color: red;">*</strong></label>
  ...
  <?php if($this->Phd_mis_reg->get_certificate_by_sno($prev_edu_details['sno'],$reg_id)) { ?>
    <input type="hidden" name="certificate[]" value="<?php echo $this->Phd_mis_reg->get_certificate_by_sno($prev_edu_details['sno'],$reg_id); ?>" >
      <input type="hidden" name="verified_certificate[]" value="<?php echo $this->Phd_mis_reg->get_certificate_by_sno($prev_edu_details['sno'],$reg_id); ?>">
  <a href="<?php echo $this->Phd_mis_reg->get_certificate_by_sno($prev_edu_details['sno'],$reg_id); ?>" class="btn btn-primary" target='_blank'>View Certificate</a>
...
<div class="col-md-4">
<input type="text" class="form-control" name="sub[]" value="<?php if ($this->Phd_mis_reg->get_dynamic_sub_by_sno($prev_edu_details['sno'],$reg_id) != '') {
   echo $this->Phd_mis_reg->get_dynamic_sub_by_sno($prev_edu_details['sno'],$reg_id);
...
<p align="center"><strong>*Please fill the details in chronological order starting from 10th upto higher education</p>
...
<script>
  $('#previous_personal_details').click(function(){
    //alert('hii');
   window.location.href = "<?php echo base_url(); ?>index.php/admission/phd/Adm_phd_mis_registration/manage_personal_details";
  });
</script>
