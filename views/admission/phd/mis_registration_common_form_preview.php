...
<?php } else {
                ...
                <!-- <p>Fill all form field to go to next step</p> -->
                    ...
                    <fieldset>
                    <form id="msform" class="form-horizontal" method="post" accept-charset="utf-8" enctype="multipart/form-data" action="<?php echo base_url(); ?>index.php/admission/phd/Adm_phd_mis_registration_other_details/preview_submit" onsubmit="return submitForm(this);">
...
<script>
  $('#previous_other_details').click(function(){
    //alert('hii');
   window.location.href = "<?php echo base_url(); ?>index.php/admission/phd/Adm_phd_mis_registration_other_details/manage_previous_other_details";
  });
</script>
</body>
</html>
