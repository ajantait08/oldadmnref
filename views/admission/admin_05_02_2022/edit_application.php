...
<div class="page-header">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>index.php/admission/admin/dashboard">All Applicants</a></li>
        ...
        <div class="wizard">
            <div class="wizard-inner">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li role="presentation" class="disabled" id="tab3">
                        <a href="#step3" data-toggle="tab" aria-controls="step3" role="tab"><span class="round-tab">WE</span> <i>Work Experience</i></a>
                    </li>
            ...
            <div class="tab-content" id="main_form">
                ...
                <div class="tab-pane active" role="tabpanel" id="step1">
                    ...
                    <?php if ($this->session->flashdata('error_personal')) { ?>
                        <div class="alert alert-danger alert-dismissible">
                            <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                            <strong>Info!</strong> <?php echo $this->session->flashdata('error_personal') ?>
                        </div>
                    <?php } ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6 col-lg-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="application_no" type="text" name="application_no" class="form-control" value=" <?php if (!empty($registration_detail)) {
                        ...
                        <div class="col-md-6 col-sm-6 col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                    <input id="registration_no" name="registration_no" type="text" class="form-control" value="<?php if (!empty($registration_detail)) {
                        ...
                        <div class="col-md-6 col-sm-6 col-lg-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                    <input id="category" name="category" type="text" class="form-control" value="<?php if (!empty($registration_detail)) {
                        ...
                        <div class="col-md-6 col-sm-6 col-lg-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                    <input id="pwd" name="pwd" type="text" value="<?php if (!empty($registration_detail)) {
                                                                                        if ($registration_detail[0]->pwd == '') {
                                                                                            echo "Yes";
                                                                                        } else {
                                                                                            echo "No";
                                                                                        }
                                                                                    } ?>" class="form-control" name="divyang" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-6 col-lg-6">
                        ...
                        <div class="col-md-6 col-sm-6 col-lg-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                    <input id="dob" name="dob" type="text" class="form-control" value="<?php if (!empty($registration_detail)) {
                        ...
                        <div class="col-md-6 col-sm-6 col-lg-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                    <input id="email" name="email" type="text" class="form-control" value="<?php if (!empty($registration_detail)) {
                        ...
                        <div class="col-md-6 col-sm-6 col-lg-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                    <input id="mobile" name="mobile" type="text" value="<?php if (!empty($registration_detail)) {
                        ...
                        <!-- <div class="col-md-6 col-sm-6 col-lg-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                    <input id="sponser" type="text" class="form-control" name="sponser" placeholder="">
                                </div>
                            </div>
                        </div> -->
                        <!-- <div class="col-md-6 col-sm-6 col-lg-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                    <input id="adm_type" name="adm_type" type="text" class="form-control"  placeholder="">
                                </div>
                            </div>
                        </div> -->
                        <div class="col-md-6 col-sm-6 col-lg-6">
                        ...
                        <!-- <div class="col-md-6 col-sm-6 col-lg-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                    <input id="department" name="department" type="text"  value ="<?php if (!empty($application_details)) {
                                                                                                        echo $application_details[0]->dept_id;
                        ...
                        <!-- <div class="col-md-6 col-sm-6 col-lg-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                    <input id="course" name="course" value ="<?php if (!empty($application_details)) {
                                                                                    echo $application_details[0]->course_id;
                        ...
                        <!-- <div class="col-md-6 col-sm-6 col-lg-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                    <input id="branch" name="branch"  value ="<?php if (!empty($application_details)) {
                                                                                    echo $application_details[0]->branch_id;
                                                                                } ?>" type="text" class="form-control" readonly>
                                </div>
                            </div>
                        </div> -->
                    ...
                    <ul class="list-inline pull-right">
                        <li><button type="subit" class="default-btn next-step">submit</button></li>
                    </ul>
                    </form>
                </div>
                ...
                <div class="tab-pane" role="tabpanel" id="step2">
                    ...
                    <?php if ($this->session->flashdata('apply_success_personal')) { ?>
                        <div class="alert alert-success alert-dismissible">
                            <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                            <strong>Info!</strong> <?php echo $this->session->flashdata('apply_success_personal') ?>
                        </div>
                    <?php } ?>
                    <?php if ($this->session->flashdata('error_educationa')) { ?>
                        <div class="alert alert-danger alert-dismissible">
                            <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                            <strong>Info!</strong> <?php echo $this->session->flashdata('error_educationa') ?>
                        </div>
                    <?php } ?>
                    <?php
                    $attributes = array('class' => 'email', 'id' => 'p_details', 'name' => 'p_details', 'enctype' => 'multipart/form-data');
                    ...
                    <div id="hide_yes_no_cat">
                        <div class="row">
                            <div class="col-md-8">
                                <p> Enter your CAT 2021 Registration Number</p>
                            </div>
                            <div class="col-md-4  col-sm-4 col-lg-4">
                                <div class="form-group">
                                    <!-- <label for="sel1">Select list:</label> -->
                                    <input type="text" class="form-control" id="cat_reg_no" name="cat_reg_no">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 col-sm-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                        <input id="cat_percentile" name="cat_percentile" type="text" class="form-control" placeholder="Enter CAT Percentile">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                        <input id="cat_score" name="cat_score" type="text" class="form-control" placeholder="Enter CAT Score">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6  col-sm-6 col-lg-6">
                                <div class="form-group">
                                    <label>CAT Quantitative Percentile:</label>
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                        <input id="cat_quantitative_p" name="cat_quantitative_p" type="text" class="form-control" placeholder="Enter CAT Quantitative Percentile">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6  col-sm-6 col-lg-6">
                                <div class="form-group">
                                    <label>CAT Quantitative Score:</label>
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                        <input id="cat_quantitative_s" name="cat_quantitative_s" type="text" class="form-control" placeholder="Enter CAT Quantitative Score">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6  col-sm-6 col-lg-6">
                                <div class="form-group">
                                    <label>CAT Verbal Percentile:</label>
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                        <input id="cat_verbal_p" name="cat_verbal_p" type="text" class="form-control" placeholder="CAT Verbal Percentile">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6  col-sm-6 col-lg-6">
                                <div class="form-group">
                                    <label>CAT Verbal Score:</label>
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                        <input id="cat_verbal_s" name="cat_verbal_s" type="text" class="form-control" placeholder="Enter CAT Verbal Score">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6  col-sm-6 col-lg-6">
                                <div class="form-group">
                                    <label>CAT Data Interpretation Percentile:</label>
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                        <input id="data_interpretationl_p" name="data_interpretationl_p" type="text" class="form-control" placeholder="Enter CAT Data Interpretation Percentile">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-6 col-lg-6">
                                <div class="form-group">
                                    <label>CAT Data Interpretation Score:</label>
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                        <input id="data_interpretationl_s" name="data_interpretationl_s" type="text" class="form-control" placeholder="Enter CAT Data Interpretation Score">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-lg-12">
                            ...
                            <table id="qual" class="table-responsive">
                                ...
                                <tbody>
                                    <tr>
                                        <td data-column="Exam type"> <select id="examtype10" name="examtype10">
                                                <option>10 th</option>
                                            </select></td>
                                        <td data-column="Name of exam"><select id="name_of_exam10" name="name_of_exam10">
                                                <option>10 th</option>
                                        </td>
                                        ...
                                        <td data-column="result Status"><select id="10passed" name="10passed">
                                                <option>Passed</option>
                                        </td>
                                        <td data-column="marks System"><select id="10percentage" name="10percentage">
                                    ...
                                    <tr>
                                        <td data-column="Exam type"> <select id="examtype12" name="examtype12">
                                                <option>12 th</option>
                                            </select></td>
                                        <td data-column="Name of exam"><select id="name_of_exam12" name="name_of_exam12">
                                                <option>12 th</option>
                                        </td>
                                        ...
                                        <td data-column="result Status"><select id="12passed" name="12passed">
                                                <option>Passed</option>
                                        </td>
                                        <td data-column="marks System"><select id="12percentage" name="12percentage">
                                                <option>Percentage</option>
                                                <option>Cgpa</option>
                                        </td>
                                    ...
                                    <tr>
                                        <td data-column="Exam type"> <select id="examtypeug" name="examtypeug">
                                                <option>UG Exam</option>
                                            </select></td>
                                        ...
                                        <td data-column="result Status"><select id="ug_appearing" name="ug_appearing">
                                                <option>Appearing</option>
                                                <option>Passed</option>
                                        </td>
                                        <td data-column="marks System"><select id="ug_percentage" name="ug_percentage">
                                                <option>Percentage</option>
                                                <option>Cgpa</option>
                                        </td>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-lg-12">
                            <?php if ($this->session->flashdata('apply_success_education')) { ?>
                                <div class="alert alert-success alert-dismissible">
                                    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                    <strong>Info!</strong> <?php echo $this->session->flashdata('apply_success_education') ?>
                                </div>
                            <?php } ?>
                            ...
                            <table id="workexp" class="table-responsive work_exp_h_s">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td data-column="sector"><input id="sector1" name="sector1" type="text" class="form-control"></td>
                            ...
                            <input type="button" id="addexp" name="addmore" value="Add More" style="float:right; margin-top: -40px;" class="btn btn-primary btn-sm work_exp_h_s">
                        </div>
                ...
                <div class="tab-pane" role="tabpanel" id="step4">
                    ...
                    <div class="row">
                        <?php $attributes = array('class' => 'email', 'id' => 'p_details', 'name' => 'p_details', 'enctype' => 'multipart/form-data');
                        echo form_open('admission/mtech/Adm_mba_personal_details/insert_document', $attributes); ?>
                        <div class="col-md-6 col-sm-6 col-lg-6">
                            <div class="row">
                                <!-- <div class="col-md-12 col-sm-12 col-lg-12">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend" id="button-addon3">
                                                ...
                                                ?>
                                                <a id="uglink" href="<?php if (!empty($v)) {
                                                                            echo $v;
                                                                        } ?>" <?php if (!empty($v)) {
                                                                                    echo 'target="iframed"';
                                                                                } else {
                                                                                    echo '"#"';
                                                                                } ?>><button id="ugpri" class="btn btn-primary" type="button">Preview</button></a>
                                            </div>
                                        </div>
                                        <p style="color: green" id="msgug"><?php if (!empty($v)) {
                                                                                echo "You was Uploaded file UG Marksheet can be viewed using Preview button";
                                                                            } ?></p>
                                    </div>
                                </div>
                                <div class="col-md-12 col-sm-12 col-lg-12">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group mb-6">
                                            <div class="input-group-prepend" id="button-addon3">
                                                ...
                                                ?>
                                                <a id="link1" href="<?php if (!empty($v)) {
                                                                        echo $v;
                                                                    } else {
                                                                        echo '#';
                                                                    } ?>" <?php if (!empty($v)) {
                                                                                echo 'target="iframed"';
                                                                            } ?>><button id="dobpri" class="btn btn-primary" type="button">Preview</button></a>
                                            </div>
                                        </div>
                                        <p style="color: green" id="msg"><?php if (!empty($v)) {
                                                                                echo "You was Uploaded file DOB can be viewed using Preview button";
                                                                            } ?></p>
                                    </div>
                                </div>
                                <div class="col-md-12 col-sm-12 col-lg-12">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend" id="button-addon3">
                                                ...
                                                ?>
                                                <a id="cblink" href="<?php if (!empty($v)) {
                                                                            echo $v;
                                                                        } else {
                                                                            echo '#';
                                                                        } ?>" <?php if (!empty($v)) {
                                                                                    echo 'target="iframed"';
                                                                                } ?>><button id="cbpri" class="btn btn-primary" type="button">Preview</button></a>
                                            </div>
                                        </div>
                                        <p style="color: green" id="msgcb"><?php if (!empty($v)) {
                                                                                echo "You was Uploaded file Colour Blindness can be viewed using Preview button";
                                                                            } ?></p>
                                    </div>
                                </div>
                                <div class="col-md-12 col-sm-12 col-lg-12">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend" id="button-addon3">
                                                ...
                                                ?>
                                                <a id="gsclink" href="<?php if (!empty($v)) {
                                                                            echo $v;
                                                                        } else {
                                                                            echo '#';
                                                                        } ?>" <?php if (!empty($v)) {
                                                                                    echo 'target="iframed"';
                                                                                } ?>><button id="gscpri" class="btn btn-primary" type="button">Preview</button></a>
                                            </div>
                                        </div>
                                        <p style="color: green" id="msggsc"><?php if (!empty($v)) {
                                                                                echo "You was Uploaded file Gate Score Card can be viewed using Preview button";
                                                                            } ?></p>
                                    </div>
                                </div>
                                <div class="col-md-12 col-sm-12 col-lg-12">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend" id="button-addon3">
                                                ...
                                                ?>
                                                <a id="pwdlink" href="<?php if (!empty($v)) {
                                                                            echo $v;
                                                                        } else {
                                                                            echo '#';
                                                                        } ?>" <?php if (!empty($v)) {
                                                                                    echo 'target="iframed"';
                                                                                } ?>><button id="pwdpri" class="btn btn-primary" type="button">Preview</button></a>
                                            </div>
                                        </div>
                                        <p style="color: green" id="msgpwd"><?php if (!empty($v)) {
                                                                                echo "You was Uploaded file PWD certificate can be viewed using Preview button";
                                                                            } ?></p>
                                    </div>
                                </div>
                                <div class="col-md-12 col-sm-12 col-lg-12">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend" id="button-addon3">
                                                ...
                                                ?>
                                                <a id="catlink" href="<?php if (!empty($v)) {
                                                                            echo $v;
                                                                        } else {
                                                                            echo '#';
                                                                        } ?>" <?php if (!empty($v)) {
                                                                                    echo 'target="iframed"';
                                                                                } ?>><button id="catpri" class="btn btn-primary" type="button">Preview</button></a>
                                            </div>
                                        </div>
                                        <p style="color: green" id="msgcat"><?php if (!empty($v)) {
                                                                                echo "You was Uploaded file Category certificate can be viewed using Preview button";
                                                                            } ?></p>
                                    </div>
                                </div>
                                <div class="col-md-12 col-sm-12 col-lg-12">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend" id="button-addon3">
                                                ...
                                                ?>
                                                <a id="pglink" href="<?php if (!empty($v)) {
                                                                            echo $v;
                                                                        } else {
                                                                            echo '#';
                                                                        } ?>" <?php if (!empty($v)) {
                                                                                    echo 'target="iframed"';
                                                                                } ?>><button id="pgpri" class="btn btn-primary" type="button">Preview</button></a>
                                            </div>
                                        </div>
                                        <p style="color: green" id="msgpg"><?php if (!empty($v)) {
                                                                                echo "You was Uploaded file PG Marksheet can be viewed using Preview button";
                                                                            } ?></p>
                                    </div>
                                </div>
                                <div class="col-md-12 col-sm-12 col-lg-12">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend" id="button-addon3">
                                                ...
                                                ?>
                                                <a id="worlink" href="<?php if (!empty($v)) {
                                                                            echo $v;
                                                                        } else {
                                                                            echo '#';
                                                                        } ?>" <?php if (!empty($v)) {
                                                                                    echo 'target="iframed"';
                                                                                } ?><button id="workpri" class="btn btn-primary" type="button">Preview</button></a>
                                            </div>
                                        </div>
                                        <p style="color: green" id="msgwork"><?php if (!empty($v)) {
                                                                                    echo "You was Uploaded file Work Experience can be viewed using Preview button";
                                                                                } ?></p>
                                    </div>
                                </div>
                                <div class="col-md-12 col-sm-12 col-lg-12">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <p style="color: green" id="msgph"><?php if (!empty($v)) {
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <img src="<?Php if (!empty($v)) {
                                                                echo $v;
                                                            } else {
                                                                echo base_url() . 'assets/images/photo.png';
                                                            } ?>" id="p" style='width:159px;height:181px;'>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <p style="color: green" id="msgsg"><?php if (!empty($v)) {
                                                                                        echo "Image was Uploaded";
                                                                                    } ?></p>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <img src="<?Php if (!empty($v)) {
                                                                ...
                                                                echo base_url() . 'assets/images/photo.png';
                                                            } ?>" id="q" style='width:158px;;height:70px;'>
                                            </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(e) {
        ...
        $("#work_exp").change(function() {
            var work_exp_yes_no = $("#work_exp").val();
            if (work_exp_yes_no == 'Yes') {
                $(".work_exp_h_s").show();
            } else if (work_exp_yes_no == 'No') {
                $(".work_exp_h_s").hide();
    ...
    $(document).ready(function() {
        ...
        $("#btech_cgpa").change(function() {
            ...
            if (betchcgpa == 'Yes') {
                ...
                $("#btechyes").hide();
                $("#hide_yes_no_cat").show();
            } else {
                $("#btechyes").hide();
                $("#hide_yes_no_cat").hide();
            }
        })
        $("#btech_cat_qual").change(function() {
            var btech_cat_qual_yes = $("#btech_cat_qual").val();
            if (btech_cat_qual_yes == 'Yes') {
                $("#hide_yes_no_cat").show();
            } else {
                $("#hide_yes_no_cat").hide();
            }
