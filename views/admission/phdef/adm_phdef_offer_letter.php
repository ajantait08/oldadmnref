                ...
                <div class="col-md-12 col-lg-12 col-sm-12">
                    <div class="panel panel-primary news_back">
                        ...
                        <div class="panel-body">
                            ...
                            <form
                                action="<?php echo base_url() . 'index.php/admission/phdef/Adm_phdef_mis_registration/proceed_with_registration'; ?>"
                                ...
                                <section>
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <br>
                                            <?php $url = base_url() . 'assets/admission/phdef/OfferLetter/' . $application[0]->registration_no . '/Offer_letter_' . $program_id . '_' . $application[0]->registration_no . '.pdf'; ?>
                                            ...
                                            <?php } ?>
                                            <br>
                                            <a href="<?php echo base_url() ?>index.php/admission/phdef/Adm_phdef_application_preview/application_download_phdef/<?php echo $program_id; ?>/<?php echo $program_desc; ?>/<?php echo $fellowtype; ?>"
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <br>
                                            <?php $url = base_url() . 'assets/admission/phdef/OfferLetter/' . $application[0]->registration_no . '/Offer_letter_' . $program->program_id . '_' . $application[0]->registration_no . '.pdf'; ?>
                                            ...
                                            <?php } ?>
                                            <br>
                                            <a href="<?php echo base_url() ?>index.php/admission/phdef/Adm_phd_application_preview/application_download_phdef/<?php echo $program->program_id; ?>/<?php echo $program->program_desc; ?>"
                                                class="btn btn-primary" style="margin-top:5px;border-radius:4px;">
                                        ...
                                        $("#optradio<?php echo $countopt; ?>").click(function() {
                                            ...
                                            $.ajax({
                                                type: "POST",
                                                url: "<?php echo base_url() . 'index.php/admission/phdef/Adm_phdef_application_preview/get_selected_data'; ?>",
                                                data: {
...
$("#backbutton").click(function() {
    window.location.href = "<?php echo base_url() .'index.php/admission/phdef/Adm_phdef_application_preview'; ?>";
});
</script>