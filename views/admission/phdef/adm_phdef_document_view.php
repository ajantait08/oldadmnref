                                                        ...
                                                        <div class="tab-pane active" role="tabpanel" id="step4">
                                                            ...
                                                            <?php }?>
                                                             <?php  $attributes = array('class' => 'email', 'id' => 'btn_document','name'=>'p_details','enctype'=>'multipart/form-data');
                                                                echo form_open('admission/phdef/Adm_phdef_document/document_submit', $attributes); ?>
                                                                <div class="col-md-6 col-sm-6 col-lg-6">
                                                                    ...
                                                                    <input id="doc_filed" name="doc_filed" type="hidden" value="yes">
                                                                        ...
                                                                        <?php if(!empty($VIS)){  ?>
                                                                        <div class="col-md-12 col-sm-12 col-lg-12">
                                                                            <label class="control-label">GATE score card for Visvesvaraya Scheme<span style= "color:red;">*(Maximum size 1mb Only pdf)</span></label>
                                                                            <div class="form-group">
                                                                                <div class="input-group mb-3">
                                                                                    <div class="input-group-prepend" id="button-addon3">
       ...
       $('#formcheck').click(function()
            {
                ...
                var count=$('#doc_t').val();
                $.ajax({
                url: base_url+'/index.php/admission/phdef/Adm_phdef_document/validate_photo_signature_doc',
                type: "POST",
                // dataType:'json',
                data: {"total":count},
...
function doc_upload(filenameid,link,msg,button_id)
{
    ...
    $.ajax({
        url: base_url+'/index.php/admission/phdef/Adm_phdef_document/document_upload/'+valchek, // point to server-side controller method
...
function doc_remove(filenameid,link,msg,button_id)
{
   ...
   if(hrefval==='#')
   {
    ...
    form_data.append(filenameid, file_data);
    $.ajax({
        url: base_url+'/index.php/admission/phdef/Adm_phdef_document/document_remove/'+filenameid, // point to server-side controller method
        dataType: 'json', // what to expect back from the server
        cache: false,
        contentType: false,
        processData: false,
