...
<body>
    <div class="page" width="8.3 inches" height="11.7 inches" align="center">
        ...
        <table class="phd-nb" style="margin: 0.01in 0.01in 0.01in 0.01in; width:100%" align="center">
            ...
            <tr>
                <td>
                    Congratulations on being provisionally shortlisted to the interview for admission to Ph.D. program
                    of IIT (ISM) Dhanbad !
                </td>
            </tr>
        </table>
                    ...
                    <ul style="list-style:none;">
                        <li><p class="ex1">1. The selection and the offer of admission is purely provisional and subject to
                            ...
                            Dhanbad campus on <b><?php echo date('d.m.Y', strtotime($doc_verification_date)) ?></b>.<b><span style="color:blue;">Please note that failure to report in person for admission and submit the required
                                ...
                                <li>2. The offer of admission is to the Ph.D program of IIT (ISM) Dhanbad under the Externally Funded category (
UGC-JRF ). Your fellowship for the tenure of the Ph.D. program, as a full-time Ph.D candidate will have to be
availed by you from the external funding agency i.e. UGC – JRF.You are solely responsible to get your
fellowship from UGC-JRF. Please note that IIT (ISM) Dhanbad is not responsible for payment of fellowship
under any circumstances.</b>
                                </p>
                                </li>
                                <li>
                                3.You are requested to confirm the acceptance of the provisional offer by paying the
                        ...
                        <li>4. Failure to pay the registration fee by
                        ...
                        <li>
                            6. <b><span style="color:blue;">Candidates working in Govt./Pvt. Organizations must submit the NOC / acceptance of
                        ...
                        <li>
                            7. Candidates taking admission are required to abide by the rules and regulations laid down
                            in the Ph.D. manual of IIT(ISM) and any other rules promulgated by the institute as and when
                            they are notified.
                        </li>
                        <li>
                            8. <b><span style="color:blue;"><u>It may please be noted that any wrong information or insufficient supporting
            ...
            <tr>
                <td>
                    ...
                    <ul style="list-style:none;">
                        ...
                        <li>
                            9. <b><span style="color:blue;">Publication of results, appearance of name in the merit list or payment of
            ...
            <tr>
                <td>
                    ...
                    <ul style="list-style:none;">
                        ...
                        <li>
                            10. <b>Withdrawal and refund of admission fee :</b>
                            <p class="ex1">
                                <!-- <b>Failure to submit any of the above mentioned documents at the time of reporting, or if permitted, by September 01, 2022, the provisional admission, if done, will be cancelled by the Institute without any further notice.</b> -->
