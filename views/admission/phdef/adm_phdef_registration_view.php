<link href="<?php echo base_url(); ?>themes/dist/css/phdef/adm_phdef_registration.css" rel="stylesheet" media="screen">
<div class="row">
    <!--row start  -->
    <div class="col-md-2">
        <!--row col-md-4 start  -->
                                ...
                                <div class="row">
                                    <div class="col-md-8 col-md-offset-2">
                                        <form name="newUser" class="register" id="sub"
                                            action="<?php echo base_url() ?>index.php/admission/phdef/Adm_phdef_registration/get_registration"
...
<script type="text/javascript" src="<?php echo base_url(); ?>themes/dist/js/phdef/adm_phdef_registration.js"></script>