<link href="<?php echo base_url();?>themes/dist/css/phdef/login.css" rel="stylesheet" media="screen">
<style>
.myalert
{
  color:white;
                    ...
                    <div style="margin-top: 481px;">
                        <div class="container-center"> 
                            ...
                            <?php
                                ...
                                echo form_open('admission/phdef/Adm_phdef_forgetp/forget_password', $attributes); 
                            ...
                            ?>
                                ...
                                <input type="text" name="forget_registration" maxlength="20" id="forget_registration" value="" />
                            ...
                            <input class="btn btn-danger" style="width:100%;" type="button" onclick="location.href='<?php echo base_url() ?>'+'index.php/admission/phdef/add_phdef/adm_phdef_login'" value="Did you remember? Sign In" />
                           </p>
                        </div>
                    </div> 
                </div>
...
<script type="text/javascript" src="<?php echo base_url();?>themes/dist/js/ef/adm_phdef_education.js"></script>
