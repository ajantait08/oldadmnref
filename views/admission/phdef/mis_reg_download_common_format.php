    ...
    <td><?php
       echo strtoupper($branch);
        ...
        <?php }else {?>
         ...
         <td> <?php
           echo strtoupper($this->Phdef_mis_reg->get_branch_name_by_id($branch_id)); }
          ?>
      </td>
    <td>&nbsp;</td>
  </tr>
...
<div class="row">
  ...
  <div class="col-md-3">
              <div class="form-group">
              <?php echo strtoupper($admn_based_on);?>
              </div>
  </div>
  <div class="col-md-3">
              <div class="form-group">
...
<div class="form-group">
    ...
    <?php
    echo '<center>';
echo '<a class="btn btn-primary" href="'.base_url().'index.php/admission/phdef/Adm_phdef_mis_registration_other_details/download_pdf/'.$admn_no.'/'.$admn_type.'/'.$registration_no.'">Download</a>';
?>
&nbsp;
<?php
echo '<a class="btn btn-default" href="'.base_url().'index.php/admission/phdef/Adm_phdef_application_preview'.'">Back To HomePage</a>';
    echo '</center>';
