                                                ...
                                                <!-- <form role="form" action="index.html" class="login-box register"> -->
                                                    <div class="tab-content" id="main_form">
                                                        ...
                                                        <div class="tab-pane active" role="tabpanel" id="step1">
                                                            ...
                                                            echo form_open('admission/phdef/Adm_phdef_personal_details/get_personal_details', $attributes); ?>
                                                                <div class="row">
                                                                ...
                                                                <ul class="list-inline pull-right">
                                                                  <li><button type="button" class ="btn btn-primary" style="background-color: #0074aa;" id="btn_personal_details">Save & Next</button></li>
                                                                </ul>
                                                           </form>
                                                        </div>
                                                        ...
                                                        <?php }?>
                                                             ...
                                                             echo form_open('admission/phdef/Adm_phdef_personal_details/get_education_detail', $attributes); ?>
                                                             ...
                                                             <div class="row">
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <p>Are you an IIT graduate ?<span style="color:red;">*</span></p>
                                                                </div>
                                                        ...
                                                        <div class="row">
                                                           ...
                                                           <?php echo $this->session->flashdata('apply_success_education')?>
                                                            ...
                                                            echo form_open('admission/phdef/Adm_phdef_personal_details/get_work_experience_detail', $attributes); ?>
...
<script type="text/javascript" src="<?php echo base_url();?>themes/dist/js/phdef/adm_phdef_personal_detail.js"></script>
