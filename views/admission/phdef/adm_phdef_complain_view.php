                    ...
                    <div class="panel panel-primary news_back">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <input class="btn btn-warning" style="width:100%;" type="button" onclick="location.href='<?php echo base_url() ?>'+'index.php/admission/phdef/Adm_phdef_complain_register'" value="Complaint Register" />
                                <input class="btn btn-primary" style="width:100%;" type="button" onclick="location.href='<?php echo base_url() ?>'+'index.php/admission/phdef/Adm_phdef_complain_register/track_status'" value="Tracking Complaint" />
                                <?php if(!empty($tab))
                                {
                                    if($tab=='4')
                                    { ?>
                                         <input class="btn btn-secondary" style="width:100%;" type="button" onclick="location.href='<?php echo base_url() ?>'+'index.php/admission/phdef/Adm_phdef_payment'" value="Back to Payment " />
                                    <?php }
                                } ?>
                            ...
                            <section class="signup-step-container">
                                    ...
                                    # code...
                                            ...
                                            <div class="card shadow mb-4 col-md-12">
                                                ...
                                                <h5 align="center" style="color:red;">
                                                Register complaint only related to phd application fee payment.
                                                </h5>
                                                </center>
                                                ...
                                                <?php
                                                    ...
                                                    echo form_open('admission/phdef/Adm_phdef_complain_register/save', $attributes); 
                                            ...
                                            <option value="phd Application Fee">Ph.d. Application Fee</option>
