                    ...
                    <div class="panel panel-primary news_back">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <input class="btn btn-warning" style="width:100%;" type="button" onclick="location.href='<?php echo base_url() ?>'+'index.php/admission/phdef/Adm_phdef_complain_register'" value="Complain Register" />
                                <input class="btn btn-primary" style="width:100%;" type="button" onclick="location.href='<?php echo base_url() ?>'+'index.php/admission/phdef/Adm_phdef_complain_register/track_status'" value="Tracking Complain" />
                                                ...
                                                <!-- <form role="form" action="index.html" class="login-box register"> -->
                                                    <div class="tab-content" id="main_form">
                                                        ...
                                                        <div class="tab-pane active" role="tabpanel" id="step5">
                                                            <h4 class="text-center" style="text-decoration: underline;">Admission Payment Details</h4>
                                                             <div class="row">
                                                                  ...
                                                                  <div class="col-md-12" class="text-center">
                                                                        ...
                                                                        <?php
                                                                           ...
                                                                           echo form_open('admission/phdef/Adm_phdef_admisison_payment/proceed_to_payment', $attributes); ?>
                                                                                <table class="table table-striped table-hover">
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            ...
                                                                                            <td style="font-size:15px; font-weight: bold;" width="50%">Fee :<?php if(!empty($personal_details)){ echo 'Rs.'.$personal_details[0]['admission_fee']; }?><input type="hidden" name="fee_to_be_paid" value="<?php if(!empty($personal_details)){ echo $personal_details[0]['admission_fee']; }?>"></td>
                                                                                            ...
                                                                                            <input type="hidden" name="program_selected" value="<?php if(!empty($program_selected)){ echo $program_selected; }?>">
                                                                        ...
                                                                        <div class="table-responsive">
                                                                            <table class="table table-striped table-hover" cellpadding="0" style="font-size:15px; font-weight: bold; backgroud" cellspacing="0">
                                                                                ...
                                                                                <th>Sl.No</th>
                                                                                <th> Programme Selected For Payment</th>
                                                                                <th>Amount</th>
                                                                                ...
                                                                                <tbody>
                                                                                  <?php
                                                                                    ...
                                                                                    {?>
                                                                                        <tr>
                                                                                            <td><?php echo $i;?></td>
                                                                                            <td><?php echo $this->Adm_phdef_admission_payment_model->get_program_desc($program_selected)[0]['program_desc']; ?></td>
                                                                                            <td><?php echo 'Rs. '.$row['admission_fee'];?></td>
                                                                            ...
                                                                            <div style="margin-bottom: 67px;">
                                                                                <center><h5>Total Amount To be Paid:<?php if(!empty($personal_details)){ echo 'Rs.'.$personal_details[0]['admission_fee']; }?></h5></center>
                                                                            </div>
                                                                        </div>
                                                                  </div>
                                                             </div>
                                                             ...
                                                             <div class="modal fade bd-example-modal-lg" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                                                    ...
                                                                    Amount : <?php if(!empty($personal_details)){ echo 'Rs.'.$personal_details[0]['admission_fee']; }?>
                                                                    </b>
                                                                    </p>
                                                                    ...
                                                                    <h5>2.	When a candidate makes double payment by mistake, refund can be considered only on bringing it to the notice of competent authority of IIT (ISM), Dhanbad on mail refund@iitism.ac.in  by made within 7 days of making such payment. Any kind of requests beyond this 7 days period will not be entertained. The refund process via same source of payment made in such cases will be intuited in due course of time after receiving the refund request in an eligible cases of refund. This causes is applicable only in case of multiple payments by a candidate for the notification.</h5>
                                                                    <h5>3.	During the process of making payment by the candidate.By any chance the amount is deducted from the candidate and the same has not reached account is automatically refunded by the Payment gateway provider on bringing the issue to the notice of Payment Gateway service provided in due course of time.</h5>
                                                                    </p>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="panel panel-primary news_back">
                        ...
                        <div class="panel-body">
                        <input class="btn btn-info" style="width:100%;" type="button" onclick="location.href='<?php echo base_url() ?>'+'index.php/admission/phdef/Adm_phdef_applicant_home'" value="Back applicant home" />
                        </div>
                    </div>
                    <!--end  -->
                </div>
