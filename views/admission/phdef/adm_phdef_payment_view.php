                                                             ...
                                                             <div class="row">
                                                                  ...
                                                                  <div class="col-md-12" class="text-center">
                                                                        ...
                                                                        <?php 
                                                                           ...
                                                                           echo form_open('admission/phdef/Adm_phdef_payment/proceed_to_payment', $attributes); ?>
                                                                                <table class="table table-striped table-hover">
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            ...
                                                                                            <td style="font-size:15px; font-weight: bold;" width="50%">Fee : Rs. <?php if(!empty($personal_details)){ echo $personal_details[0]['application_fee']; }?><input type="hidden" name="fee_to_be_paid" value="<?php if(!empty($personal_details)){ echo $personal_details[0]['application_fee']; }?>"></td>
                                                                        ...
                                                                        <div class="table-responsive">   
                                                                            ...
                                                                            <div style="margin-bottom: 67px;">
                                                                                <center><h5>Total Amount To be Paid: Rs. <?php if(!empty($personal_details)){ echo $personal_details[0]['application_fee']; }?></h5></center>
                                                                            </div>
                                                                        </div>
                                                                  </div>
                                                             </div>
...
<script type="text/javascript" src="<?php echo base_url();?>themes/dist/js/adm_phdef/adm_phdef_education.js"></script>
