...
<div class="row">
  ...
  <td width="50%">D.O.B : <strong><?php echo date("d-m-Y", strtotime($receipt_payment['dob'])); ?></strong></td>
            ...
            <div class="col-md-4">
              ...
              <a href="https://admission.iitism.ac.in/index.php/admission/phdef/Adm_phdef_application_preview" class="btn btn-info">Back To Applicant Home</a>
              <!-- <a href="https://admissiondev.iitism.ac.in/index.php/admission/phdef/Adm_phdef_application_preview" class="btn btn-info">Back To Applicant Home</a> -->
            </div>
