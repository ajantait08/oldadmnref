...
<body>
    <div class="page" width="8.3 inches" height="11.7 inches" align="center">
        ...
        <table class="phd-nb" style="margin: 0.01in 0.01in 0.01in 0.01in; width:100%" align="center">
            ...
            <tr>
                <td>
                    Congratulations on being provisionally selected for admission to Ph.D. program
                    of IIT (ISM) Dhanbad !
                </td>
            </tr>
        </table>
                ...
                <td>
                    ...
                    <ul style="list-style:none;">
                        <li>1. The selection and the offer of admission is purely provisional and subject to
                            ...
                            Dhanbad campus on <b><?php echo date('d.m.Y', strtotime($doc_verification_date)) ?></b>.<b><span style="color:blue;">Please note that failure to report in person for admission and submit the required
                                documents on the scheduled date will lead to automatic cancellation of this offer.</span></b>
                            </li>
                            <li>
                            <b><span>2. The offer of admission is to the Ph.D program of IIT (ISM) Dhanbad under the Externally Funded category.Your fellowship for the tenure of the Ph.D program,
                            as a full time Ph.D candidate will have to be availed by you from the external funded agency i.e. DST-INSPIRE after phase II clearance. In case your efforts to secure funding from the
                            external funding agency is not successful,you will have to comply with the following modalities/ terms and conditions for conversion from DST INSPIRE  fellowship to Institute Fellowship category  :  </span></b>
        ...
        <table style="margin: 0.01in 0.01in 0.01in 0.01in; width:100%" align="center">

            <tr>
                <td>
                            <ul style="list-style:none;">
                                <li>
                                    <i> a)	Scholars will fill up the online application form, as and when the admission portal will be opened for Ph. D. admission in the next semester, as a candidate for taking fresh admission.</i>
                    </li>
                    <li>
                                    <i> b) They will have to fulfil all the eligibility criteria and follow the selection process prescribed for other candidates being considered for admission to Ph. D. under Institute fellowship category.</i>
                                     </li>
                                     <li>
                                     <i> c) In case of re-admission, all the academic activities, already completed for pursuing the Ph. D. program as a scholar of Inspire Fellowship, will be counted for fulfilment of the requirements of the Ph. D. program.</i>
                                     </li>
                                     <li>
                                     <i>  d) If eligible, the scholar will get the Institute fellowship from the date of commencement of the classes of the semester in which they are re-admitted.</i>
                                     </li>
                                     <li>
                                     <i>  e) Since all the academic activities which have been completed during the period when they were given admission as a scholar of the Inspire Fellow will be counted towards Ph. D. requirement, the duration of the fellowship of five years (sixty months) will be counted from the date of admission as a scholar of Inspire Fellowship.</i>
                                     </li>
                                     <li>
                                     <i>   f) No arrears will be paid for the period of admission falling under Inspire Fellowship category.</i>
                                     </li>
                            </ul>
                            </li>
                    </td>
            ...
            <tr>
                ...
                <ul style="list-style:none;">
                            <li>
                            <p class="ex1">
                            However, there is no guarantee that the same will be done as it depends upon your performance during the evaluation process and availability of funds for the purpose.
                            </p>
                            </li>
                            <li>
                            ...
                            <p class="ex1">
                                ...
                                registration fee of <b><span style="color:blue;">Rs. 64450/- (For GEN/OBC-NCL/EWS) and Rs. 58450/-
                                    (For SC/ST/PwD candidates</span></b>) through the online payment portal available on the
                                Institute website from <b><span style="color:blue;"><u><?php echo date('F d, Y', strtotime($start_date)); ?> to
                                        <?php echo date('F d, Y', strtotime($end_date)); ?></u>. Above fee is inclusive
                                    of mess fee of Rs. 21000/- for the one semester. Part Time candidates will have to pay fee
                                    of Rs. 36350/- only</span></b> as a registration fee.Please follow the following
                                instructions to pay the fees online:
                            </p>


                        <ul style="list-style:none;">
                            <li>
                                a. Login to <u>https://admission.iitism.ac.in/index.php/admission/phdef</u> using your
                                IITISM registration number and credential.
                            </li>
                            <li>
                            ...
                            <li>
                                e. Once “Pay Now” is clicked, the system will take to E-pay site of SBI Payment gateway.
                            </li>
                            <li>
                        ...
                        <li>3. Failure to pay the registration fee by
                            ...
                            for Ph.D. admission. <u>Any communication/request/recommendations, whatsoever in this
                                regard, will not be entertained beyond the given deadline.</u></span>
                        </li>
                        <p class="ex1"></p>
                        <li>
                            4. IIT (ISM) Dhanbad will not be responsible for any unforeseen events, like,
                            non-availability of internet connection, problems with the payment portal, natural calamity,
                            etc. for the failure in payment of registration fee by
                            <b><span style="color:green;"><u><?php echo date('F d, Y', strtotime($end_date)); ?></u></span></b>.
                        </li>
                        <p class="ex1"></p>
                        <!-- <li>
                            4. After acceptance of the offer, you will be intimated with the details of admission
                            procedure which include physical document verification process, physical reporting time,
                            venue, etc. which is presently scheduled at <b>03.01.2023.</b>
                        </li> -->

                        <li>
                            5. <b><span style="color:blue;">Candidates working in Govt./Pvt. Organizations must submit the NOC / acceptance of
                                resignation letter from their employer for the Ph.D. admission by the date of the
                                physical registration at IIT (ISM) Dhanbad</span></b>.
                        </li>
                        <p class="ex1"></p>
                        <li>
                    ...
                    <ul style="list-style:none;">
                        ...
                        <ul style="list-style:none;">
                            ...
                            <ul style="list-style:none;">
                                ...
                                <li>
                                    (iv) <b><span style="color:green;">Valid</span></b> GATE/NET/CAT/GMAT and other required score card as proof of
                                    Qualifying Examination as claimed in the application form.
                                </li>

                                <li>
                                    (v) Marksheet and Certificate for Qualifying degree as claimed in the application
                                    form.
                                </li>
                                ...
                                <li>
                                    (viii) Caste certificate – applicable only for SC/ST/OBC-NCL candidates. <b><span style="color:blue;">The
                                    OBC-NCL certificate should be as the Central Government format and should
                                    have been issued on or after April 01, 2022</span></b>.
                                </li>

                                <li>
                                    (ix) Relevant certificate for the candidates in the sub-category (EWS/PwD). <b><span style="color:green;">EWS
                ...
                <td>
                    ...
                    <ul style="list-style:none;">
                        ...
                        <li>
                            ...
                            <p class="ex1">
                                <!-- <b>Failure to submit any of the above mentioned documents at the time of reporting, or if permitted, by September 01, 2022, the provisional admission, if done, will be cancelled by the Institute without any further notice.</b> -->
                                Candidate may withdraw his/her admission before physical reporting and Withdrawal may be requested to AR (Admissions)
                            ...
                            <ul style="list-style:none;">
                                ...
                                <li>
                                    ...
                                    date of payment for the round in which she/he was admitted, the entire fee
                                ...
                                <li>
                                    ...
                                    date of payment for the round in which she/he was admitted, she/he will be
