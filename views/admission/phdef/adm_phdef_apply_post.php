                        ...
                        <div class="panel-body">
                            ...
                            ?>
                                <section class="signup-step-container">
                                    <div id="sponserd">
                                        <form id="apply_post" action="<?php echo base_url() ?>index.php/admission/phdef/Adm_phdef_user_dashboard/get_apply_post" method="POST" control="" class="form-group register">
                                            <div class="row">
                                                <div class="col-md-3">
                                            ...
                                            <div class="row" style="border: 1px solid #e9ecef;border-left: 3px solid green; margin-top: 39px;margin-bottom: 46px;">                  
                                                <div class="col-md-2">
                                                    <!-- NAME -->
                                                    <div class="form-group">
                                                        <!-- <label>Choose your specialization Priority<span style="color:red;">*</span></label> -->
                                                        <label>Propose your Supervisor:<span style="color:red;">*</span></label>
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($fill_appl_details as $row) { ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo $this->Add_phdef_registration_model->get_degree_desc_by_program_id($row->degree_id); ?></td>
                                                            <td><?php if(!empty($row->phd_in)) echo $row->phd_in; ?></td>
                                                            <td> <ul>
                                                            <?php 

                                                                $specail_val=$this->Add_phdef_registration_model->get_specialization_reg_pro($row->registration_no,$row->program_id);
                                                                    ...
                                                                    <div class="modal-dialog modal-dialog-centered">
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body">
                                                                                <div class="box-body ">
                                                                                    <form method="POST" action="<?php echo base_url() ?>index.php/admission/phdef/Adm_phdef_user_dashboard/education_apply_post" method="POST">
...
<!--row start  -->
<script type="text/javascript" src="<?php echo base_url(); ?>themes/dist/js/phdef/adm_phdef_apply.js"></script>
<script type="text/javascript">
    $(document).ready(function() 
    {   
        ...
        $("#programme_apply_for").change(function(event) 
        {
            ...
            $.ajax({
                url: "<?php echo base_url() ?>index.php/admission/phdef/Adm_phdef_user_dashboard/get_program_elligibilty",
                type: "POST",
                // dataType:'json',
                data: {
            ...
            // $.ajax({
            //     url: "<?php echo base_url() ?>index.php/admission/phdef/Adm_phdef_user_dashboard/get_specialization_by_program_id",
            //     type: "POST",
            //     // dataType:'json',
            //     data: {
            //         "programme_apply_for": programme_apply_for
        ...
        $("#dept").change(function(event) 
        {
            ...
            $.ajax({
                url: "<?php echo base_url() ?>index.php/admission/phdef/Adm_phdef_user_dashboard/get_faculty_by_dept_id",
                type: "POST",
                // dataType:'json',
                data: {
                    "dept": dept
