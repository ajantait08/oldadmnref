            ...
            <div class="navbar-menu-wrapper d-flex align-items-stretch">
                ...
                <ul class="navbar-nav navbar-nav-right">
                    ...
                    <li class="nav-item nav-logout d-lg-block">
                        <a class="nav-link" href="<?php echo base_url(); ?>index.php/admission/phd/admin/dashboard/logout">
                    ...
                    if(($user_role == 'superadmin')) { ?>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="collapse" href="#sub-menus-cfi" aria-expanded="false"  aria-controls="sub-menus-cfi">
                                <span class="menu-title">PHD Admission Super Admin</span>
                            ...
                            <div class="collapse" id="sub-menus-cfi">
                                <ul class="nav flex-column sub-menu">
                                    <li class="nav-item">
                                        <a class="nav-link" href="<?php echo base_url(); ?>index.php/admission/phd/admin/dashboard/download_CI_documents">
                                         Call For Interview List
                                        </a>
                                    </li>
                                </ul>
                            </div>
