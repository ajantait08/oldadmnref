                        ...
                        <div class="panel-body">
                            <div id="newUser">
                                ...
                                <!-- <marquee behavior="scroll" direction="left" onmouseover="this.stop();"
                                    ...
                                    Registration for Jee Advance admission will be closed today (06.05.2022) at 1700 hrs and
                                    the payment process will be closed today at 2400 hrs.
                                </marquee>
                                <marquee behavior="scroll" direction="left" onmouseover="this.stop();"
                                    onmouseout="this.start();" style="font-size: 20pt; font-weight: bold">
                                    The last date of applying in Jee Advance registration was 5 PM(06 may 2022).
                                </marquee> -->
                                <?php $var = 'not';
                                // if(true)
                                if ($var == 'go') { ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-8 col-md-offset-2">
                                            <form name="newUser" class="register" id="sub" action="<?php echo base_url() ?>index.php/admission/phd/Adm_phd_registration/get_registration" method="POST" control="" class="form-group" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <option value="Female" <?= set_select('category', 'Transgender') ?>>Transgender</option>   -->
                                                                        ...
                                                                        <option value='OBC' <?= set_select('category', 'OBC') ?>>OBC(NCL)
                                                                        </option>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <input value="" id="year" type="hidden" class="form-control" name="year">
                                                                    <input value="" id="month" type="hidden" class="form-control" name="month">
                                                                    <input value="" id="day" type="hidden" class="form-control" name="month">
                                                                    <?php if (validation_errors()) { ?>
                                                                        <div class="myalert">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <select id="gender" name="gender" class="form-select" aria-label="Default select example">
                                                                        ...
                                                                        <option value="Male" <?php echo  set_select('gender', 'Male'); ?>>Male
                                                                        </option>
                                                                        <option value="Female" <?php echo  set_select('gender', 'Female'); ?>>
                                                                            Female</option>
                                                                        <option value="Transgender" <?php echo  set_select('gender', 'Transgender'); ?>>
                                                                            Transgender</option>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <select id="appl_type" name="appl_type" class="form-select" aria-label="Default select example">
                                                                        ...
                                                                        <option value="Full time" <?= set_select('appl_type', 'Full time') ?>>Full
                                                                            Time</option>
                                                                        <option value="Part time" <?= set_select('appl_type', 'Part time') ?>>Part
                                                                            Time </option>
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        <select id="yes_no_cfti" name="yes_no_cfti">
                                                                            <option value="">--please select ---</option>
                                                                            <option value="Yes" <?= set_select('yes_no_cfti', 'Yes') ?>>Yes
                                                                            </option>
                                                                            <option value="No" <?= set_select('yes_no_cfti', 'No') ?>>No
                                                                            </option>
                                                                        </select>
                                                                        <?php if (validation_errors()) { ?>
                                                                            <div class="myalert">
