                                                ...
                                                <div class="wizard-inner">
                                                    ...
                                                    <ul class="nav nav-tabs" role="tablist">
                                                        <li role="presentation">
                                                            <a href="#"><span class="round-tab">PD </span> <i>Personal details</i></a>
                                                        </li>
                                                        ...
                                                        <div class="tab-pane active" role="tabpanel" id="step4">
                                                            ...
                                                            <?php }?>
                                                             <?php  $attributes = array('class' => 'email', 'id' => 'btn_document','name'=>'p_details','enctype'=>'multipart/form-data');
                                                                echo form_open('admission/Adm_mba_document/document_submit', $attributes); ?>
                                                                <div class="col-md-6 col-sm-6 col-lg-6">
                                                                    <div class="row">
                                                                        <p><span style= "color:red;">Note:All document file,image,signature name must be different starting with Alphabate character only.</span></p>
                                                                        <div class="col-md-6 col-sm-6 col-lg-12">
                                                                            <label class="control-label">DOB/X Marksheet<span style= "color:red;">*(Maximum size 1mb Only pdf)</span></label>
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-6">
                                                                                  <?php  
                                                                                   ...
                                                                                   ?>   
                                                                                   <label class="control-label">Photo<span style= "color:red;">*(Maximum 50kb)(.png, .jpg, .jpeg)</span></label>
                                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-12 col-sm-12 col-lg-12">
                                                                            <div class="row">
                                                                                <div class="col-md-6">
                                                                                   ...
                                                                                   ?>   
                                                                                   <label class="control-label">Signature<span style= "color:red;">*(Maximum 50kb)(.png, .jpg, .jpeg)</span></label>
                                                                                    <div class="form-group">                                  
       ...
       $('#formcheck').click(function()
            {
                ...
                var count=$('#doc_t').val();
                $.ajax({
                url: base_url+'/index.php/admission/Adm_mba_document/validate_photo_signature_doc',
                type: "POST",
                // dataType:'json',
                data: {"total":count},
...
{  
    ...
    $.ajax({
        url: base_url+'/index.php/admission/Adm_mba_document/document_upload/'+valchek, // point to server-side controller method
...
{ 
   ...
   if(hrefval==='#')
   {
    ...
    form_data.append(filenameid, file_data);
    $.ajax({
        url: base_url+'/index.php/admission/Adm_mba_document/document_remove/'+filenameid, // point to server-side controller method
        dataType: 'json', // what to expect back from the server
        cache: false,
        contentType: false,
        processData: false,
