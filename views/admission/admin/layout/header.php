            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    ...
                    if(($user_role == 'superadmin')) { ?>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="collapse" href="#exceldata" aria-expanded="false"  aria-controls="exceldata">
                                <span class="menu-title">Upload excel data</span>
                                <i class="menu-arrow"></i>
                                <i class="mdi mdi-currency-inr menu-icon"></i>
                            </a>
                            <div class="collapse" id="exceldata">
                                <ul class="nav flex-column sub-menu">
                                    <li class="nav-item">
                                        <a class="nav-link" href="<?php echo base_url(); ?>index.php/admission/admin/dashboard/upload_excel_data">
                                            upload Csv file
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="<?php echo base_url(); ?>index.php/admission/admin/dashboard/sink_data_for_interview">
                                           Sink Data call for interview
                                        </a>
                                    </li>
                                </ul>
                            </div>
