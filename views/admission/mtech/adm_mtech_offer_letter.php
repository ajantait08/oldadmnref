            ...
            <div class="row">
                <div class="col-md-12 col-lg-12 col-sm-12">
                    <div class="panel panel-primary news_back">
                        ...
                        <form action="<?php echo base_url().'index.php/admission/mtech/Adm_mtech_admisison_payment/adm_mtech_payment'; ?>" method="post" enctype="multipart/form-data">
                            <section>
                                <div class="row">
                                ...
                                <?php
                                    ...
                                    <div class="col-md-6">
                                <div class="radio">
                                <label><input type="radio" id="optradio" name="optradio" value="<?php echo $program_id; ?>" checked=checked><span style="font-weight:bold;"><?php echo $program_id; ?>(<?php echo $program_desc; ?>)</span></label>
                                <input type="hidden" name="program_desc" value="<?php echo $program_desc; ?>">
                            </div>
                                <br>
                                <iframe src="<?php echo base_url().$application_preview_mtech; ?>" name="iframe_a" height="300px" style="margin-top:10px;" width="100%" title="Iframe mtech" checked=checked></iframe>
                                <br>
                                <a href="<?php echo base_url() ?>index.php/admission/mtech/Adm_mtech_application_preview/application_download_mtech" class="btn btn-primary" style="margin-top:5px;border-radius:4px;">
                                Download Offer Letter for Mtech</a>
                            ...
                            <?php
                            // echo '<pre>';
                            // print_r($selected_program_details);
...
<script>
    ...
    window.location.href="<?php echo base_url().'index.php/admission/mtech/Adm_mtech_application_preview'; ?>";
});
</script>
<script>
