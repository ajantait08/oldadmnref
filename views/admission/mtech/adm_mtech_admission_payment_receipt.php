...
<head>
    <title>Mtech Payment Receipt</title>
...
redirect('admission/mtech/Adm_mtech_registration/logout');
    ...
    <table style="width:100%" border="0">
        ...
        <tr>
            <td align="center">PAYMENT MTECH Admission Fee</td>
        </tr>
        <tr>
    ...
    </div><!--row start  --><script type="text/javascript" src="<?php echo base_url();?>themes/dist/js/adm_mtech/adm_mtech_education.js"></script>
</body>
