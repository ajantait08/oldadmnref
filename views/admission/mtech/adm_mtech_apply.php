                    ...
                    <div class="panel panel-primary news_back">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <input class="btn btn-info" style="width:100%;" type="button" onclick="location.href='<?php echo base_url() ?>'+'index.php/admission/mtech/Adm_mtech_user_dashboard/apply_post'" value="Start Application" />
                        ...
                        <div class="panel-body">
                            <section class="signup-step-container">
                               <form role="form"  class="login-box register">
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12 col-lg-12 ">
                                            <center>  <h5 style="color:#17a2b8;"><b><?php echo $name;?> Welcome to M.Tech Admission - 2022-2023 portal</b></h5></center>
                                        </div>
                                    </div>                
                                </form>
                            </section>
