                    ...
                    <div class="panel panel-primary news_back">
                        ...
                        <div class="panel-body">
                           ...
                           <marquee behavior="scroll" direction="left" onmouseover="this.stop();" onmouseout="this.start();" style="font-size: 20pt; font-weight: bold">
                                 The last date of applying in M.Tech registration was 5 PM(29th April 2022).
                                </marquee>
                           <?php $var='not';
                                    // $var='go';
                                if($var=='go')
                               ...
                               <?php if($this->session->flashdata('email_mobile')){?>
                                   ...
                                   <center> <strong><?php echo $this->session->flashdata('email_mobile')?></strong> </center>
                                    </div> 
                                    <?php }?>
                                   <div class="col-md-8 col-md-offset-2">
                                        <!-- <form name="newUser" class="register" id="sub" action="<?php echo base_url() ?>index.php/admission/mtech/Adm_mtech_registration_not_working/get_registrationdd" method="POST"control="" class="form-group" method="post" enctype="multipart/form-data"> -->
                                         ...
                                         <div class=row>
                                            <div class="col-md-12">
                                                ...
                                                <div style="color:green;">
                                                    <h5 id="">Your registration Number is :<?php echo $reg_num; ?> please save for the future use</h5>
                                       ...
                                       <?php }
                                        ...
                                        <?php }?> 
                                        <!-- <marquee behavior="scroll" direction="left" onmouseover="this.stop();" onmouseout="this.start();" style="font-size: 20pt; font-weight: bold">
                            New Registration for Application of admission in M.Tech will be closed at 5.00 PM on April 29, 2022. Complete Your application with payment by 12 midnight of April 29,2022. It's advised not to wait till the end and apply today only. No relaxation will be possible in the deadline.
                                </marquee> -->
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <!-- NAME -->
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input value="<?php echo set_value('first_name');?>" id="first_name" type="text" onkeyup="capital(this.id)" class="form-control" name="first_name" placeholder="Enter Your First Name" maxlength="49">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                                            <input  value="<?php echo set_value('middle_name');?>" id="middle_name" type="text" class="form-control" onkeyup="capital(this.id)" name="middle_name" placeholder="Enter Your Middle Name" maxlength="49">
                                                            <?php if(validation_errors()){?>
                                                                <div class ="myalert">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                                            <input  value="<?php echo set_value('last_name');?>" id="last_name" type="text" onkeyup="capital(this.id)" class="form-control" name="last_name" placeholder="Enter Your Last Name" maxlength="49">
                                                            <?php if(validation_errors()){?>
                                                                <div class ="myalert">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <select id="category" name="category" class="form-select" aria-label="Default select example">
                                                                ...
                                                                <option value='OBC'<?= set_select('category', 'OBC') ?>>OBC(NCL)</option>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input value="<?php echo set_value('email');?>" id="email" type="text" class="form-control" name="email" placeholder="Enter Your Email" maxlength="49">
                                                            <?php if(validation_errors()){?>
                                                                <div class ="myalert">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input value="<?php echo set_value('dob');?>" id="dob" type="dob" class="form-control" name="dob" placeholder="Enter Your DOB" readonly>
                                                            <?php if(validation_errors()){?>
                                                                <div class ="myalert">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-lg-6">
                                                    <div class="form-group">
                                                        <label>Blood Group<span style= "color:red;">*</span></label>
                                                            <div class="input-group">
                                                                <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                                                <select id="blood_group" name="blood_group" class="form-select" aria-label="Default select example">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                                            <input value="<?php echo set_value('father_name');?>" id="father_name" type="text" onkeyup="capital(this.id)" class="form-control" name="father_name" placeholder="Enter Your Father's Name" maxlength="150">
                                                            <?php if(validation_errors()){?>
                                                                <div class ="myalert">
