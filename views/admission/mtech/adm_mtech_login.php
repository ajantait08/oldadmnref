       ...
       <div class="login"><!--login start  -->
            <div class="row">
                <div class="col-md-8">
                    ...
                    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                    <strong></strong> <?php echo $this->session->flashdata('loginfail')?>
                    </div> 
                    <?php }?>  
                    </center>
                    ...
                    <div class="alert alert-danger alert-dismissible">
                    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                    <strong></strong> <?php echo $this->session->flashdata('registration_no')?>
                    </div> 
                    <?php }?>  
                    </center>
                        ...
                        <div class="d-flex justify-content-center h-100">
                            <div class="user_card">
                                ...
                                <div class="d-flex justify-content-center form_container">
                                    ...
                                    <form  name="loginf" id="loginsub" action="<?php echo base_url() ?>index.php/admission/mtech/Adm_mtech_registration/user_login" method="POST"control="" class="form-group" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="input-group mb-2">
                                            ...
                                            <!-- <div class="g-recaptcha" data-sitekey="6LchRQIaAAAAAAii2cHJZ1z3rb_qTDDJcgambclr"> dev google captch -->
                                ...
                                <div class="mt-4">
                                    ...
                                    <input class="btn btn-danger" style="width:100%;" type="button" onclick="location.href='<?php echo base_url() ?>'+'index.php/admission/mtech/Adm_mtech_forgetp'" value="Forgot your password?" />
                                    </div>
