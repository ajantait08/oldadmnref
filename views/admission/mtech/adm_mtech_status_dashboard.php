                        ...
                        <div class="panel-body">
                            <section>
                                    ...
                                    <div class="col-md-12 col-sm-12 col-lg-12">
                                        ...
                                        <div class="panel panel-primary news_back">
                                            ...
                                            <div class="panel-body">
                                              ...
                                              <?php if ($count_ml_with_payment == 0) { ?>
                                ...
                                <div class="col-md-12 col-sm-12 col-lg-12">
                                    ...
                                    <input class="btn btn-primary" style="width:100%;" type="button" onclick="location.href='<?php echo base_url() ?>'+'index.php/admission/mtech/Adm_mtech_application_preview/admission_offer_letter'" value="Offer Letter"/>
                                </div>
                                </div>
                                ...
                                <div class="col-md-12 col-lg-12 col-sm-12">
                                <div class="panel panel-primary news_back">
                                <div class="panel-heading">MTECH Admission Status
                                </div>
                                <div class="panel-body">
                                <table>
                                <thead>
                                            ...
                                            <tr>
                                                ...
                                                <?php } else { ?>
                                                    <td data-label="Action">
                                                        ...
                                                        <a href="<?php echo base_url(); ?>index.php/admission/mtech/Adm_mtech_application_preview/payment_receipt_admission"><button class="btn btn-sm btn-info">Payment Receipt</button></a><br/><br/>

                                                        <a href="<?php echo base_url();?>index.php/admission/mtech/Adm_mtech_application_preview/application_download_mtech"><button class="btn btn-sm  btn-success">Offer Letter MTECH</button></a><br/>
                                                ...
                                                ?>
                                                                ...
                                                                <?php }  else {} ?>
                                                                            ...
                                                                            <?php } elseif ($selected_program_details_with_underscore != '') { ?>
                                                                    <h2>Payment window for your offer letter is over!!</h2>
                                                              <?php  } else {
                                                                # code...
                                                              } ?>
                                                                            </div>
