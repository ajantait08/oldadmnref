<link href="<?php echo base_url();?>themes/dist/css/adm_mtech/adm_mtech_personal_details.css" rel="stylesheet" media="screen">
<?php
                                                    ...
                                                    <div class="tab-content" id="main_form">
                                                        ...
                                                        <div class="tab-pane active" role="tabpanel" id="step5">
                                                             ...
                                                             <div class="row">
                                                                  ...
                                                                  <div class="col-md-12" class="text-center">
                                                                        ...
                                                                        <?php
                                                                           ...
                                                                           echo form_open('admission/mtech/Adm_mtech_admisison_payment/proceed_to_payment', $attributes); ?>
                                                            ...
                                                            <ul class="text-center">
                                                                <li style="list-style: none;"><button type="submit" class="btn btn-primary">Proceed to payment</button></li>
...
<script type="text/javascript" src="<?php echo base_url();?>themes/dist/js/adm_mtech/adm_mtech_education.js"></script>
