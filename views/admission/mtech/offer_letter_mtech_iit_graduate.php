    ...
    <div class="page" width="8.3 inches" height="11.7 inches" align="center">
        <!-- <table class="mtech-nb" style="margin: 0.01in 0.01in 0.01in 0.01in; width:100%" align="center">
            ...
            <b>ACADEMIC SECTION</b>
                ...
                <tr>
                <td colspan='2'>
                 <?php /*No. Acad/605001/M.Tech. 2022 Adm./<?php echo $application[0]->registration_no; ?> */ ?>
                 No. Acad/605001/M.Tech. Admission/2022-23
                </td>
                <td>
            ...
            <tr>
            <td>
            Sub: Offer for provisional admission to 2 Year M. Tech. in <?php echo $program_desc; ?> for IIT graduates.
            </td>
            </tr>
           </table>
           ...
           <table class="mtech-nb" style="margin: 0.01in 0.01in 0.01in 0.01in; width:100%" align="center">
            ...
            <tr>
            <td>
            This is to inform you that on the basis of your online application form, you have been <b>provisionally</b> selected for admission to the 2 year M.Tech in (<?php echo $program_desc; ?>) at Indian Institute of Technology (Indian School of Mines), Dhanbad. You are required to pay the fees for provisional admission of Rs. 56,470/- (for GEN/OBC) / Rs. 41,470/- (for SC/ST/PwD) (including mess advance of Monsoon Semester of Rs. 15,000/-) through IIT(ISM) online application portal. Please follow the instructions given on the portal to pay the fees online. You are required to pay the fees up to <span style="color:red;"><?php echo date('d/m/Y',strtotime($selected_payment_details[0]->end_date)); ?></span> for provisional admission.
            </td>
            </tr>
           </table>
           ...
           <table class="mtech-nb" style="margin: 0.01in 0.01in 0.01in 0.01in; width:100%" align="center">
            ...
            <tr>
            <td>
            Please note that payment of provisional admission fees does not provide confirmed admission of the candidate.  After payment of admission fees all such candidates will be required to <b>report, for admission in person</b> on <span style="color:red;font-weight:bold;">August  04 , 2022</span>  at Indian Institute of Technology (Indian School of Mines), Dhanbad with all required documents. Please note that failure to submit admission fees / <u>report in person for admission</u>, on the scheduled date, will lead to cancellation of offer.
            </td>
            </tr>
           </table>
           ...
           <table class="mtech-nb" style="margin: 0.01in 0.01in 0.01in 0.01in; width:100%" align="center">
            ...
            <tr>
            <td>
            The admission will be subject to production of the following requisite documents <b>in original</b> for checking to fulfil the eligibility criteria, <b>failure to which admission will be cancelled:</b>
            <br>
           ...
           <table class="mtech-nb" style="margin: 0.01in 0.01in 0.01in 0.01in; width:100%" align="center">
            ...
            <li>
            c)	Copy of provisional admission fee payment receipt.
            </li>
            <li>
            ...
            <li>
            iii) Qualifying Degree <b>Marks-Sheet/Grade Card</b> (7th semester/pre-final year marks-sheet for the ‘appearing candidates’ whose final semester/final year results are awaited).(<b>candidates should have CGPA 8.00 and above (on a scale of 10)</b>)
            </li>
            <!-- <li>
            ...
            <li>
            iv)	A <b>Medical Fitness certificate</b> from <b>Govt. Hospital</b> as given in Annexure-III of the Information Brochure in original.
            </li>
           ...
           <table class="mtech-nb" style="margin: 0.01in 0.01in 0.01in 0.01in; width:100%" align="center">
            ...
            <tr>
            <td>
            IIT(ISM): 2 Year M. Tech Admission 2022
            </td>
            ...
            <li>
            v) A <b>Medical certificate</b> separately from Chief Medical Officer (CMO) or Equivalent of a Government Hospital, indicating <b>no colour blindness</b> for candidates of M.Tech. in <b>Opencast mining, Mining engineering, Tunneling & Underground Space Technology and Petroleum engineering</b> in original</li>
            <li>
            vi)	Caste certificate – applicable only for SC/ST/OBC-NCL candidates. The <b>OBC-NCL certificate should be as per Annexure I </b>(in the Central Government format) of the Information Brochure and should have been issued on or after<b>April 01, 2021</b>.
            </li>
            <li>
            vii)	Relevant certificate for the candidates in the sub-category (EWS/PwD). <b>EWS certificate</b> should have been issued on or after <b>April 01, 2021</b> (in the Central Government format).
            </li>
            </ul>
           ...
           <table class="mtech-nb" style="margin: 0.01in 0.01in 0.01in 0.01in; width:100%" align="center">
            ...
            <tr>
            <td>
            All other formalities related to Identity Card, Hostel accommodation and opening of bank account will be completed subsequently by the candidates immediately after final admission on <b>04 August 2022</b>. The classes of the M. Tech. Programmes will commence on <b>08 August 2022</b> (Monday).
            </td>
            </tr>
           </table>
