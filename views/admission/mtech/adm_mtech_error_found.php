                                                            ...
                                                            <h4 class="text-center" style="text-decoration: underline;">Payment Details</h4>
                                                             <div class="row">
                                                                  ...
                                                                  <div class="col-md-12" class="text-center">
                                                                        ...
                                                                        <?php }?>
                                                                        <h1 class='alert alert-danger'>Dear Applicant Error found in your previous information please send mail to /contact-> admission_mtech@iitism.ac.in</h1>
                                                                        </div>
                                                                        ...
                                                                        <div class=""> 
                                                                          <?php 
                                                                           ...
                                                                           echo form_open('admission/mtech/Adm_mtech_error/error', $attributes); ?>
