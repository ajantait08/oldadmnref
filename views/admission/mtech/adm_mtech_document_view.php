                                                             ...
                                                             <?php  $attributes = array('class' => 'email', 'id' => 'btn_document','name'=>'p_details','enctype'=>'multipart/form-data');
                                                                ...
                                                                <div class="col-md-6 col-sm-6 col-lg-6">
                                                                    ...
                                                                    <input id="doc_filed" name="doc_filed" type="hidden" value="yes">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <div class="input-group mb-3">
                                                                                    <div class="input-group-prepend" id="button-addon3">
                                                                                        ...
                                                                                        <button  id="upload12" class="btn btn-success" type="button" style="background-color:#0c3695;">Upload</button>
                                                                        ...
                                                                        <div class="col-md-12 col-sm-12 col-lg-12">
                                                                            <label class="control-label">Date of Birth certificate<span style= "color:red;">*(Maximum size 1mb Only pdf)</span></label>
                                                                            <div class="form-group">
                                                                                <div class="input-group mb-6">
                                                                                    <div class="input-group-prepend" id="button-addon3">
                                                                                        ...
                                                                                        <button id="uploadob" class="btn btn-success" type="button" style="background-color:#0c3695;">Upload</button>
                                                                            ...
                                                                            <div class="form-group">
                                                                                <div class="input-group mb-3">
                                                                                    <div class="input-group-prepend" id="button-addon3">
                                                                                        ...
                                                                                        <button  id="uploadug" class="btn btn-success" type="button"  style="background-color:#0c3695;">Upload</button>
                                                                        ...
                                                                        <div class="col-md-12 col-sm-12 col-lg-12">
                                                                            <label class="control-label">Colour Blindness<span style= "color:red;">*(Maximum size 1mb Only pdf)</span></label>
                                                                            <div class="form-group">
                                                                                <div class="input-group mb-3">
                                                                                    <div class="input-group-prepend" id="button-addon3">
                                                                                        ...
                                                                                        <button  id="uploadcb" class="btn btn-success" type="button" style="background-color:#0c3695;">Upload</button>
                                                                            ...
                                                                            <div class="form-group">
                                                                                <div class="input-group mb-3">
                                                                                    <div class="input-group-prepend" id="button-addon3">
                                                                                        ...
                                                                                        <button  id="uploadgsc" class="btn btn-success" type="button"  style="background-color:#0c3695;">Upload</button>
                                                                            ...
                                                                            <div class="form-group">
                                                                               <div class="input-group mb-3">
                                                                                    <div class="input-group-prepend" id="button-addon3">
                                                                                        ...
                                                                                        <button  id="uploadpwd" class="btn btn-success" type="button"  style="background-color:#0c3695;">Upload</button>
                                                                            ...
                                                                            <div class="form-group">
                                                                                <div class="input-group mb-3">
                                                                                    <div class="input-group-prepend" id="button-addon3">
                                                                                        ...
                                                                                        <button  id="uploadcat" class="btn btn-success" type="button"  style="background-color:#0c3695;">Upload</button>
                                                                            ...
                                                                            <div class="form-group">
                                                                                <div class="input-group mb-3">
                                                                                    <div class="input-group-prepend" id="button-addon3">
                                                                                        ...
                                                                                        <button  id="uploadpg" class="btn btn-success" type="button"  style="background-color:#0c3695;">Upload</button>
                                                                            ...
                                                                            <div class="form-group">
                                                                                <div class="input-group mb-3">
                                                                                    <div class="input-group-prepend" id="button-addon3">
                                                                                        ...
                                                                                        <button  id="uploadspon1" class="btn btn-success" type="button" style="background-color:#0c3695;">Upload</button>
                                                                            ...
                                                                            <div class="form-group">
                                                                                <div class="input-group mb-3">
                                                                                    <div class="input-group-prepend" id="button-addon3">
                                                                                        ...
                                                                                        <button  id="uploadspon2" class="btn btn-success" type="button"  style="background-color:#0c3695;">Upload</button>
                                                                            ...
                                                                            <div class="form-group">
                                                                               <div class="input-group mb-3">
                                                                                    <div class="input-group-prepend" id="button-addon3">
                                                                                        ...
                                                                                        <button  id="uploadwor" class="btn btn-success" type="button"  style="background-color:#0c3695;">Upload</button>
                                                                                  ...
                                                                                  <?php  
                                                                                   ...
                                                                                   <label class="control-label">Photo<span style= "color:red;">*(Maximum 100kb) (Only png or jpeg) </span></label>
                                                                                    <div class="form-group">
                                                                                                ...
                                                                                                <button  id="uploadph" class="btn btn-success" type="button"  style="background-color:#0c3695;">Upload <button id="removeph" class="btn btn-danger" type="button">Remove</button></button>
                                                                                ...
                                                                                <div class="col-md-6">
                                                                                   ...
                                                                                   <label class="control-label">Signature<span style= "color:red;">*(Maximum 100kb) (Only png or jpeg) </span></label>
                                                                                    <div class="form-group">                                  
                                                                                            ...
                                                                                            <button  id="uploadsg" class="btn btn-success" type="button"  style="background-color:#0c3695;">Upload <button  id="removesg" class="btn btn-danger" type="button">Remove</button></button>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="input-group">
                                                                            ...
                                                                            <input type="text" id="coap_reg" name="coap_reg" value="" class="form-control" maxlength="12">
                                                                        </div>
                                                                        <?php if(validation_errors()){?>
                                                                        <div class ="myalert">
                                                                           <p style="color:red;">
                                                                              <?php echo form_error('coap_reg');?>
                                                                            </p>
                                                                        </div>
                                                                        <?php } ?>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label>Re-enter COAP registration:</label>
                                                                        <div class="input-group">
                                                                            <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                                                            <input type="text" id="coap_reg_re" name="coap_reg_re" value="" class="form-control" maxlength="12">
                                                                        </div>
                                                                        <p> COAP Registration number is mandatory  for submitting the application.Your registration will be cancelled without the valid COAP registration number</p>
                                                                    </div>
                                                                ...
                                                                <div class="col-md-12 col-sm-12 col-lg-12">
                                                                   ...
                                                                   <div class="row">
                                                                       <div class="col-md-11 col-md-offset-0">
                                                                        <p>I hereby declare that I have read and understood the conditions of eligibility for M.Tech admission 2022. I fulfil the minimum eligibility criteria and I have provided the necessary information in this regard. In the event of the information being found incorrect or misleading, my candidature shall be liable to cancellation at any time. Further, I have carefully read all the instructions and I accept them and shall not raise any objections in future over the same.</p>
                                                                        <p>I hereby give my consent to make some or all of my data in IIT(ISM) website and various other portals of IIT(ISM) as and when required by IIT(ISM).</p>
                                                                       </div>
                                                                        <input type="hidden" name="doc_t" id='doc_t' value="<?php echo $total_document; ?>">
                                                                   </div>
                                                                   <div class="row">
                                                                       <div class="col-md-11 col-md-offset-0">
                                                                        <p><strong>Note: Incomplete application form and documents leads to cancellation of the candidature</strong></p>
   ...
   {  
    ...
    $('#btn_document').submit(function(e){
        ...
        if(app_type_coap=='GATE Candidates')
        {
            ...
            if(coapre=='')
            {
             alert("Re-enter coap registration is field is balnk!");
             $('#formcheck').prop('checked', false);
             return false; 
            }
            ...
            if(coap!=coapre)
            {
                alert("Re-enter coap registration field does not match!");
                $('#formcheck').prop('checked', false);
                return false;  
            }
