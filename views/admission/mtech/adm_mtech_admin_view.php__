...
<body class="hold-transition login-page">
  ...
  <strong>Info!</strong> <?php echo $this->session->flashdata('fail')?>
  </div> 
  <?php }?>
<div class="login-box">
  <div class="login-logo">
     <a href="https://www.iitism.ac.in">
       <img style ="width: 3.6em;"class="img-responsive" id="logo" src="<?php echo base_url();?>assets/img/logo.png" alt="logo">
     </a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form action="<?php echo base_url() ?>index.php/admission/Adm_mba_admin/login" method="POST">
