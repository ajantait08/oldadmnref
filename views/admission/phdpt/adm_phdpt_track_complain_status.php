                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <?php echo validation_errors(); ?>
                                              <?php
                                                  ...
                                                  echo form_open('admission/phdpt/Adm_phdpt_complain_register/track_technical_status', $attributes);
                                              ...
                                              <div class="col-md-8" id="order_radio" style="display:none;">
                                                <div class="form-group">
                                                  <label>Registration No.<span style="color:red;">*</span></label>
                                                      <input type="text" class="form-control" name="registration_no_new" id="order_no" value="<?php echo $registration_no; ?>" disabled placeholder="Please enter order no *"/>
                                                </div>
                                              </div>
...
<!-- <script type="text/javascript" src="<?php echo base_url();?>themes/dist/js/mtech/adm_phd_education.js"></script> -->
...
<script>
    ...
    if (complain_type.trim() === 'Payment Related Complaint') {
      $('#order_no_hide_display').css('display','contents');
    }
    else{
