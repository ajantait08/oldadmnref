        ...
        <table class="Phd" style="margin: 0.01in 0.01in 0.01in 0.01in; width:80%" align="center">
            <tr>
                ...
                <b>Indian Institute of Technology (Indian School of Mines) Dhanbad</b><br />
                    Online Application Form for Ph.D. (Part Time) Admission 2023-2024<br />Ph.D. Programme<br /><br />
            ...
            <tr>
                <td colspan="3">
                    ...
                    <table class="Phd-prgm" style="width:100%;border:1px solid black;">
                      <tr>
                          <td>
                              ...
                              elseif ($application[0]->assistance_type == 'SP') {
                                $assistance_type = 'Sponsored Candidate';
                              }
                              else{
                   ...
                   <?php if(!empty($application[0]->cfti_nirf_flag)) {?>
                    <p class="ex1"><b>CFTI/NIRF CANDIDATURE DETAILS: </b></p>
                    <?php if($application[0]->cfti_nirf_flag=='Y') {?>
                    <table class="Phd-prgm" style="width:100%;border:1px solid black;">
                                <tr>
                                    <td style="width:25%;">
                                        <b>CFTI/NIRF Flag: </b>&nbsp;&nbsp;
                                    ...
                                    <td style="width:25%;">
                                        <?php if(!empty($application[0]->cfti_nirf_flag)){
                                           if($application[0]->cfti_nirf_flag=='Y') 
                                           echo 'Yes'; 
                                           else
                                           echo 'No'; 
                                        } ?>
                                    ...
                                    <td style="width:25%;">
                                        <b>Name of the Institute: </b>&nbsp;&nbsp;
                                    </td>
                                    <td style="width:25%;">
                                        <?php if(!empty($application[0]->cfti_name_of_institute)){
                                            echo $application[0]->cfti_name_of_institute;
                                        } ?>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="width:25%;">
                                        <?php if(!empty($application[0]->cfti_nirf_cgpa)){
                                            echo $application[0]->cfti_nirf_cgpa;
                                        } ?>
                                    </td>
                                    <td style="width:25%;">
                                        <b>CFTI Year of passing: </b>&nbsp;&nbsp;
                                    </td>
                                    <td style="width:25%;">
                                        <?php if(!empty($application[0]->cfti_year_of_passing)){
                                            echo $application[0]->cfti_year_of_passing;
                                        } ?>
                                    </td>
                                </tr>
                                <tr>
                                <td style="width:25%;">
                                        <b>Current Year NIRF Rank: </b>&nbsp;&nbsp;
                                    </td>
                                    <td style="width:25%;">
                                        <?php if(!empty($application[0]->overall_nirf_rank_curr_yr)){
                                            echo $application[0]->overall_nirf_rank_curr_yr;
                                        } ?>
                                    </td>
                                    <td style="width:25%;">
                                        <b>Previous Year NIRF Rank: </b>&nbsp;&nbsp;
                                    </td>
                                    <td style="width:25%;">
                                        <?php if(!empty($application[0]->overall_nirf_rank_pre_yr)){
                                            echo $application[0]->overall_nirf_rank_pre_yr;
                                        } ?>
                                    </td>
                                </tr>
                                <tr>
                                <td style="width:25%;">
                                        <b>Current Year (Engineering/University) NIRF Rank: </b>&nbsp;&nbsp;
                                    </td>
                                    <td style="width:25%;">
                                        <?php if(!empty($application[0]->eng_nirf_rank_curr_yr)){
                                            echo $application[0]->eng_nirf_rank_curr_yr;
                                        } ?>
                                    </td>
                                    <td style="width:25%;">
                                        <b>Previous Year (Engineering/University) NIRF Rank: </b>&nbsp;&nbsp;
                                    </td>
                                    <td style="width:25%;">
                                        <?php if(!empty($application[0]->eng_nirf_rank_pre_yr)){
                                            echo $application[0]->eng_nirf_rank_pre_yr;
                                        } ?>
                                    </td>
                                </tr>
                        </table>
                   ...
                   <?php }?>
                    ...
                    <?php } ?>
                        ...
                        <table class="Phd" style="width:100%">
                            <tr>
                                ...
                                <th style="width:10%">Duration&nbsp;(<small>in Y M,D</small>)</th>
                            ...
                            foreach ($work_exp as $work) { ?>
                                <tr>
                                    ...
                                    <td style="width:10%"><?php if (!empty($work->start_date)) {
                                                                $sdate=date_create($work->start_date);
                                                                echo date_format($sdate,"d-m-Y");
                                                            } ?></td>
                                    <td style="width:10%"><?php if (!empty($work->end_date)) {
                                                                $edate=date_create($work->end_date);
                                                                echo date_format($edate,"d-m-Y");
                                                            } ?></td>
                                    <td style="width:10%"><?php if (!empty($work->duration)) {
                                                                echo $work->duration;
                                                            } ?></td>
                    ...
                    <p class="ex1"><b>Programme Specilization Details:</b></p>
                    <table class="Phd-prgm" style="width:100%">
                        <tr>
                            <th style="width:10%">Sl. No.</th>
                            <th style="width:40%">Programme Name</th>
                            ...
                            foreach ($prog_spec_details as $prog_spec_details) { ?>
                                <tr>
                                    ...
                                    <td style="width:35%"><?php if (!empty($prog_spec_details->program_id)) {
                                                                echo $this->Phd_all->get_program_desc($prog_spec_details->program_id);
                                                            } ?>
