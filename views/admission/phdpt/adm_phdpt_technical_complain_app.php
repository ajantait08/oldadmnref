                    ...
                    <div class="panel panel-primary news_back">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <input class="btn btn-primary" style="width:100%;" type="button" onclick="location.href='<?php echo base_url() ?>'+'index.php/admission/phdpt/Adm_phdpt_complain_register/track_status'" value="Tracking Technical Complain" />
...
<!-- <script type="text/javascript" src="<?php echo base_url();?>themes/dist/js/mtech/adm_phd/adm_phd_education.js"></script> -->
