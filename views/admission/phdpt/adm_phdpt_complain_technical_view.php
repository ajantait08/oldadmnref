                    ...
                    <div class="panel panel-primary news_back">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <input class="btn btn-warning" style="width:100%;" type="button" onclick="location.href='<?php echo base_url() ?>'+'index.php/admission/phdpt/Adm_phdpt_complain_register/technical_complaint'" value="Technical Complaint Register" />
                                <input class="btn btn-primary" style="width:100%;" type="button" onclick="location.href='<?php echo base_url() ?>'+'index.php/admission/phdpt/Adm_phdpt_complain_register/track_technical_status'" value="Tracking Technical Complaint" />
                                <?php if(!empty($tab))
                                {
                                    if($tab=='4')
                                    { ?>
                        ...
                        <div class="panel-body">
                            <section class="signup-step-container">
                                ...
                                elseif ($this->session->flashdata('message_error') != '') { ?>
                                    ...
                                    elseif ($this->session->flashdata('amount_error') != '') { ?>
                                    ...
                                    # code...
                                            ...
                                            <div class="card shadow mb-4 col-md-12">
                                                ...
                                                <h5 align="center" style="color:red;">
                                                Register complaint only related to MTECH application fee payment.
                                                </h5>
                                                </center>
                                                ...
                                                <?php
                                                    ...
                                                    echo form_open('admission/phdpt/Adm_phdpt_complain_register/save_technical_complaint', $attributes);
                                                ...
                                                <select class="form-control" name="complain_type" id="complain_type" required>
                                                    ...
                                                    <?php foreach($complaint_list as $complaint_details) { ?>
                                                    <option value="<?php echo $complaint_details['complaint_type']; ?> "><?php echo $complaint_details['complaint_type']; ?></option>
                                                    <?php } ?>
                                                </select>

                                                </div>

                                                <div id="order_no_hide_display">
                                                <div class="form-group mb-6">
                                            ...
                                            <option value="PHD Part Time Form Submission Issues">PHD Part Time Form Submission Issues</option>
...
$(document).ready(function(){
  ...
  $("#dateofPayment" ).datepicker({
    ...
    <script>
        $(document).ready(function(){
        $('#order_no_hide_display').css('display','none');
        });
    </script>
    ...
    $('#complain_type').change(function(){
        ...
        if(complainttype.trim() == 'Payment Related Complaint'){
            $('#order_no_hide_display').css('display','block');
