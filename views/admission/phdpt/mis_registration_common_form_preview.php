...
<?php } else {
                ...
                <!-- <p>Fill all form field to go to next step</p> -->
                    ...
                    <fieldset>
                    <form id="msform" class="form-horizontal" method="post" accept-charset="utf-8" enctype="multipart/form-data" action="<?php echo base_url(); ?>index.php/admission/phdpt/Adm_phdpt_admisison_payment/adm_phd_payment" onsubmit="return submitForm(this);">
...
<!-----------------------------                                 --------------------------------------------->
 ...
 <div class="panel panel-default">
  ...
  <div class="form-group">
      ...
      <input type="text" class="form-control" name="admn_based_on" value="<?php if($admn_based_on != '') {echo strtoupper($admn_based_on); } else { echo 'PT';} ?>" readonly>
       <?php }
    else if($admn_type=='mtech'){?>
      <input type="text" class="form-control" name="admn_based_on" value="<?php echo strtoupper($admn_based_on); ?>" readonly>
       <?php }
...
<div class="form-group">
 <label class="control-label col-md-2" for="cat_score">Cat Score:<strong  style="color: red;">*</strong></label>
    ...
    <?php }
     ...
     <label class="control-label col-md-2" for="other_rank">Rank:<strong  style="color: red;">*</strong></label>
      <div class="col-md-4">
      <input type="text" class="form-control" name="other_rank" readonly maxlength="5" oninput="this.value = this.value.replace(/[^0-9.]/g, '');" value='<?php echo set_value($other_rank);?>'>
       <?php echo form_error('other_rank'); ?>
      </div>
    </div>
<?php } }
 ...
 <label class="control-label col-md-2" for="gate_score">Gate Score:<strong  style="color: red;">*</strong></label>
    ...
    <?php }
     ...
     <label class="control-label col-md-2" for="other_rank">Rank:<strong  style="color: red;">*</strong><strong  style="color: red;">*</strong></label>
      <div class="col-md-4">
      <input type="text" class="form-control" name="other_rank" readonly maxlength="5" oninput="this.value = this.value.replace(/[^0-9.]/g, '');" value='<?php if($get_mis_reg_education_details[0]['other_rank'] != '') {
...
foreach($get_prev_education_details as $key => $education)
  { ?>
        ...
        <input type="hidden" name="verified_certificate[]" value='<?php echo $this->Phd_mis_reg->get_certificate_by_sno($education['sno'],$reg_id);?>'>
        <input type="hidden" name="verified_marksheet[]" value='<?php echo $this->Phd_mis_reg->get_marksheet_by_sno($education['sno'],$reg_id);?>'>
...
?>
    ...
    <input type="submit" name="next" class="next action-button" value="Proceed For Payment" style="width:160px;"/>
...
<script>
  $('#previous_other_details').click(function(){
    //alert('hii');
   window.location.href = "<?php echo base_url(); ?>index.php/admission/phdpt/Adm_phdpt_mis_registration_other_details/manage_previous_other_details";
  });
</script>
</body>
</html>
