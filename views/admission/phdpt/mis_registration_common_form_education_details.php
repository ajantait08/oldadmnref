...
?>
                ...
                <!-- <p>Fill all form field to go to next step</p> -->
                    ...
                    <fieldset>
                    <form id="msform" class="form-horizontal" method="post" accept-charset="utf-8" enctype="multipart/form-data" action="<?php echo base_url(); ?>index.php/admission/phdpt/Adm_phdpt_mis_registration_education/mis_registration_save_education_details" onsubmit="return submitForm(this);">
                        <div class="form-card">
                            <div class="row">
                                <!-- <div class="col-7">
...
<p align="center"><b>Please do not use Autofill. </p>
   ...
   <div class="form-group">
      ...
      <input type="text" class="form-control" name="admn_based_on" value="<?php if ($admn_based_on != '') {
        echo strtoupper($admn_based_on);
      } else { echo 'PT'; } ?>" readonly>
       <?php }
...
<script>
  $('#previous_personal_details').click(function(){
    //alert('hii');
   window.location.href = "<?php echo base_url(); ?>index.php/admission/phdpt/Adm_phdpt_mis_registration/manage_personal_details";
  });
</script>
