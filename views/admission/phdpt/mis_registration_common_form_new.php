    ...
    <div class="row justify-content-center">
      <div class="col-md-8 text-center p-0 mt-3 mb-2">
        <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
          ...
          <fieldset>
            <form id="msform" class="form-horizontal" method="post" accept-charset="utf-8" enctype="multipart/form-data" action="<?php echo base_url(); ?>index.php/admission/phdpt/Adm_phdpt_mis_registration/mis_registration_save_personal_details" onsubmit="return submitForm(this);">
              <div class="form-card">
                <div class="row">
                  <!-- <div class="col-7">
