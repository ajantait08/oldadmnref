                    ...
                    <div class="panel panel-primary news_back">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <input class="btn btn-warning" style="width:100%;" type="button" onclick="location.href='<?php echo base_url() ?>'+'index.php/admission/phdpt/Adm_phdpt_complain_register'" value="Complain Register" />
                                <input class="btn btn-primary" style="width:100%;" type="button" onclick="location.href='<?php echo base_url() ?>'+'index.php/admission/phdpt/Adm_phdpt_complain_register/track_status'" value="Tracking Complain" />
                                                             ...
                                                             <div class="row">
                                                                  ...
                                                                  <div class="col-md-12" class="text-center">
                                                                        ...
                                                                        <?php
                                                                           ...
                                                                           echo form_open('admission/phdpt/Adm_phdpt_admisison_payment/proceed_to_payment', $attributes); ?>
                                                                                ...
                                                                                <tbody>
                                                                                  <?php
                                                                                    ...
                                                                                    {?>
                                                                                        <tr>
                                                                                            <td><?php echo $i;?></td>
                                                                                            <td><?php echo $this->Adm_phdpt_admission_payment_model->get_program_desc($program_selected)[0]['program_desc']; ?></td>
