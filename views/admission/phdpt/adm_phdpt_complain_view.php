                    ...
                    <div class="panel panel-primary news_back">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <input class="btn btn-warning" style="width:100%;" type="button" onclick="location.href='<?php echo base_url() ?>'+'index.php/admission/phdpt/Adm_phdpt_complain_register'" value="Complaint Register" />
                                <input class="btn btn-primary" style="width:100%;" type="button" onclick="location.href='<?php echo base_url() ?>'+'index.php/admission/phdpt/Adm_phdpt_complain_register/track_status'" value="Tracking Complaint" />
                                <?php if(!empty($tab))
                                {
                                    if($tab=='4')
                                    { ?>
                                    ...
                                    # code...
                                            ...
                                            <div class="card shadow mb-4 col-md-12">
                                                ...
                                                <?php
                                                    ...
                                                    echo form_open('admission/phdpt/Adm_phdpt_complain_register/save', $attributes);
                                            ...
                                            <option value="PHD Part Time Application Fee">PHD Part Time Application Fee</option>
