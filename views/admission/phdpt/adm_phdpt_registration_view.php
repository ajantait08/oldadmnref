<link href="<?php echo base_url(); ?>themes/dist/css/phdpt/adm_phdpt_registration.css" rel="stylesheet" media="screen">
<div class="row">
    <!--row start  -->
    <div class="col-md-2">
        <!--row col-md-4 start  -->
                        ...
                        <div class="panel-body">
                            <div id="newUser">
                               ...
                               <!-- <marquee behavior="scroll" direction="left" onmouseover="this.stop();"
                                   ...
                                   The Registration Process for the Ph.D (Part Time) has not yet started.
                                </marquee> -->
                                ...
                                <div class="row">
                                    <div class="col-md-8 col-md-offset-2">
                                        <form name="newUser" class="register" id="sub"
                                            action="<?php echo base_url() ?>index.php/admission/phdpt/Adm_phdpt_registration/get_registration"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <select id="blood_group" name="blood_group"
                                                                ...
                                                                <option value="A+"
                                                                    <?php echo  set_select('blood_group', 'A+'); ?>>A+
                                                                </option>
                                                                <option value="A-"
                                                                    <?php echo  set_select('blood_group', 'A-'); ?>>A-
                                                                </option>
                                                                <option value="B+"
                                                                    <?php echo  set_select('blood_group', 'B+'); ?>>B+
                                                                </option>
                                                                <option value="B-"
                                                                    <?php echo  set_select('blood_group', 'B-'); ?>>B-
                                                                </option>
                                                                <option value="O+"
                                                                    <?php echo  set_select('blood_group', 'O+'); ?>>O+
                                                                </option>
                                                                <option value="O-"
                                                                    <?php echo  set_select('blood_group', 'O-'); ?>>O-
                                                                </option>
                                                                <option value="AB+"
                                                                    <?php echo  set_select('blood_group', 'AB+'); ?>>AB+
                                                                </option>
                                                                <option value="AB-"
                                                                    <?php echo  set_select('blood_group', 'AB-'); ?>>AB-
                                                                </option>
                                                ...
                                                <div class="col-md-6 col-sm-6 col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <span class="input-group-addon"><i
                                                                    class="glyphicon glyphicon-user"></i></span>
                                                            <input value="<?php echo set_value('father_name'); ?>"
                                                                id="father_name" type="text" onkeyup="capital(this.id)"
                                                                class="form-control" name="father_name"
                                                                placeholder="Enter Your Father's Name" maxlength="150">
                                                            <?php if (validation_errors()) { ?>
                                                            <div class="myalert">
...
<script type="text/javascript" src="<?php echo base_url(); ?>themes/dist/js/phdpt/adm_phdpt_registration.js"></script>