...
<head>
    ...
    <title>PHD (Part Time) ADMISSION</title>
    ...
    <link href="<?php echo base_url();?>themes/dist/css/phdpt/header.css" rel="stylesheet" media="screen">
    <link href="<?php echo base_url();?>themes/dist/css/phdpt/adm_phdpt_login.css" rel="stylesheet" media="screen">
...
<body>
    ...
    <script type="text/javascript" src="<?php echo base_url();?>themes/dist/js/phdpt/adm_phdpt_header.js"></script>
    <header>
        <div class="row">
                ...
                <div class="card hovercard">
                    ...
                    <div class="useravatar">
                        ...
                        <span class="card-title"
                            ...
                            MINES), DHANBAD<br>Ph.D. (Part Time) Admission 2023-2024</span>
                    </div>
                    <div class="card-info">
                    </div>
                </div>
            ...
            <nav class="navbar navbar-expand-custom navbar-mainbg">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item" id="home">
                            <a class="nav-link" href="<?php echo base_url();?>index.php/admission/phdpt/add_phdpt/home"><i
                                    class="fas fa-home"></i>HOME</a>
                        </li>
                        <li class="nav-item  active" id="apply">
                            <a class="nav-link"
                                href="<?php echo base_url();?>index.php/admission/phdpt/add_phdpt/how_to_apply">
                                <!--<i class="far fa-address-book"></i>-->HOW TO APPLY
                            </a>
                        </li>
                        <li class="nav-item" id="brochure">
                            <a class="nav-link"
                                href="<?php echo base_url();?>index.php/admission/phdpt/add_phdpt/information_brochure">
                                <!--<i class="far fa-clone"></i>-->INFORMATION BROCHURE
                            </a>
                        </li>
                        <li class="nav-item" id="eligibility">
                            <a class="nav-link"
                                href="<?php echo base_url();?>index.php/admission/phdpt/add_phdpt/programme_eligibility">
                                <!--<i class="far fa-calendar-alt"></i>-->PROGRAMME ELIGIBILITY
                            </a>
                        </li>
                        <li class="nav-item" id="payment">
                            <a class="nav-link"
                                href="<?php echo base_url();?>index.php/admission/phdpt/add_phdpt/payment_of_fees">
                ...
                <a class="nav-link" href="<?php echo base_url();?>index.php/admission/phd/add_phd/adm_phd_coap_counselling">COAP-Counselling</a>
                        ...
                        <li class="nav-item " id="login">
                            <a class="nav-link"
                                href="<?php echo base_url();?>index.php/admission/phdpt/add_phdpt/adm_phdpt_login">LOGIN</a>
                        </li>
                        <li class="nav-item" id="registration">
                            <a class="nav-link"
                                href="<?php echo base_url();?>index.php/admission/phdpt/add_phdpt/adm_phdpt_registration">
                        ...
                        <li class="nav-item" id="contact">
                            <a class="nav-link"
                                href="<?php echo base_url();?>index.php/admission/phdpt/add_phdpt/contact_us">
