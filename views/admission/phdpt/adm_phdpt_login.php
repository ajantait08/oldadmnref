                        ...
                        <div class="d-flex justify-content-center h-100">
                            <div class="user_card">
                                ...
                                <div class="d-flex justify-content-center form_container">
                                    ...
                                    <form  name="loginf" id="loginsub" action="<?php echo base_url() ?>index.php/admission/phdpt/Adm_phdpt_registration/user_login" method="POST"control="" class="form-group" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="input-group mb-2">
                                            ...
                                            <div class="g-recaptcha" data-sitekey="6LdRAokdAAAAAPzpLEre4KfqwOdYBuR830eOc0c3">   // live capcha 
                                            <!-- <div class="g-recaptcha" data-sitekey = "6Lfgv28kAAAAACYjex9AFmzaEauDZCzhy0yaA_6X"> -->
                                ...
                                <div class="mt-4">
                                    ...
                                    <input class="btn btn-danger" style="width:100%;" type="button" onclick="location.href='<?php echo base_url() ?>'+'index.php/admission/phdpt/Adm_phdpt_forgetp'" value="Forgot your password?" />
                                    </div>
                                    <div class="d-flex justify-content-center links" style="color: white;">
                                        <!-- Don't have an account? <a href="<?php echo base_url();?>index.php/admission/phdpt/Add_phdpt/adm_phdpt_registration" class="ml-2" style="color: white;">Sign Up</a> -->
                                    </div>
...
<script type="text/javascript" src="<?php echo base_url();?>themes/dist/js/phdpt/adm_phdpt_login.js"></script>
