<link href="<?php echo base_url();?>themes/dist/css/phdpt/login.css" rel="stylesheet" media="screen">
<style>
.myalert
{
  color:white;
                    ...
                    <div style="margin-top: 481px;">
                        <div class="container-center"> 
                            ...
                            <?php
                                ...
                                echo form_open('admission/phdpt/Adm_phdpt_forgetp/forget_password', $attributes); 
                            ...
                            <input class="btn btn-danger" style="width:100%;" type="button" onclick="location.href='<?php echo base_url() ?>'+'index.php/admission/phdpt/add_phdpt/adm_phdpt_login'" value="Did you remember? Sign In" />
                           </p>
                        </div>
                    </div> 
                </div>
