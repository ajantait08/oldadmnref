...
<!--Moment Precise Range Javascript Library -->
                                                ...
                                                <!-- <form role="form" action="index.html" class="login-box register"> -->
                                                    <div class="tab-content" id="main_form">
                                                        ...
                                                        <div class="tab-pane active" role="tabpanel" id="step1">
                                                            ...
                                                            echo form_open('admission/phdpt/Adm_phdpt_personal_details/get_personal_details', $attributes); ?>
                                                                <div class="row">
                                                                    ...
                                                                    <?php if($registration_detail[0]->color_blind != ''){ ?>
                                                                    <div class="col-md-6 col-sm-6 col-lg-6">
                                                                        <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <!-- <label>Date of Issue of cast certificate(OBC-NCL/EWS)(Cut off date of issue of caste certificate is 01-04-2022)<span id='doprof' style="color:red;">*</span></label> -->
                                                                            <label>Date of Issue of cast certificate(OBC-NCL/EWS) (Cut off date of issue of caste certificate is 01-04-2022)<span id='doprof' style="color:red;">*</span></label>
                                                                            <div class="input-group">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6 col-sm-6 col-lg-6">
                                                                        <div class="row">
                                                                            <div class="col-md-12 col-sm-12 col-lg-12">
                                                                                <div class="form-group">
                                                                                    <label>Correspondence Address:<span style="color:red;">*</span></label><br>
                                                                                      ...
                                                                                      <?php if(!empty($application_details_ms[0]['assistance_type']))
                                                                                        {
                                                                                            ...
                                                                                            {?>
                                                                                                ...
                                                                                                <option value="SP" <?php echo  set_select('assistant_type', 'Sponsered Candidate'); ?>>Sponsored</option>
                                                                                            ...
                                                                                            <option value="<?php if($application_details_ms[0]['assistance_type']=='SP'){echo "SP";} ?>" <?php echo  set_select('assistant_type', 'Sponsered Candidate');?> selected><?php if($application_details_ms[0]['assistance_type']=='SP'){echo "Sponsored";} ?></option>
                                                                ...
                                                                <ul class="list-inline pull-right">
                                                                  <li><button type="button" class ="btn btn-primary" style="background-color: #B31312;" id="btn_personal_details">Save & Next</button></li>
                                                                </ul>
                                                           </form>
                                                        </div>
                                                        ...
                                                        <?php }?>
                                                             ...
                                                             echo form_open('admission/phdpt/Adm_phdpt_personal_details/get_education_detail', $attributes); ?>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <select class="form-control" id="qualifying_degree_new" name="qualifying_degree_new">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <p>Are You Applying from CFTI / Top 20 Institutes based on last 2 years of NIRF ranking and having a CGPA of 8.0 ?<span style="color:red;">*</span></p>
                                                                </div>
                                                                <div class="col-md-4  col-sm-4 col-lg-4">
                                                                    <div class="form-group">
                                                                        <!-- <label for="sel1">Select list:</label> -->
                                                                        <select class="form-control" id="cfti_nirf_flag" name="cfti_nirf_flag">

                                                                            <?php if(!empty($application_details_ms[0]['cfti_nirf_flag']))
                                                                            {
                                                                                 if($application_details_ms[0]['cfti_nirf_flag']=='Y')

                                                                                {?>
                                                                                    <option value="<?php if($application_details_ms[0]['cfti_nirf_flag']=='Y'){echo "Y";} ?>" <?php echo  set_select('cfti_nirf_flag', 'Yes');?> selected><?php if($application_details_ms[0]['cfti_nirf_flag']=='Y'){echo "Yes";} ?></option>
                                                                                    <option value="N" <?php echo  set_select('cfti_nirf_flag', 'N'); ?>>No</option>

                                                                                <?php }
                                                                                else
                                                                                {?>

                                                                                  <option value="<?php if($application_details_ms[0]['cfti_nirf_flag']=='N'){echo "N";} ?>"  <?php echo  set_select('cfti_nirf_flag', 'No'); ?> selected><?php if($application_details_ms[0]['cfti_nirf_flag']=='N'){echo "No";} ?></option>
                                                                                  <option value="Y" <?php echo  set_select('cfti_nirf_flag', 'Y'); ?>>Yes</option>
                                                                        ...
                                                                        <?php if(validation_errors()){?>
                                                                        <div class ="myalert">
                                                                        <?php echo form_error('cfti_nirf_flag') ?>
                                                                        </div>
                                                                        <?php } ?>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div id="cfti_nirf_yes_no" style="margin: 21px 0px 21px 0px;">
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <p> Name of the Institute <span style="color:red;">*</span></p>
                                                                    </div>
                                                                    <div class="col-md-4  col-sm-4 col-lg-4">
                                                                        <div class="form-group">
                                                                                <!-- <label for="sel1">Select list:</label> -->
                                                                                    ...
                                                                                    <input class="form-control" id="cfti_name_of_institute" placeholder="Name of the Institute" name="cfti_name_of_institute" type="text" value="<?php if(!empty($application_details_ms[0]['cfti_name_of_institute'])) { echo $application_details_ms[0]['cfti_name_of_institute'];} else {}?>">

                                                                                <?php if(validation_errors()){?>
                                                                                <div class ="myalert">
                                                                                <?php echo form_error('cfti_name_of_institute') ?>
                                                                                </div>
                                                                                <?php } ?>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <p> Enter CGPA<span style="color:red;">*</span></p>
                                                                    </div>
                                                                    <div class="col-md-4  col-sm-4 col-lg-4">
                                                                        <div class="form-group">
                                                                            <!-- <label for="sel1">Select list:</label> -->
                                                                            <input class="form-control" id="cfti_nirf_cgpa" name="cfti_nirf_cgpa" placeholder="Enter CGPA" type="text" value="<?php if(!empty($application_details_ms[0]['cfti_nirf_cgpa'])) { echo $application_details_ms[0]['cfti_nirf_cgpa'];} else {}?>">
                                                                            <?php if(validation_errors()){?>
                                                                            <div class ="cfti_nirf_cgpa">
                                                                            <?php echo form_error('cfti_nirf_cgpa') ?>
                                                                            </div>
                                                                            <?php } ?>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <p> Enter Year of passing<span style="color:red;">*</span></p>
                                                                    </div>
                                                                    <div class="col-md-4 col-sm-4 col-lg-4">
                                                                        <div class="form-group">
                                                                            <!-- <label for="sel1">Select list:</label> -->
                                                                            <input class="form-control" id="cfti_year_of_passing" name="cfti_year_of_passing" placeholder="Enter Year of passing" type="text" value="<?php if(!empty($application_details_ms[0]['cfti_year_of_passing'])) { echo $application_details_ms[0]['cfti_year_of_passing'];} else {}?>">
                                                                            <?php if(validation_errors()){?>

                                                                            <?php echo form_error('cfti_year_of_passing') ?>
                                                                        ...
                                                                        <div class="col-md-6">
                                                                        <p>Overall NIRF Rank<span style="color:red;">*</span></p>
                                                                    </div>
                                                                    <div class="col-md-4  col-sm-4 col-lg-4">
                                                                        <div class="form-group">
                                                                            <label for="sel1"><?php echo  'Enter '.date('Y').' Overall NIRF Ranking'; ?></label>
                                                                            <input class="form-control" id="overall_nirf_rank_curr_yr" name="overall_nirf_rank_curr_yr" placeholder="Enter Overall NIRF Ranking" type="text" value="<?php if(!empty($application_details_ms[0]['overall_nirf_rank_curr_yr'])) { echo $application_details_ms[0]['overall_nirf_rank_curr_yr'];} else {}?>">

                                                                            <?php if(validation_errors()){?>

                                                                            <?php echo form_error('overall_nirf_rank_curr_yr') ?>

                                                                            <?php } ?>
                                                                            </div>

                                                                            <div class="form-group">
                                                                            <label for="sel1"><?php $prev_date = date('Y') - 1; echo  'Enter '.$prev_date.' Overall NIRF Ranking'; ?></label>
                                                                            <input class="form-control" id="overall_nirf_rank_pre_yr" name="overall_nirf_rank_pre_yr" placeholder="Enter Overall NIRF Ranking" type="text" value="<?php if(!empty($application_details_ms[0]['overall_nirf_rank_pre_yr'])) { echo $application_details_ms[0]['overall_nirf_rank_pre_yr'];} else {}?>">
                                                                            <?php if(validation_errors()){?>
                                                                            <?php echo form_error('overall_nirf_rank_pre_yr') ?>
                                                                            <?php } ?>
                                                                            </div>
                                                                        </div>

                                                                        <div class="col-md-6">
                                                                        <p>(Engineering/University) NIRF Rank<span style="color:red;">*</span></p>
                                                                    </div>
                                                                    <div class="col-md-4  col-sm-4 col-lg-4">
                                                                        <div class="form-group">
                                                                            <label for="sel1"><?php echo  'Enter '.date('Y').' (Engineering/University) NIRF Ranking'; ?></label>
                                                                            <input class="form-control" id="eng_nirf_rank_curr_yr" name="eng_nirf_rank_curr_yr" placeholder="Enter Engineering NIRF Ranking" type="text" value="<?php if(!empty($application_details_ms[0]['eng_nirf_rank_curr_yr'])) { echo $application_details_ms[0]['eng_nirf_rank_curr_yr'];} else {}?>">

                                                                            <?php if(validation_errors()){?>

                                                                            <?php echo form_error('eng_nirf_rank_curr_yr') ?>

                                                                            <?php } ?>
                                                                            </div>

                                                                            <div class="form-group">
                                                                            <label for="sel1"><?php $prev_date = date('Y') - 1; echo  'Enter '.$prev_date.' (Engineering/University) NIRF Ranking'; ?></label>
                                                                            <input class="form-control" id="eng_nirf_rank_pre_yr" name="eng_nirf_rank_pre_yr" placeholder="Enter Engineering NIRF Ranking" type="text" value="<?php if(!empty($application_details_ms[0]['eng_nirf_rank_pre_yr'])) { echo $application_details_ms[0]['eng_nirf_rank_pre_yr'];} else {}?>">
                                                                            <?php if(validation_errors()){?>
                                                                            <?php echo form_error('eng_nirf_rank_pre_yr') ?>
                                                                            <?php } ?>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                        ...
                                                        <div class="row">
                                                           ...
                                                           <?php echo $this->session->flashdata('apply_success_education')?>
                                                            ...
                                                            echo form_open('admission/phdpt/Adm_phdpt_personal_details/get_work_experience_detail', $attributes); ?>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="form-group">
                                                                    <select class="form-control" id="work_exp" name="work_exp">
                                                                        ...
                                                                        {?>
                                                                           <option value="">--Please Select --</option>
                                                                           <?php if($application_details_ms[0]['assistance_type'] == 'SP'){ ?>
                                                                           <option value="Yes" <?php echo  set_select('work_exp', 'Yes')?>>Yes</option>
                                                                           <?php } else { ?>
                                                                            <option value="No" <?php echo  set_select('work_exp', 'No')?>>No</option>
                                                                            <option value="Yes" <?php echo  set_select('work_exp', 'Yes')?>>Yes</option>
                                                              ...
                                                              <table id="workexp"  class="table work_exp_h_s">
                                                                ...
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th>Start Date in (YYYY-MM-DD)<span style="color:red;">*</span></th>
                                                                        <th>End Date in (YYYY-MM-DD)<span style="color:red;">*</span></th>
                                                                        <th>Duration in (Y M,D)<span style="color:red;">*</span></th>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    //    }
                                                                        if(!empty($exp_details)){
                                                                            $single=$exp_details[0]['duration'];
                                                                            $sum_of_month+=$exp_details[0]['duration'];
                                                                        }
                                                                    ?>
                                                                    <tr>
                                                                       ...
                                                                       <td data-column="start_date">
                                                                           <input  id="start_date1" name="start_date1" value="<?php echo set_value('start_date1')?><?php if(!empty($exp_details[0]['start_date'])) echo $exp_details[0]['start_date'];?>" type="text" class="form-control"  placeholder="Start Date" autocomplete="off">
                                                                           <?php if(validation_errors()){?><div class ="myalert"><?php echo form_error('start_date1')?> </div> <?php } ?>
                                                                       </td>

                                                                       <td data-column="end_date">
                                                                           <input  id="end_date1" name="end_date1" value="<?php echo set_value('end_date1')?><?php if(!empty($exp_details[0]['end_date'])) echo $exp_details[0]['end_date'];?>" type="text" class="form-control"  placeholder="End Date" autocomplete="off">
                                                                           <?php if(validation_errors()){?><div class ="myalert"><?php echo form_error('end_date1')?> </div> <?php } ?>
                                                                       </td>
                                                                       <td data-column="Duration(in month)">
                                                                           <input  id="duration1" name="duration1" type="text" value="<?php if(!empty($exp_details[0]['duration'])) echo trim($exp_details[0]['duration']);?><?php echo set_value('duration1');?>" class="form-control" readonly>
                                                                           <input  id="firstd" name="firstd" type="hidden" value="0">
                                                                           <input  id="month1" name="month1" class="valmonth"  type="hidden" value="<?php if(!empty($exp_details[0]['tot_duration_details'])){ echo explode('|',$exp_details[0]['tot_duration_details'])[1]; } else {echo 0;} ?>">
                                                                           <input  id="day1" name="day1" class="valday" type="hidden" value="<?php if(!empty($exp_details[0]['tot_duration_details'])){ echo explode('|',$exp_details[0]['tot_duration_details'])[2]; } else {echo 0;} ?>">
                                                                           <input  id="year1" name="year1" class="valyear" type="hidden" value="<?php if(!empty($exp_details[0]['tot_duration_details'])){ echo explode('|',$exp_details[0]['tot_duration_details'])[0]; } else {echo 0;} ?>">
                                                                           <input  id="secondd" name="secondd" type="hidden" value="<?php if (!empty($exp_details[0]['duration'])) { echo $exp_details[0]['duration'];} else { echo "0";} ?> ">
                                                                    ...
                                                                    <!-- <?php
                                                                        ...
                                                                        {
                                                                            foreach ($exp_details_d as $value) {
                                                                               // $sum_of_month+=$value['duration'];
                                                                                $val_year = explode('|',$value['tot_duration_details'])[0];
                                                                                $val_month = explode('|',$value['tot_duration_details'])[1];
                                                                                $val_day = explode('|',$value['tot_duration_details'])[2];
                                                                            ?>
                                                                            ...
                                                                            <tr id="row<?php echo $value['id'];?>">
                                                                                ...
                                                                                <td>
                                                                                    <input class="valorganization form-control" value="<?php if(!empty($value['start_date'])){ echo $value['start_date'];} ?>" id="start_date<?php echo $x;?>" name="start_date[]" type="text" class="form-control"  placeholder="Start Date" required maxlength="199" autocomplete="off">
                                                                                </td>

                                                                                <td>
                                                                                    <input class="valorganization form-control" value="<?php if(!empty($value['end_date'])){ echo $value['end_date'];} ?>" id="end_date<?php echo $x;?>" name="end_date[]" type="text" class="form-control"  placeholder="End Date" required maxlength="199" autocomplete="off">
                                                                                </td>

                                                                                <td>
                                                                                   <!-- <input class="valduration1 form-control"  name="duration_in_monthd[]"  value="<?php if(!empty($value['duration'])){ echo $value['duration'];}?>" onkeypress="return acceptnumber(event)" id="duration1<?php echo $x;?>" onchange="editget_month_d(this.id,<?php echo $value['id'];?>)"  type="text" class="form-control" maxlength="2" required maxlength="199"> -->

                                                                                   <input class="valduration1 form-control"  name="duration_in_monthd[]"  value="<?php if(!empty($value['duration'])){ echo $value['duration'];}?>" id="duration<?php echo $x;?>" readonly type="text" class="form-control" maxlength="2" required maxlength="199">
                                                                                    <input  id="editfirstt<?php echo $value['id'];?>" name="editfirstt<?php echo $value['id'];?>" type="hidden" value="0">
                                                                                    <input  id="month<?php echo $x; ?>" class="valmonth" name="month_d[]" type="hidden" value="<?php if(!empty($val_month)){ echo $val_month;}else{echo 0;}?>">
                                                                                    <input  id="day<?php echo $x; ?>" class="valday" name="day_d[]" type="hidden" value="<?php if(!empty($val_day)){ echo $val_day ;}else{echo 0;}?>">
                                                                                    <input  id="year<?php echo $x; ?>" class="valyear" name="year_d[]" type="hidden" value="<?php if(!empty($val_year)){ echo $val_year;}else{echo 0;}?>">
                                                                                    <input  id="editsecondt<?php echo $value['id'];?>" name="editsecondt<?php echo $value['id'];?>" type="hidden" value="<?php if(!empty($value['duration'])){ echo $value['duration'];} ?>">
                                                                                    <button class="btn-danger" type="button" name="<?php echo $value['id'];?>" onclick="remove_month_exp(<?php echo $x; ?>)"  id="removexpr<?php echo $x; ?>">Remove</button>
                                                                                </td>
                                                                        ...
                                                                        $("#start_date"+<?php echo $x; ?>).datepicker({
                                                                            changeMonth: true,
                                                                            changeYear: true,
                                                                        // dateFormat: "dd/mm/yy",
                                                                            yearRange: "-60:+00",
                                                                            ...
                                                                            {
                                                                                $("#end_date"+<?php echo $x; ?>).datepicker("destroy");

                                                                                $("#end_date"+<?php echo $x; ?>).datepicker({
                                                                                    changeMonth: true,
                                                                                    changeYear: true,
                                                                                    // dateFormat: "dd/mm/yy",
                                                                                    // yearRange: "-40:+00",
                                                                                    ...
                                                                                    minDate: new Date($("#start_date"+<?php echo $x; ?>).val())
                                                                                })

                                                                            if($("#end_date"+<?php echo $x; ?>).val() != ''){
                                                                            var start_date = moment($("#start_date"+<?php echo $x; ?>).val());
                                                                            var end_date = moment($("#end_date"+<?php echo $x; ?>).val());
                                                                            var diff = moment.preciseDiff(start_date,end_date,true);
                                                                            if($('#year').val() != '' && $('#month').val() != '' && $('#day').val() != ''){
                                                                            if($('#year'+<?php echo $x; ?>).val() != '' && $('#month'+<?php echo $x; ?>).val() != '' && $('#day'+<?php echo $x; ?>).val() != ''){
                                                                            /* year manage */
                                                                            //$year_latest = $('#year').val() - $('#year'+<?php echo $x; ?>).val();
                                                                            //$year_new = $year_latest + diff['years'];
                                                                            //$('#year').val($year_new);
                                                                            $('#year'+<?php echo $x; ?>).val(diff['years']);
                                                                            /* year manage */
                                                                            /* month manage */

                                                                            //$month_latest = $('#month').val() - $('#month'+<?php echo $x; ?>).val();
                                                                            //$month_new = $month_latest + diff['months'];
                                                                            //$('#month').val($month_new);
                                                                            $('#month'+<?php echo $x; ?>).val(diff['months']);
                                                                            /* month manage */
                                                                            /* day manage */

                                                                            //$day_latest = $('#day').val() - $('#day'+<?php echo $x; ?>).val()

                                                                            //$day_new = $day_latest + diff['days']

                                                                            //$('#day').val($day_new);
                                                                            $("#day"+<?php echo $x; ?>).val(diff['days']);
                                                                            /* day manage */
                                                                            }
                                                                            else{
                                                                            $('#year'+<?php echo $x; ?>).val(diff['years']);
                                                                            ...
                                                                            var dayElements = document.querySelectorAll(".valday");
                                                                            var monthElements = document.querySelectorAll(".valmonth");
                                                                            var yearElements = document.querySelectorAll(".valyear");
                                                                        // Iterate through the elements and get their values
                                                                            var sumday = 0;
                                                                            var summonth = 0;
                                                                            var sumyear = 0;
                                                                            dayElements.forEach(function(element) {
                                                                            sumday = parseInt(sumday) + parseInt(element.value);
                                                                            });

                                                                            monthElements.forEach(function(element) {
                                                                            summonth = parseInt(summonth) + parseInt(element.value);
                                                                            });

                                                                            yearElements.forEach(function(element) {
                                                                            sumyear = parseInt(sumyear) + parseInt(element.value);
                                                                            });

                                                                            // new calculation
                                                                            var day = parseInt(sumday % 30);
                                                                            var daym = parseInt(sumday / 30);

                                                                            var monthnew = parseInt(summonth) + parseInt(daym);
                                                                            var month = parseInt(monthnew % 12)
                                                                            var monthy = parseInt(monthnew / 12)

                                                                            var year = parseInt(sumyear) + parseInt(monthy);
                                                                            // new calculation

                                                                            $('#year').val(year);
                                                                            $('#month').val(month);
                                                                            $("#day").val(day);
                                                                            //$('#duration'+countexp).val(diff['years'] + 'Y ' + diff['months'] + 'M,' + ' ' + diff['days'] + 'D');

                                                                                $('#duration'+<?php echo $x; ?>).val(diff['years'] + 'Y ' + diff['months'] + 'M,' + ' ' + diff['days'] + 'D');
                                                                                $("#sum_of_month").val(year + 'Y ' + month + 'M,' + ' ' + day + 'D');
                                                                            ...
                                                                            // // //var month = parseInt(year*12) + month;
                                                                            // // var day = parseInt(month*30) + day;
                                                                            // // convert days in months
                                                                            //  // convert months into years

                                                                            // if(day < 0){
                                                                            // var day = month * 30 + day
                                                                            // var month = 0
                                                                            // }

                                                                            // var year = year + parseInt(month/12);
                                                                            // var month = month % 12;
                                                                            // // convert months into years
                                                                            // // convert days in months
                                                                            // var month = month + parseInt(day/30);
                                                                            // var day = day % 30;
                                                                            // //convert days in months
                                                                            // // convert months into years
                                                                            // $('#year').val(year);
                                                                        ...
                                                                        $("#end_date"+<?php echo $x; ?>).datepicker({
                                                                            ...
                                                                            $("#end_date"+<?php echo $x; ?>).change(function(){

                                                                            if($("#start_date"+<?php echo $x; ?>).val() != ''){
                                                                            if($("#end_date"+<?php echo $x; ?>).val() != ''){
                                                                            var start_date = moment($("#start_date"+<?php echo $x; ?>).val());
                                                                            var end_date = moment($("#end_date"+<?php echo $x; ?>).val());
                                                                            var diff = moment.preciseDiff(start_date,end_date,true);
                                                               ...
                                                               <div> <input type="button" id="addexp"  name="addmore" value="Add More" style="float:right; margin-top: 9px;" class="btn btn-primary btn-sm work_exp_h_s"></div>
                                                                ...
                                                                <input type="hidden"  id="countexp"  name="countexp"  value="<?php echo $x-1; ?>">
                                                                <input type="hidden"  id="tab_id"  name="tab_id"  value="<?php echo $tab ;?>">
                                                               <div> <input type="button" id="addexp"  name="addmore" value="Add More" data-target=<?php echo $x; ?> style="float:right; margin-top: 9px;" class="btn btn-primary btn-sm work_exp_h_s"></div>
                                                               <input  id="month" name="month" type="hidden" value="<?php echo $main_month; ?>">
                                                               <input  id="day" name="day" type="hidden" value="<?php echo $main_day; ?>">
                                                               <input  id="year" name="year" type="hidden" value="<?php echo $main_year; ?>">
                                                                <div class="work_exp_h_s"><center>Total Experince in Y M , D:<input type="text" id="sum_of_month" name="sum_of_month" value="<?php if(!empty($application_details_ms[0]['total_work_experience'])){ echo $application_details_ms[0]['total_work_experience'];} else {echo "0";} ?>" readonly/></center></div>
                                                            </div>
                                                            <span style="color:red"> Note : Please Enter End Date as Today's Date For Current Employment</span>
                                                        </div>
                                                        <ul class="list-inline pull-right">
...
<script type="text/javascript" src="<?php echo base_url();?>themes/dist/js/phdpt/adm_phdpt_personal_detail.js"></script>
<!-- <script type="text/javascript" src="<?php echo base_url();?>themes/dist/js/phd/adm_phd_education.js"></script>  -->
<script>
$("#assistant_type").change(function()
{
    //alert($("#assistant_type").val());
    var value=$("#assistant_type").val();

    if(value=='IA')
    {
        //swal.fire("Information!", "Atleast one qualification examination is need for Institute Assistanship (GATE,CAT,GMAT,NETLS,IITGR,GATE score for Visvesvaraya Scheme).");
        swal.fire("Information!", "Atleast one qualification examination is needed for Institute Assistanship (GATE,CAT,GMAT,NETLS,IITGR).");
    }
    else if(value=='EXT')
    {
        swal.fire("Information!", "Atleast one qualification examination is needed for Externalship (DBTJRF,DSTINS,ICMR,ICPR,ICSSR,MANF,NBHM,NETCSIR,NETUGC,PMRF,RGNF)");
    }
    else if(value=='SP')
    {
        swal.fire("Information!","Atleast one relevant document is required for Sponsored Candidature");
    }
    else
    {
...
$("#end_date").datepicker({
    ...
    $("#end_date1").change(function(){
        ...
        if($("#start_date1").val() != ''){
        if($("#end_date1").val() != ''){
        var start_date = moment($("#start_date1").val()); //select start_date1
        var end_date = moment($("#end_date1").val()); // select end_date1
        var diff = moment.preciseDiff(start_date,end_date,true); // difference between start_date1 and end_date1
        $('#duration1').val(diff['years'] + 'Y ' + diff['months'] + 'M,' + ' ' + diff['days'] + 'D'); // setup difference in duration1
        if($('#year').val() != '' && $('#month').val() != '' && $('#day').val() != ''){
        if($('#year1').val() != '' && $('#month1').val() != '' && $('#day1').val() != ''){
        /* year manage */
        //$year_latest = $('#year').val() - $('#year1').val()
        //$year_new = $year_latest + diff['years']
        //$('#year').val($year_new);
        $('#year1').val(diff['years']);
        /* year manage */
        /* month manage */
        //$month_latest = $('#month').val() - $('#month1').val()
        //$month_new = $month_latest + diff['months']
        //$('#month').val($month_new);
        $('#month1').val(diff['months']);
        /* month manage */
        /* day manage */
        //$day_latest = $('#day').val() - $('#day1').val()
        //$day_new = $day_latest + diff['days']
        //$('#day').val($day_new);
        $("#day1").val(diff['days']);
        /* day manage */
        ...
        // if($("#countexp").val() != '')
        // {
        // var countexp = $("#countexp").val();
        // }


        // $("#duration"+countexp).focus(function(){
        //     var start_date = moment($("#start_date"+countexp).val());
        //     var end_date = moment($("#end_date"+countexp).val());
        //     var diff = moment.preciseDiff(start_date,end_date,true);
        //     $('#year'+countexp).val(diff['years']);
        //     $('#month'+countexp).val(diff['months']);
        //     $("#day"+countexp).val(diff['days']);
        //     var totyear = $("#year").val();
        //     var totmonth = $("#month").val();
        //     var totday = $("#day").val();
        //     var caltotyear = parseInt(totyear) + parseInt(diff['years']);
        //     var caltotmonth = parseInt(totmonth) + parseInt(diff['months']);
        //     var caltotday = parseInt(totday) + parseInt(diff['days']);
        //     $('#year').val(caltotyear);
        //     $('#month').val(caltotmonth);
        //     $("#day").val(caltotday);
        //     // convert months into years
        //     var year = parseInt($('#year').val());
        //     var month = parseInt($('#month').val());
