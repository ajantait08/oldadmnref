  ...
  <div class="col-lg-12 col-sm-12">
    <div class="card hovercard">
        ...
        <div class="useravatar" >
            ...
            <span class="card-title" style="font-size: calc(0.7vw + 0.3vh + 0.7vmin);font-weight: 800;" >भारतीय प्रौद्योगिकी संस्थान (भारतीय खनि विद्यापीठ), धनबाद<br>INDIAN INSTITUTE OF TECHNOLOGY (INDIAN SCHOOL OF MINES), DHANBAD<br>M.Tech. Admission 2022-2023 (2-Year M.Tech. Programme)</span>
        </div>
        <div class="card-info"> 
        </div>
    </div>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item" id="eligibility">
                <a class="nav-link" href="<?php echo base_url();?>index.php/admission/mtech/add_mtech/programme_eligibility"><!--<i class="far fa-calendar-alt"></i>-->PROGRAMME ELIGIBILITY</a>
            </li>
