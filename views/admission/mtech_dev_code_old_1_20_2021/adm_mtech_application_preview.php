        ...
        <table class="mtech" style="margin: 0.01in 0.01in 0.01in 0.01in; width:80%" align="center">
            <tr>
                ...
                <td class="headingforms" style="width:80%" align="center">
                    ...
                    Online Application Form for M.Tech. Admission 2021<br />(2-Year M.Tech. Programme)<br /><br />
                ...
                <td colspan="3">
                    ...
                    <table class="mtech" style="width:100%">
                        ...
                        <tr>
                            ...
                            <td><?php if (!empty($fellowship[0]->gate_result_status)) {
                                    echo $fellowship[0]->gate_result_status;
                                } ?></td>
                        </tr>
                    </table>
