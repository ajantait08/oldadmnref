                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-lg-12">
                                        <button class="btn btn-info" style="width:100%;"><a href="<?php echo base_url() ?>index.php/admission/mtech/Adm_mtech_user_dashboard/logout"><b style="text-decoration: none; color: white;">Apply</b></a> </button>
                ...
                <div class="col-md-12 col-lg-12 col-sm-12"><!--home col-md-12 start  -->
                    ...
                    <div class="panel panel-primary news_back">
                        <div class="panel-body">
                            ...
                            <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                            <strong>Info!</strong> <?php echo $this->session->flashdata('apply_success')?>
                            </div> 
                            <?php }?>
                                        ...
                                        <div class="row">  
                                                <div class="col-md-6 col-md-offset-3">
                                                    ...
                                                    <div class="form-group">
                                                        <label>Gate Subject and Code <span style= "color:red;">*</span></label>
                                                        <div class="input-group">
                                                            ...
                                                            <select id="gate_sub_code" name="gate_sub_code" class="form-select" aria-label="Default select example">
                                                                ...
                                                                <?php if(!empty($gate_paper_code)){ foreach ($gate_paper_code as $value) {?>
                                                                    <option value="<?php echo $value->gate_paper_code?>"><?php echo $value->gate_paper_desc?></option>
                                                                        <?php }}?>
                                                            </select>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <select id="course" name="course" class="form-select" aria-label="Default select example">
                                                                    ...
                                                                    <option value="M.tech"<?= set_select('course', 'M.TECH') ?>selected>M.TECH</option>
                                                            </select>
                                                            <?php if(validation_errors()){?>
                                                                <div class ="myalert">
                                                ...
                                                <div class="col-md-3 col-md-offset-5">
                                                    <div class="form-group">
                                                        <button type="submit" class="btn btn-primary g" style="background-color:#7f42b7;">Submit</button>
                                                    </div>
                                                </div>
                                            </div> 
                                            </div>                    
                                       ...
                                       <div id="sponserd">
                                            <form id="apply_post" action="<?php echo base_url() ?>index.php/admission/mtech/Adm_mtech_user_dashboard/get_apply_post" method="POST" control="" class="form-group register">
                                                <div class="row">  
                                                    ...
                                                    <!-- <div class="col-md-4" id="mining_non_mining">
                                                        <div >
                                                            <div class="form-group">
                                                                <label>Mining and non-mining<span style= "color:red;">*</span></label>
                                                                <div class="input-group">
                                                                    <span class="input-group-addon"><i class="glyphicon glyphicon-star"></i></span>
                                                                    <select id="ming_non_m_yes_no" name="ming_non_m_yes_no" class="form-select" aria-label="Default select example">
                                                                            <option value="">-- please select--</option>
                                                                            <option value="Y">Yes</option>
                                                                            <option value="N">No</option>
                                                                    </select>
                                    ...
                                    <section>
                                          <?php if(!empty($fill_appl_details)){?>
                                                    ...
                                                    <table id="table_programme">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            foreach($fill_appl_details as $row){ ?>
                                                                <tr>
                                                                    <td><?php echo $i;?> </td>
                                                                    <td class="valprog"><?php echo $row->program_desc;?></td>
                                                                    <td><?php echo $row->degree_desc;?></td>
                                                                    <td><?php echo $row->sub_math_12th;?></td>
                                                                    <td><?php if($row->non_min_work_exp=='Y'){ echo "Yes"; } else { echo " "; } ?></td>
                                                                    <td>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <center>
                                                         <button type="button" class="btn-primary" id="final_submit">Final Submit</button>
                                                    </center>
