...
//                                                             //
///////////////////////////////////////////////////////////////// 
class Adm_phd_application_model extends CI_Model
{
  ...
  public $adm_phd_tab = "adm_phd_tab";
  ...
  public function insert_application_details($data)
  {
    ...
    $myquery = "select g.* from adm_phd_appl_ms g where g.registration_no=?";
  ...
  {
    $stmt = " SELECT t.* FROM  adm_phd_tab t WHERE t.registration_no='" . $data['registration_no'] . "' ";
  ...
  {
    $query = $this->db->insert('adm_phd_specialization', $data);
    //  echo $this->db->last_query();
    //   exit;
    if ($query) {
      return true;
