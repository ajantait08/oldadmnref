...
class Adm_phd_document_model extends CI_Model {
    ...
    public $gate="adm_phd_fellowship";
    ...
    public function check_color_blind_doc($reg_no)
    {
      ...
      $myquery = "SELECT * FROM adm_phd_reg_appl_program p
      JOIN adm_phd_program_ms d ON d.dept_id=p.dept_id AND p.phd_in=d.adm_category
    ...
    public function get_appl_no_by_reg_id($reg)
    {
      ...
      $myquery = "select g.appl_no from adm_phd_appl_ms g where g.reg_no='".$reg."'";   // appl_no field is not there--- changed here by ----MADAN---on---23-02-2022
