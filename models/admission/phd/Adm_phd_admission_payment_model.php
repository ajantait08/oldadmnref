...
//                                                             //
/////////////////////////////////////////////////////////////////
class Adm_phd_admission_payment_model extends CI_Model {
...
//private $table_pay='paybeta';
  ...
  public $appl_program="adm_phd_reg_appl_program";
  public $address="adm_phd_address";
  public $tab="adm_phd_tab";
  public $cat="adm_phd_fellowship";
  public $qualification="adm_phd_qulaification";
  public $work_exp="adm_phd_work_exp";
  public $document="adm_phd_doc";
  public $adm_phd_appl_selected = "adm_phd_appl_selected";
   ...
   function insert_mis_pay_adm_pay_detail($payment_details,$cond)
   {
    ...
    $querystmt = $this->db->get_where('online_payment_admission_phd_final_fee',$cond);
    ...
    {
      $query = $this->db->insert('online_payment_admission_phd_final_fee',$payment_details); // phdportal db
    ...
    $querystmt2 = $this->db2->get_where('online_payment_admission_phd_final_fee',$cond);
    ...
    {
      $query2 = $this->db2->insert('online_payment_admission_phd_final_fee',$payment_details); // mis db
    ...
    $querystmt3 = $this->db4->get_where('online_payment_admission_phd_final_fee',$cond);
    ...
    {
      $query3 = $this->db4->insert('online_payment_admission_phd_final_fee',$payment_details); // pay db
   ...
   function update_main_payment_log($update_array,$where_data)
   {
    ...
    function update_payment_appl_ms_details($data,$reg,$prog)
    {
      ...
      $this->db->update('adm_phd_appl_selected', $data , $where);
   ...
   public function get_registration($data)
   {
    ...
    {
      $myquery = "select g.appl_no from adm_phd_appl_ms g where g.reg_no='".$reg."'";
    ...
    {
         $this->db->where($where_data);
         $this->db->update('adm_phd_tab',$update_array);

        return TRUE;

    }

    public function get_program_desc($program_selected){

      $sql = "select program_desc from adm_phd_program_ms where program_id = ?";
      $query = $this->db->query($sql,array($program_selected));
      if ($query->num_rows() > 0) {
         return $query->result_array();
      }
      else {
    ...
    public function get_adm_phd_appl_ms_selected($reg_no,$program_selected)
    {
      $sql = "select a.*,b.*,a.dob as 'dob' from adm_phd_appl_ms a inner join adm_phd_appl_selected b on a.registration_no = b.registration_no where a.registration_no = '".$reg_no."' and b.program_id = '".$program_selected."'";
    ...
    public function get_adm_phd_reg_appl_program_selected($reg_no,$program_selected)
    {
      $query=$this->db->get_where($this->adm_phd_appl_selected,array('registration_no'=>$reg_no,'program_id'=>$program_selected));
      if($query->num_rows() >0)
      return $query->result_array();
    }
