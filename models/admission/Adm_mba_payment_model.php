...
//                                                             //
///////////////////////////////////////////////////////////////// 
class Adm_mba_payment_model extends CI_Model {
  ...
  function __construct(){
    ...
    // $this->db4 = $CI->load->database($this->table_pay, TRUE); // 
  ...
  public $document="adm_mba_doc";
   ...
   function insert_mis_pay_adm_pay_detail($payment_details,$cond)
   {
    ...
    $querystmt = $this->db->get_where('online_payment_adm_mba_final_fee',$cond);
    ...
    {
      $query = $this->db->insert('online_payment_adm_mba_final_fee',$payment_details); // mbaportal db
    ...
    $querystmt2 = $this->db2->get_where('online_payment_adm_mba_final_fee',$cond);
    ...
    {
      $query2 = $this->db2->insert('online_payment_adm_mba_final_fee',$payment_details); // mis db
    ...
    $querystmt3 = $this->db4->get_where('online_payment_adm_mba_final_fee',$cond);
    ...
    {
      $query3 = $this->db4->insert('online_payment_adm_mba_final_fee',$payment_details); // pay db
...
// end changes for mtech 2021
 ...
 function update_payment_tab_details($update_array,$where_data)
 {
      ...
      $this->db2->where($where_data);
      $this->db2->update('adm_mba_tab',$update_array);
 ...
 function update_payment_appl_ms_details($update_array,$where_data)
   {
        $this->db->where($where_data);
        $this->db->update('adm_mba_appl_ms',$update_array);

        $this->db2->where($where_data);
        $this->db2->update('adm_mba_appl_ms',$update_array);
