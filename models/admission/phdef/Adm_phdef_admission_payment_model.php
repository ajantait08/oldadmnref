...
//                                                             //
/////////////////////////////////////////////////////////////////
class Adm_phdef_admission_payment_model extends CI_Model {
...
//private $table_pay='paybeta';
  ...
  public $cat="adm_phdef_fellowship";
  public $qualification="adm_phdef_qulaification";
  public $work_exp="adm_phdef_work_exp";
  public $document="adm_phdef_doc";
  public $adm_phd_appl_selected = "adm_phdef_appl_selected";

   function get_fee_details($reg_id,$email,$contact_no)
   {
      $this->db->select('fee_to_be_paid');
      $query = $this->db->get_where('online_payment_adm_phdef_final_fee',['reg_id' => $reg_id, 'email' => $email, 'contact_no' => $contact_no]); // stud_final_with_fee
      if($query->num_rows() > 0)
      {
   ...
   function insert_mis_pay_adm_pay_detail($payment_details,$cond)
   {
    ...
    $querystmt = $this->db->get_where('online_payment_admission_phdef_final_fee',$cond);
    ...
    {
      $query = $this->db->insert('online_payment_admission_phdef_final_fee',$payment_details); // phdportal db
    ...
    $querystmt2 = $this->db2->get_where('online_payment_admission_phdef_final_fee',$cond);
    ...
    {
      $query2 = $this->db2->insert('online_payment_admission_phdef_final_fee',$payment_details); // mis db
    ...
    $querystmt3 = $this->db4->get_where('online_payment_admission_phdef_final_fee',$cond);
    ...
    {
      $query3 = $this->db4->insert('online_payment_admission_phdef_final_fee',$payment_details); // pay db
   ...
   function update_main_payment_log($update_array,$where_data)
   {
    ...
    function update_payment_appl_ms_details($data,$reg,$prog)
    {
      ...
      $this->db->update('adm_phdef_appl_selected', $data , $where);
   ...
   public function get_registration($data)
   {
    ...
    {
         $this->db->where($where_data);
         $this->db->update('adm_phdef_tab',$update_array);
    ...
    public function get_program_desc($program_selected){
      ...
      $sql = "select program_desc from adm_phdef_program_ms where program_id = ?";
    ...
    public function get_adm_phdef_appl_ms_selected($reg_no,$program_selected)
    {
      $sql = "select a.*,b.*,a.dob as 'dob' from adm_phdef_appl_ms a inner join adm_phdef_appl_selected b on a.registration_no = b.registration_no where a.registration_no = '".$reg_no."' and b.program_id = '".$program_selected."'";
      $query = $this->db->query($sql);
      if($query->num_rows() >0)
      return $query->result_array();
    }
    public function get_adm_phdef_reg_appl_program($reg_no)
    {
    ...
    public function get_adm_phdef_reg_appl_program_selected($reg_no,$program_selected)
    {
