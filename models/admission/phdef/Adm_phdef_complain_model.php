...
class Adm_phdef_complain_model extends CI_Model {
...
//   private $tabulation='mislive'; //  mis
    ...
    {
        $query = $this->db->insert('adm_phdef_payment_complaints',$data);
    ...
    {
        $query = $this->db->get_where('adm_phdef_payment_complaints',$where);
    ...
    {   
        ...
        $query = $this->db->get('adm_phdef_payment_complaints');
        if ($query->num_rows() > 0) {
            return true;
        } else {
            return false;
