...
//                                                             //
/////////////////////////////////////////////////////////////////
class Adm_phdef_payment_model extends CI_Model {
...
//   private $table_pay='pay_live';
  ...
  public $document="adm_phdef_doc";
   ...
   function update_payment_tab_details($update_array,$where_data)
   {
        ...
        $this->db2->where($where_data);
        $this->db2->update('adm_phdef_tab',$update_array);
   ...
   {
        $this->db->where($where_data);
        $this->db->update('adm_phdef_appl_ms',$update_array);

        $this->db2->where($where_data);
        $this->db2->update('adm_phdef_appl_ms',$update_array);
