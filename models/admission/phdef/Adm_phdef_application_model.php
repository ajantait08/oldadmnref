...
//                                                             //
///////////////////////////////////////////////////////////////// 
class Adm_phdef_application_model extends CI_Model
{
  ...
  public $adm_phd_tab = "adm_phdef_tab";
  ...
  {
    $stmt = " SELECT t.* FROM  adm_phdef_tab t WHERE t.registration_no='" . $data['registration_no'] . "' ";
  ...
  {
    $query = $this->db->insert('adm_phdef_specialization', $data);
    $this->db2->insert('adm_phdef_specialization', $data);
    //  echo $this->db->last_query();
    //   exit;
    if ($query) {
      return true;
