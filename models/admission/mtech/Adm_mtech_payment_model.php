...
class Adm_mtech_payment_model extends CI_Model {
  ...
  public $document="adm_mtech_doc";
   ...
   function insert_mis_pay_adm_pay_detail($payment_details,$cond)
   {
    ...
    $querystmt = $this->db->get_where('online_payment_adm_mtech_final_fee',$cond);
    ...
    {
      $query = $this->db->insert('online_payment_adm_mtech_final_fee',$payment_details); // mtechportal db
    ...
    $querystmt2 = $this->db2->get_where('online_payment_adm_mtech_final_fee',$cond);
    ...
    { 
      ...
      $query2 = $this->db2->insert('online_payment_adm_mtech_final_fee',$payment_details); // mis db
    ...
    $querystmt3 = $this->db4->get_where('online_payment_adm_mtech_final_fee',$cond);
    ...
    {
      $query3 = $this->db4->insert('online_payment_adm_mtech_final_fee',$payment_details); // pay db
