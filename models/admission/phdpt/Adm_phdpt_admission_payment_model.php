...
//                                                             //
/////////////////////////////////////////////////////////////////
class Adm_phdpt_admission_payment_model extends CI_Model {

// private $tabulation='misdev'; //this for misdev when do live the use below one
// private $tabulation='mistest'; //this for misdev when do live the use below one
...
//private $table_pay='paybeta';
  ...
  public $adm_phd_appl_selected = "adm_phdpt_appl_selected";
   ...
   function update_main_payment_log($update_array,$where_data)
   {
    ...
    function update_payment_appl_ms_details($data,$reg,$prog)
    {
      ...
      $this->db->update('adm_phdpt_appl_selected', $data , $where);
   ...
   public function get_registration($data)
   {
    ...
    public function get_program_desc($program_selected){
      ...
      $sql = "select program_desc from adm_phdpt_program_ms where program_id = ?";
    ...
    {
      $sql = "select a.*,b.*,a.dob as 'dob' from adm_phdpt_appl_ms a inner join adm_phdpt_appl_selected b on a.registration_no = b.registration_no where a.registration_no = '".$reg_no."' and b.program_id = '".$program_selected."'";
