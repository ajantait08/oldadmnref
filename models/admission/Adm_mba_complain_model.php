...
class Adm_mba_complain_model extends CI_Model {
    ...
    {
        $query = $this->db->insert('adm_mba_payment_complaints',$data);

        $query2 = $this->db2->insert('adm_mba_payment_complaints',$data);
    ...
    {
        $query = $this->db->get_where('adm_mba_payment_complaints',$where);
    ...
    {   
        ...
        $query = $this->db->get('adm_mba_payment_complaints');
        if ($query->num_rows() > 0) {
            return true;
        } else {
            return false;
    ...
    {   
        ...
        // $query=$this->db->get_where('online_payment_adm_mba_log',$con);
    ...
    //     // $query = $this->db3->get('adm_mba_payment_complaints');
